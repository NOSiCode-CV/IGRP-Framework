            ...
            contents: [{
                ...
                elements: [{
                    ...
                    children: [
                	{
	                    ...
	                    class : 'croppie',
	                    name  : 'wr-croppie',
	                    label: d.lang.image.upload+' e Cortar',
	                    hidden: !0,
	                    onLoad: function() {
	                    ...
	                    onClick: function() {
	                    	var a = this.getDialog(),
	                         ...
	                         if ($.IGRP && $.IGRP.components.croppie) {
		                    	$.IGRP.components.croppie.onConfirm = function(p){
		                    		if(p){
		                            	...
		                            	imgB64 = p.value;
		                            	c.setAttribute("src", imgB64);
		                            	a.preview && (t.setAttribute("src", imgB64), a.preview.setAttribute("src", t.$.src), f(a))
	                    ...
	                    onChange: function() {
	                        var a = this.getDialog(),
	                            file = $(a['parts']['contents']['$']).find('table').find('tr td iframe').contents().find('input[name="uploadFile"]'),
	                            b = file[0].files;
	                        ...
	                        if (0 < b.length) {
	                           ...
	                           var reader = new FileReader();
								...
								reader.onload = function () {
                                    var url   = $('#p_link_upload_img').val(),
                                        ctype = b[0].type,
                                        name  = b[0].name.split('.');
                                   
                                    if ($.IGRP && $.IGRP.utils && url) {
                                            ...
                                            pComplete   : function(respdata){
                                                ...
                                                try{
                                                    ...
                                                    if(resp){
                                                        ...
                                                        var mtype = resp.type === 'error' ? 'danger' : resp.type;  

                                                        $.IGRP.notify({
                                                            message : $.IGRP.utils.htmlDecode(resp.message),
                                                            type    : mtype
                                                        });
	                    ...
	                    commit: function(a, b) {
	                        a == e && (this.getValue() || this.isChanged()) ?  b.setAttribute("src", imgB64) : 8 == a && (b.setAttribute("src", ""), b.removeAttribute("src"))
	                    },
	                    validate: function(){
	                    	var a = this.getValue();
	                    }
