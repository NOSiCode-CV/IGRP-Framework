...
Blockly.Java['colour_rgb'] = function(block) {
  ...
  var red = Blockly.Java.valueToCode(block, 'RED',
      Blockly.Java.ORDER_COMMA) || 0;
  var green = Blockly.Java.valueToCode(block, 'GREEN',
      Blockly.Java.ORDER_COMMA) || 0;
  var blue = Blockly.Java.valueToCode(block, 'BLUE',
      Blockly.Java.ORDER_COMMA) || 0;
  var functionName = Blockly.Java.provideFunction_(
      'colour_rgb',
      [ 'function ' + Blockly.Java.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Java['colour_blend'] = function(block) {
  ...
  var c1 = Blockly.Java.valueToCode(block, 'COLOUR1',
      Blockly.Java.ORDER_COMMA) || '\'#000000\'';
  var c2 = Blockly.Java.valueToCode(block, 'COLOUR2',
      Blockly.Java.ORDER_COMMA) || '\'#000000\'';
  var ratio = Blockly.Java.valueToCode(block, 'RATIO',
      Blockly.Java.ORDER_COMMA) || 0.5;
  var functionName = Blockly.Java.provideFunction_(
      'colour_blend',
      [ 'function ' + Blockly.Java.FUNCTION_NAME_PLACEHOLDER_ +
          '(c1, c2, ratio) {',
