  ...
  <xsl:template match="/"> 
    <html>
      <head>
        ...
        <style>#gen_auto_cod{  position:absolute;  top:34px;  right:20px;}
        </style>
      </head>
      <body class="{$bodyClass} sidebar-off">
                            ...
                            <div class="box-body">
                              <div role="form">
                                ...
                                <xsl:if test="rows/content/form_1/fields/page_descr">
                                  <div class="form-group col-sm-4   gen-fields-holder" item-name="page_descr" item-type="text" required="required">
                                    <label for="{rows/content/form_1/fields/page_descr/@name}">
                                      <span>
                                        <xsl:value-of select="rows/content/form_1/fields/page_descr/label"/>
                                      </span>
                                    </label>
                                    <input type="text" value="{rows/content/form_1/fields/page_descr/value}" class="form-control " id="{rows/content/form_1/fields/page_descr/@name}" name="{rows/content/form_1/fields/page_descr/@name}" required="required" maxlength="255" placeholder="">
                                ...
                                <xsl:if test="rows/content/form_1/fields/page">
                                  <div class="form-group col-sm-4   gen-fields-holder" item-name="page" item-type="text" required="required">
                                    ...
                                    <input type="text" value="{rows/content/form_1/fields/page/value}" class="form-control " id="{rows/content/form_1/fields/page/@name}" name="{rows/content/form_1/fields/page/@name}" readonly="readonly" required="required" maxlength="255" placeholder="">
                                      <xsl:call-template name="setAttributes">
                                ...
                                <xsl:if test="rows/content/form_1/fields/modulo">
                                  <div class="col-sm-4 form-group  gen-fields-holder" item-name="modulo" item-type="select">
                                    <label for="{rows/content/form_1/fields/modulo/@name}">
                                      <xsl:value-of select="rows/content/form_1/fields/modulo/label"/>
                                    </label>
                                    <select class="form-control select2 " id="form_1_modulo" name="{rows/content/form_1/fields/modulo/@name}">
                                      <xsl:call-template name="setAttributes">
                                        <xsl:with-param name="field" select="rows/content/form_1/fields/modulo"/>
                                      </xsl:call-template>
                                      <xsl:for-each select="rows/content/form_1/fields/modulo/list/option">
                                ...
                                <xsl:if test="rows/content/form_1/fields/version">
                                  <div class="col-sm-2 form-group  gen-fields-holder" item-name="version" item-type="select" required="required">
                                ...
                                <xsl:if test="rows/content/form_1/fields/nada2">
                                  <div class="box-head subtitle gen-fields-holder" text-color="1">
                                    <span>
                                      <xsl:value-of select="rows/content/form_1/fields/nada2/label"/>
                                    </span>
                                  </div>
                                </xsl:if>
                                <xsl:if test="rows/content/form_1/fields/criar_menu">
                                  <div class="col-sm-4  gen-fields-holder" item-name="criar_menu" item-type="checkbox">
                                    <div class="form-group">
                                      <div class="checkbox form-check-offset">
                                        <label class="checkbox-switch switch">
                                          <input type="checkbox" name="{rows/content/form_1/fields/criar_menu/@name}" value="1" class="checkbox " label="{rows/content/form_1/fields/criar_menu/label}">
                                            <xsl:call-template name="setAttributes">
                                              <xsl:with-param name="field" select="rows/content/form_1/fields/criar_menu"/>
                                            </xsl:call-template>
                                            <xsl:if test="rows/content/form_1/fields/criar_menu/value = '1'">
                                              <xsl:attribute name="checked">checked
                                              </xsl:attribute>
                                            </xsl:if>
                                          </input>
                                          <span class="slider round"/>
                                          <span class="checkbox-label">
                                            <xsl:value-of select="rows/content/form_1/fields/criar_menu/label"/>
                                          </span>
                                        </label>
                                      </div>
                                    </div>
                                ...
                                <xsl:if test="rows/content/form_1/fields/componente">
                                  <div class="col-sm-4  gen-fields-holder" item-name="componente" item-type="checkbox">
                                    <div class="form-group">
                                      <div class="checkbox form-check-offset">
                                        <label class="checkbox-switch switch">
                                          <input type="checkbox" name="{rows/content/form_1/fields/componente/@name}" value="1" class="checkbox " label="{rows/content/form_1/fields/componente/label}">
                                            <xsl:call-template name="setAttributes">
                                              <xsl:with-param name="field" select="rows/content/form_1/fields/componente"/>
                                            </xsl:call-template>
                                            <xsl:if test="rows/content/form_1/fields/componente/value = '1'">
                                              <xsl:attribute name="checked">checked
                                              </xsl:attribute>
                                            </xsl:if>
                                          </input>
                                          <span class="slider round"/>
                                          <span class="checkbox-label">
                                            <xsl:value-of select="rows/content/form_1/fields/componente/label"/>
                                          </span>
                                        </label>
                                      </div>
                                    </div>
        ...
        <script>(function(){var isChecked = function() {    return $('[name="p_gen_auto_code"]').is(':checked');    };     var enableAutoCod = function(){            $('[name="p_page"]').attr('readonly','readonly');            };        var disableAutoCod = function(){            $('[name="p_page"]').removeAttr('readonly');            };         var checkAutoCod = function(){            if( isChecked() )                enableAutoCod();                else                disableAutoCod();            };         $('[name="p_gen_auto_code"]').on('change',checkAutoCod);        checkAutoCod();        $('[name="p_page_descr"]').on('keyup',function(){    console.log(isChecked());    if(isChecked()){                var val = $(this).val();                    $('[name="p_page"]').val($.IGRP.utils.string.replaceSpecialChars(val));                    }        });   })();
        </script>
        <!-- FORM JS INCLUDES -->
        ...
        <script>
          $.IGRP.rules.set({"p_criar_menu":[{"name":"hide componente","events":"load,change","isTable":false,"conditions":{"rules":[{"condition":"checked","value":"","value2":"","patern":"","patern_custom":"","opposite":"1"}],"actions":[{"action":"hide","targets":"componente","procedure":"","request_fields":"","msg_type":"info","msg":""}]}}]},'actionsList');
        </script>
      </body>
    </html>
  </xsl:template>
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1525648414430"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1525648414430"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1525648414430"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1525648414430"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1525648414430"/>
</xsl:stylesheet>
