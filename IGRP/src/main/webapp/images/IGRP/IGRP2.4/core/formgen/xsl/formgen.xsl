<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="logo">
  	...
  	<xsl:template name="formgen-html">
        ...
        <body class="fixed-nav startin" view="gen-design" template="{rows/template}" id="igrp-form-gen">
            ...
            <nav id="igrp-top-nav" class="flex-nowrap navbar navbar-fixed-top d-flex align-items-center justify-content-start pt-0" bg-color="template">
                ...
                <div id="gen-views-ctrl" class="w-100 me-3">
                    <ul class="d-flex flex-nowrap" style="overflow:auto;">
                        <li rel="gen-design" class="text-uppercase active" active-text-color="primary">
                            <span>DESIGN</span>
                        </li>
                        <li rel="gen-css" class="text-uppercase" active-text-color="primary">
                            <span>CSS</span>
                        </li>
                        <li rel="gen-js" class="text-uppercase" active-text-color="primary">
                            <span>JS</span>
                        </li>
                        <li rel="gen-xml" class="text-uppercase" active-text-color="primary">
                            <span>XML</span>
                        </li>
                        <li rel="gen-xsl" class="text-uppercase" active-text-color="primary">
                            <span>XSL</span>
                        </li>
                        <li rel="gen-blocky" class="text-uppercase" active-text-color="primary">
                            <span>BLOCKLY</span>
                        </li>
                        <li rel="gen-java" class="text-uppercase" xslt-path="{$path}/core/formgen/util/java" xslt-file="XSL_GENERATOR.xsl" text-color="1">
                            <span>JAVA</span>
                        </li>
                    </ul>
                </div>
                    ...
                    <xsl:for-each select="rows/content/form/tools-bar/item">
                        <li>
                            <a target="{target}" class="form-gen-save igrpClick d-flex align-items-center">
                                ...
                                <i class="fa fa-cog fa-spin fa-fw hidden"></i>
            ...
            <form class="IGRP-form" name="formular_default" novalidate="">
                <div class="container-fluid">
                    <div class="row">
                        <div style="/*background-color:#004910;*/" class="col-md-4 col-lg-3 col-xl-2 sidebar tree-list shadow d-none d-md-block" id="igrp-sidebar" bg-color="secondary">

                 			<a class="d-flex align-items-center justify-content-center py-2" href="{rows/link}">
                                <img class="igrp-sidebar-img" src="{$path}/core/formgen/img/logo-gen-white.png" height="60" />
                                <span class="studio-name d-flex align-items-end ms-2">studio</span>
                            </a>
                            ...
                            <ul style="/*background-color:#004910;*/" class="nav nav-tabs col-md-4 col-lg-3 col-xl-2 clearfix bottom-0 border-top" role="tablist" bg-color="secondary">
                                <li class="w-50">
                                    <a class="d-flex align-items-center justify-content-center flex-column" href="#gen-page-properties" role="tab" data-toggle="tab">
                                        <i class="ri-settings-2-line"></i>
                                        <span class="d-block text-truncate">Definições</span>
                                    </a>
                                </li>
                                <li class="active w-50">
                                    <a class="d-flex align-items-center justify-content-center flex-column" href="#gen-list-components" role="tab" data-toggle="tab">
                                        <i class="ri-apps-line"></i>
                                        <span class="d-block text-truncate">Componentes</span>
                                    </a>
                                </li>
                                <li class="w-50 d-none">
                                    <a class="d-flex align-items-center justify-content-center flex-column" href="#gen-list-fields" role="tab" data-toggle="tab">
                                        <i class="ri-checkbox-multiple-line"></i>
                                        <span class="d-block text-truncate">Fields</span>
                                    </a>
                                </li>
                            </ul>

                            <div class="tab-content p-2 border-0">
                        ...
                        <div class="col col-md-8 col-lg-19 col-xl-10 main ms-auto" id="igrp-contents">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div id="gen-page-settings" class="row" rel="settings">
                                    ...
                                    <div class="col-md-5 offset-md-1 checkbox mt-3">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content border-0">
                            <div class="modal-header d-flex flex-column">
                                ...
                                <button
                                    style="position:absolute;top:20px;right:8px;filter: invert(1);"
                                    type="button"
                            ...
                            <div class="modal-body" role="form">
                                ...
                                <div rel="fields" class="gen-properties-setts-holder row">
                                    <div class="col-4 available-wrapper text-white p-4">
                                        <div>
                                            <div class="position-relative container-field-setter-search-wrapper mb-3">
                                                <input
                                                    name="{$locale-strings/search-field}"
                                                    placeholder="{$locale-strings/search-field}"
                                                    class="ps-4 bg-transparent form-control container-field-setter-search py-1 text-white"
                                                    type="text"
                                                />
                                    ...
                                    <div class="col-8 current-wrapper p-4" style="padding-bottom:80px!important">
                                        ...
                                        <div class="current-fields position-relative">
                                        ...
                                        <div class="splist-form-holder">
                                            <div class="splist-form" role="form">
                                                <div class="form-group col-md-12 gen-fields-holder" item-name="file" item-type="text" required="required">
                                                    ...
                                                    <input required="required" type="text" value="" class="form-control " id="p_file" name="p_file" />
                                                </div>
                                            </div>
                                        </div>
            ...
            <script type="text/javascript" src="{$path}/plugins/handlebars/handlebars.4.7.8.js"></script>

            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.componentsSearcher.js"></script>

            <script type="text/javascript" src="{$path}/core/ckeditor/ckeditor.js"/>

            <script type="text/javascript" src="{$path}/core/bootstrap/plugins/tabdrop/js/bootstrap-tabdrop.js"></script>

            <!-- #RULES -->
            <script type="text/javascript" src="{$path}/core/igrp/IGRP.rules.class.js"></script>
            <!-- ##RULES -->

            <!-- #LOOKUP JS INCLUDES -->
            <script type="text/javascript" src="{$path}/plugins/lookup/igrp.lookup.js"></script>
            <!-- ##LOOKUP JS INCLUDES -->
            ...
            <script type="text/javascript" src="{$path}/core/bootstrap/plugins/treeview/js/bootstrap-treeview.js"></script>

            <!-- #code mirror -->
            <script type="text/javascript" src="{$path}/core/codemirror/js/codemirror.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/clike.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/formatting.js"></script>

            <script type="text/javascript" src="{$path}/core/codemirror/js/mode/sql/sql.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/mode/xml/xml.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/mode/xml/xslt.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/mode/css/css.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/mode/javascript/javascript.js"></script>

            <script type="text/javascript" src="{$path}/core/codemirror/js/keymap/sublime.js"></script>

            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/fold/foldcode.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/fold/foldgutter.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/fold/brace-fold.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/fold/xml-fold.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/fold/indent-fold.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/fold/markdown-fold.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/fold/comment-fold.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/edit/matchtags.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/edit/closebrackets.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/edit/matchbrackets.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/hint/xml-hint.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/hint/show-hint.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/hint/sql-hint.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/search/search.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/search/searchcursor.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/search/dialog.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/search/jump-to-line.js"></script>
            <script type="text/javascript" src="{$path}/core/codemirror/js/addon/display/fullscreen.js"></script>
            <!-- ##code mirror -->
            ...
            <!-- #Formgen -->
            <script type="text/javascript" src="{$path}/core/formgen/js/chance.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/jquery-ui.min.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/string.js" charset="utf-8"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.converter.2dot2.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.vars.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.getdata.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.Xsl.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.XML.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.config.js"></script>

            <!-- #Formgen Validation -->
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.validation.js"></script>

            <!-- #Formgen RULEs -->
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.rules.js"></script>

            <!-- #Formgen COLOR PICKER -->
            <script type="text/javascript" src="{$path}/core/formgen/js/service/jquery.jsPlumb-1.5.5.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/service/xsdmapper.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.service.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.layout.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.templates.js"></script>
            <script type="text/javascript" src="{$path}/core/xml2json/jquery.xml2json.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.downloadXSL.js"></script>

            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.containers.js" charset="utf-8"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.fields.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.html.js"></script>

            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.server.js"></script>
			<script type="text/javascript" src="{$path}/core/formgen/js/GEN.controller.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.structures.js"></script>

            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.xsl.templates.utils.js"></script>

            <script type="text/javascript" src="{$path}/core/formgen/js/vkbeautify.0.99.00.beta.js"></script>
            ...
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.state.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.adapter.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.containerFieldSetter.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.groupContainerMenus.js"></script>

            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.props.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.props.table.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.props.action.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.props.icon.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.props.date.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/v2/GEN.headers.controller.js"></script>

            <!-- #GEN Java Auto Complete -->
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.autocomplete.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.attributes.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.importTemplates.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.includeFiles.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/GEN.lookupMap.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/js/classes/Requests.js"></script>
            <script type="text/javascript" src="{$path}/core/formgen/types/containers/chart/index.js"></script>
    ...
    <xsl:template name="GEN-head">
        ...
        <!-- #BS JS -->
        <script type="text/javascript" src="{$path}/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script type="text/javascript" src="{$path}/libs/simplebar/simplebar.min.js"></script>
        <script type="text/javascript" src="{$path}/libs/node-waves/waves.min.js"></script>
        <script type="text/javascript" src="{$path}/libs/feather-icons/feather.min.js"></script>
        <script type="text/javascript" src="{$themePath}/assets/js/pages/plugins/lord-icon-2.1.0.js"></script>
        <script type="text/javascript" src="{$themePath}/assets/js/plugins.js"></script>
        <!-- ##BS JS -->

        <script type="text/javascript" src="{$path}/libs/choices.js/public/assets/scripts/choices.min.js"></script>
        ...
        <!-- IGRP iframeNavigation not async -->
