...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:include href="../java/XSL_CONSTANTS.xsl" />
    <xsl:include href="../java/XSL_FIELDS.xsl" />
    <xsl:include href="../java/XSL_BUTTON.xsl"/>
    <xsl:include href="../java/XSL_MODEL.xsl" />
    <xsl:include href="../java/XSL_VIEW.xsl" />
