var Field = function(type,params){
	...
	field.autoTag = params.options && params.options.hasOwnProperty('autoTag') ? params.options.autoTag : false;
	...
	field.init = function(){
		...
		$(document).trigger('gen-'+type+'-field-init', [{ field:field, params : params }])
