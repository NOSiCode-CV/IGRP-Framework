var GENBOX = function(name,tparams){
	...
	/*container.onHasTitleSet = function(has){
		$('>.container-contents>.igrp-inner-section>.igrp-inner-section-header',container.holder).remove();
		
		if(has)
			$('>.container-contents>.igrp-inner-section',container.holder).prepend(getBoxTitle());
	}*/

	/*container.onTitleSet = function(title){
		$('>.container-contents>.igrp-inner-section>.igrp-inner-section-header>.igrp-inner-section-title',container.holder).text(title);
	}
	*/	
	...
	container.onDrawEnd = function(){
		var boxBody = $('>.container-contents>.igrp-inner-section>.inner-body',container.holder);
	...
	container.setContents = function(contents, clear){
		...
		var holder = $($('> .container-contents > .igrp-inner-section > .inner-body',container.holder)[0]);
