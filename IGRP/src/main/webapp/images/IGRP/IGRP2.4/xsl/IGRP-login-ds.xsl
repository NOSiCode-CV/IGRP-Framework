													...
													<div class="pt-5">
														...
														<xsl:if test="rows/content/form/label/password">
															...
															<div class="mb-5 px-0">
																...
																<div class="input-group" item-name="password" item-type="password">
																	...
																	<input  placeholder="{rows/content/form/label/password}" type="{rows/content/form/label/password/@type}" value="{rows/content/form/value/password}" class="form-control" id="{rows/content/form/value/password/@name}" style="" name="{rows/content/form/value/password/@name}"/>
																	<div class="input-group-btn">
																		<span class="btn py-3 px-4" >
														...
														<xsl:if test="rows/content/form/label/button">
															<button name="p_button" value="p_button" type="submit" class="btn btn-primary shadow d-block p-3 w-100" id="{rows/content/form/value/button/@name}" >
																<span class="font-weight-bold"><xsl:value-of select="rows/content/form/label/button"/> <i class="fa  pl-2"/></span>
															</button>
														</xsl:if>
