package cv.nosi.webapps.igrp_studio.pages.env;
...
public class EnvView extends View {
	...
	public EnvView(){
		...
		name.propertie().add("name","p_name").add("type","text").add("maxlength","50").add("required","true").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false");
		...
		description.propertie().add("name","p_description").add("type","textarea").add("maxlength","500").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false");
		...
		gen_auto_code.propertie().add("name","p_gen_auto_code").add("type","checkbox").add("maxlength","2").add("required","false").add("readonly","false").add("disabled","false").add("switch","false").add("java-type","int").add("check","true");
		
		personalizacoes = new SeparatorField(model,"personalizacoes");
		personalizacoes.setLabel(gt("Personalizações"));
		personalizacoes.propertie().add("name","p_personalizacoes").add("type","separator").add("maxlength","30").add("placeholder",gt("")).add("desclabel","false");
		
		img_src = new TextField(model,"img_src");
		img_src.setLabel(gt("Logotipo"));
		img_src.propertie().add("name","p_img_src").add("type","text").add("maxlength","50").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false");
		
		templates = new TextField(model,"templates");
		templates.setLabel(gt("Template (theme)"));
		templates.propertie().add("name","p_templates").add("type","text").add("maxlength","100").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false");
		...
		host.propertie().add("name","p_host").add("type","text").add("maxlength","255").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("https://www.igrp.cv")).add("desclabel","false");
		...
		link_menu.propertie().add("name","p_link_menu").add("type","text").add("maxlength","2000").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false");
		
		link_center = new TextField(model,"link_center");
		link_center.setLabel(gt("Link Centro (Antigo)"));
		link_center.propertie().add("name","p_link_center").add("type","text").add("maxlength","2000").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false");
