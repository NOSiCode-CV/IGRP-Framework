package cv.nosi.webapps.igrp_studio.pages.wizard_export_step_2;
...
public class Wizard_export_step_2View extends View {
	...
	public Field others_class_ids;
	public Field others_class_ids_check;
	...
	public Wizard_export_step_2View(){
		...
		box_paginas = new IGRPBox("box_paginas","Páginas");
		...
		bpmn_ids.propertie().add("name","p_bpmn_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		bpmn_ids_check = new CheckBoxField(model,"bpmn_ids_check");
		bpmn_ids_check.propertie().add("name","p_bpmn_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_bpmn = new TextField(model,"descricao_bpmn");
		descricao_bpmn.setLabel(gt("Descrição"));
		descricao_bpmn.propertie().add("name","p_descricao_bpmn").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		modulo = new ListField(model,"modulo");
		modulo.setLabel(gt("Módulo"));
		modulo.propertie().add("remote",Core.getIGRPLink("igrp_studio","Wizard_export_step_2","index")).add("name","p_modulo").add("type","select").add("multiple","true").add("tags","false").add("domain","").add("maxlength","250").add("required","false").add("disabled","false").add("java-type","");
		
		pagina_ids = new CheckBoxField(model,"pagina_ids");
		pagina_ids.setLabel(gt("   "));
		pagina_ids.propertie().add("name","p_pagina_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		pagina_ids_check = new CheckBoxField(model,"pagina_ids_check");
		pagina_ids_check.propertie().add("name","p_pagina_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_pagina = new TextField(model,"descricao_pagina");
		descricao_pagina.setLabel(gt("Título (código)"));
		descricao_pagina.propertie().add("name","p_descricao_pagina").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		report_ids = new CheckBoxField(model,"report_ids");
		report_ids.setLabel(gt("   "));
		report_ids.propertie().add("name","p_report_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		report_ids_check = new CheckBoxField(model,"report_ids_check");
		report_ids_check.propertie().add("name","p_report_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_report = new TextField(model,"descricao_report");
		descricao_report.setLabel(gt("Descrição"));
		descricao_report.propertie().add("name","p_descricao_report").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		services_ids = new CheckBoxField(model,"services_ids");
		services_ids.setLabel(gt(" "));
		services_ids.propertie().add("name","p_services_ids").add("type","checkbox").add("maxlength","30").add("showLabel","true").add("java-type","String").add("switch","false").add("group_in","").add("check","true").add("desc","true");
		
		services_ids_check = new CheckBoxField(model,"services_ids_check");
		services_ids_check.propertie().add("name","p_services_ids").add("type","checkbox").add("maxlength","30").add("showLabel","true").add("java-type","String").add("switch","false").add("group_in","").add("check","true").add("desc","true");
		
		descricao_services = new TextField(model,"descricao_services");
		descricao_services.setLabel(gt("Descrição"));
		descricao_services.propertie().add("name","p_descricao_services").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		tipo_doc_ids = new CheckBoxField(model,"tipo_doc_ids");
		tipo_doc_ids.setLabel(gt(" "));
		tipo_doc_ids.propertie().add("name","p_tipo_doc_ids").add("type","checkbox").add("maxlength","30").add("java-type","int").add("switch","false").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		tipo_doc_ids_check = new CheckBoxField(model,"tipo_doc_ids_check");
		tipo_doc_ids_check.propertie().add("name","p_tipo_doc_ids").add("type","checkbox").add("maxlength","30").add("java-type","int").add("switch","false").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_tipo_doc = new TextField(model,"descricao_tipo_doc");
		descricao_tipo_doc.setLabel(gt("Descrição"));
		descricao_tipo_doc.propertie().add("name","p_descricao_tipo_doc").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		others_class_ids = new CheckBoxField(model,"others_class_ids");
		others_class_ids.setLabel(gt("   "));
		others_class_ids.propertie().add("name","p_others_class_ids").add("type","checkbox").add("maxlength","30").add("java-type","String").add("switch","false").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		others_class_ids_check = new CheckBoxField(model,"others_class_ids_check");
		others_class_ids_check.propertie().add("name","p_others_class_ids").add("type","checkbox").add("maxlength","30").add("java-type","String").add("switch","false").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_others_class = new TextField(model,"descricao_others_class");
		descricao_others_class.setLabel(gt("Descrição"));
		descricao_others_class.propertie().add("name","p_descricao_others_class").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		menu_ids = new CheckBoxField(model,"menu_ids");
		menu_ids.setLabel(gt("  "));
		menu_ids.propertie().add("name","p_menu_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		menu_ids_check = new CheckBoxField(model,"menu_ids_check");
		menu_ids_check.propertie().add("name","p_menu_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_menu = new TextField(model,"descricao_menu");
		descricao_menu.setLabel(gt("Descrição"));
		descricao_menu.propertie().add("name","p_descricao_menu").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		conexao_ids = new CheckBoxField(model,"conexao_ids");
		conexao_ids.setLabel(gt("   "));
		conexao_ids.propertie().add("name","p_conexao_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		conexao_ids_check = new CheckBoxField(model,"conexao_ids_check");
		conexao_ids_check.propertie().add("name","p_conexao_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_conexao = new TextField(model,"descricao_conexao");
		descricao_conexao.setLabel(gt("Descrição"));
		descricao_conexao.propertie().add("name","p_descricao_conexao").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		modulo_ids = new CheckBoxField(model,"modulo_ids");
		modulo_ids.setLabel(gt("    "));
		modulo_ids.propertie().add("name","p_modulo_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		modulo_ids_check = new CheckBoxField(model,"modulo_ids_check");
		modulo_ids_check.propertie().add("name","p_modulo_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_modulo = new TextField(model,"descricao_modulo");
		descricao_modulo.setLabel(gt("Descricao"));
		descricao_modulo.propertie().add("name","p_descricao_modulo").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		dao_ids = new CheckBoxField(model,"dao_ids");
		dao_ids.setLabel(gt("  "));
		dao_ids.propertie().add("name","p_dao_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		dao_ids_check = new CheckBoxField(model,"dao_ids_check");
		dao_ids_check.propertie().add("name","p_dao_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_dao = new TextField(model,"descricao_dao");
		descricao_dao.setLabel(gt("Descrição"));
		descricao_dao.propertie().add("name","p_descricao_dao").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		domain_ids = new CheckBoxField(model,"domain_ids");
		domain_ids.setLabel(gt("   "));
		domain_ids.propertie().add("name","p_domain_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		domain_ids_check = new CheckBoxField(model,"domain_ids_check");
		domain_ids_check.propertie().add("name","p_domain_ids").add("type","checkbox").add("maxlength","30").add("switch","false").add("java-type","String").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_domain = new TextField(model,"descricao_domain");
		descricao_domain.setLabel(gt("Descrição"));
		descricao_domain.propertie().add("name","p_descricao_domain").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		
		transation_ids = new CheckBoxField(model,"transation_ids");
		transation_ids.setLabel(gt("   "));
		transation_ids.propertie().add("name","p_transation_ids").add("type","checkbox").add("maxlength","30").add("java-type","String").add("switch","false").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		transation_ids_check = new CheckBoxField(model,"transation_ids_check");
		transation_ids_check.propertie().add("name","p_transation_ids").add("type","checkbox").add("maxlength","30").add("java-type","String").add("switch","false").add("showLabel","true").add("group_in","").add("check","true").add("desc","true");
		
		descricao_transation = new TextField(model,"descricao_transation");
		descricao_transation.setLabel(gt("Descrição"));
		descricao_transation.propertie().add("name","p_descricao_transation").add("type","text").add("maxlength","30").add("showLabel","true").add("group_in","");
		...
		btn_finalizar = new IGRPButton("Finalizar","igrp_studio","Wizard_export_step_2","finalizar","download","primary|fa-certificate","","");
		btn_finalizar.propertie.add("type","specific").add("rel","finalizar").add("refresh_components","");
	...
	public void render(){
		...
		table_others_class.addField(others_class_ids);
		table_others_class.addField(others_class_ids_check);
	...
	public void setModel(Model model) {
		...
		others_class_ids.setValue(model);
