	...
	public Response actionGuardar() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		if(Igrp.getInstance().getRequest().getMethod().equals("POST")){			
			...
			if(!isError){				
				...
				user.setPass_hash(cv.nosi.core.webapp.component.User.encryptToHash(username+ "" + model.getPassword(), "SHA-256"));
				...
				user.setAuth_key(cv.nosi.core.webapp.component.User.generateAuthenticationKey());
				user.setActivation_key(cv.nosi.core.webapp.component.User.generateActivationKey());
