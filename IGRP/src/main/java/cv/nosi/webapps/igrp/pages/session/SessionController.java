package cv.nosi.webapps.igrp.pages.session;
...
public class SessionController extends Controller {		
	...
	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		cv.nosi.webapps.igrp.dao.Session session = new cv.nosi.webapps.igrp.dao.Session();
		
		ArrayList<Session.Table_1> data = new ArrayList<>();
		List<cv.nosi.webapps.igrp.dao.Session> sessions = new ArrayList<cv.nosi.webapps.igrp.dao.Session>();
		try {
		...
		for(cv.nosi.webapps.igrp.dao.Session s : sessions ){
