...
import cv.nosi.core.webapp.security.PagesScapePermission;
import cv.nosi.core.webapp.security.Permission;
import cv.nosi.core.webapp.security.SecurtyCallPage;
import cv.nosi.webapps.igrp.pages.login.LoginController;
/**
...
public class User implements IComponent{
	...
	public boolean login(IIdentity identity, int expire){ // Make login and authenticate the user ... using session and cookies(remenberMe implementation purpose) 
