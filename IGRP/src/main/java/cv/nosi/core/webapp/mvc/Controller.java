package cv.nosi.core.webapp.mvc;
...
import cv.nosi.core.exception.ServerErrorHttpException;
import cv.nosi.core.gui.components.IGRPForm;
import cv.nosi.core.gui.components.IGRPMessage;
import cv.nosi.core.gui.components.IGRPView;
import cv.nosi.core.gui.fields.HiddenField;
import cv.nosi.core.gui.page.Page;
import cv.nosi.core.webapp.Igrp;
import cv.nosi.core.webapp.Response;
import cv.nosi.core.webapp.security.SecurtyCallPage;
import cv.nosi.core.webapp.util.Core;
import cv.nosi.core.webapp.util.QueryString;
import cv.nosi.core.webapp.util.constant.HttpStatus;
import cv.nosi.core.webapp.util.helpers.Route;
import cv.nosi.core.webapp.util.helpers.StringHelper;
...
import cv.nosi.core.webapp.workflow.activit.rest.entities.TaskVariableDetails;
import cv.nosi.core.webapp.workflow.activit.rest.services.TaskServiceRest;
import cv.nosi.core.webapp.workflow.bpmn.BPMNButton;
import cv.nosi.core.webapp.workflow.bpmn.BPMNConstants;
import cv.nosi.core.webapp.workflow.bpmn.BPMNHelper;
import cv.nosi.core.webapp.workflow.bpmn.BPMNTimeLine;
import cv.nosi.core.webapp.workflow.bpmn.DisplayDocmentType;
import cv.nosi.core.webapp.workflow.bpmn.InterfaceBPMNTask;
import cv.nosi.core.webapp.workflow.bpmn.RuntimeTask;
import cv.nosi.core.webapp.workflow.bpmn.ViewTaskDetails;
