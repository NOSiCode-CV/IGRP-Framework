...
import cv.nosi.base.ActiveRecord.ResolveColumnNameQuery;
...
public abstract class QueryHelper implements QueryInterface{
	...
	public QueryHelper(Object connectionName) {
		...
		this.connectionName = cv.nosi.core.webapp.util.helpers.database.Connection.getMyConnectionName(connectionName);
	}	
	...
	public ResultSet execute() {
		...
		Connection conn = cv.nosi.core.webapp.util.helpers.database.Connection.getConnection(this.getConnectionName());
		if(conn!=null) {
			try {
