package cv.nosi.core.cversion.svn;
...
public final class SvnClient {
    ...
    public SvnClient() { // load default values ... 
    ...
    public SvnClient(String svnUrl, String localUriPath, String workFolder) {
		this();
		this.svnUrl = svnUrl;
	...
	public SvnClient setSvnUrl(String svnUrl) {
		this.svnUrl = svnUrl;
		return this;
	}
	...
	public SvnClient setLocalUriPath(String localUriPath) {
		this.localUriPath = localUriPath;
		return this;
	}
	...
	public SvnClient setWorkFolder(String workFolder) {
		this.workFolder = workFolder;
		return this;
	}
	...
	public SvnClient setMessage(String message) {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
          SvnClient  svnapi = new SvnClient();
