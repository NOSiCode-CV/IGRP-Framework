...
public class EQUIPEListView extends View {
	...
	public EQUIPEListView(){

		this.setPageTitle("Listar EQUIPE");
			
		table_1 = new IGRPTable("table_1","Listar EQUIPE");
		...
		btn_new = new IGRPButton("New","human_resources","EQUIPEList","new","modal|refresh","success|fa-plus","","");
		btn_new.propertie.add("type","specific").add("rel","new");

		btn_update = new IGRPButton("Update","human_resources","EQUIPEList","update","mpsubmit|refresh","warning|fa-pencil","","");
		btn_update.propertie.add("type","specific").add("rel","update");

		btn_delete = new IGRPButton("Delete","human_resources","EQUIPEList","delete","confirm","danger|fa-trash","","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((EQUIPEList) model).getTable_1());
