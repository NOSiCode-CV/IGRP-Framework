...
public class ATRIBUICAOListView extends View {
	...
	public ATRIBUICAOListView(){

		this.setPageTitle("Listar ATRIBUICAO");
			
		table_1 = new IGRPTable("table_1","Listar ATRIBUICAO");
		...
		btn_new = new IGRPButton("New","human_resources","ATRIBUICAOList","new","modal|refresh","success|fa-plus","","");
		btn_new.propertie.add("type","specific").add("rel","new");

		btn_update = new IGRPButton("Update","human_resources","ATRIBUICAOList","update","mpsubmit|refresh","warning|fa-pencil","","");
		btn_update.propertie.add("type","specific").add("rel","update");

		btn_delete = new IGRPButton("Delete","human_resources","ATRIBUICAOList","delete","confirm","danger|fa-trash","","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((ATRIBUICAOList) model).getTable_1());
