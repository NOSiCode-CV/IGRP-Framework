...
public class TIPO_AVALIACAOListView extends View {
	...
	public TIPO_AVALIACAOListView(){

		this.setPageTitle("Listar TIPO_AVALIACAO");
			
		table_1 = new IGRPTable("table_1","Listar TIPO_AVALIACAO");
		...
		btn_new = new IGRPButton("New","human_resources","TIPO_AVALIACAOList","new","modal|refresh","success|fa-plus","","");
		btn_new.propertie.add("type","specific").add("rel","new");

		btn_update = new IGRPButton("Update","human_resources","TIPO_AVALIACAOList","update","mpsubmit|refresh","warning|fa-pencil","","");
		btn_update.propertie.add("type","specific").add("rel","update");

		btn_delete = new IGRPButton("Delete","human_resources","TIPO_AVALIACAOList","delete","confirm","danger|fa-trash","","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((TIPO_AVALIACAOList) model).getTable_1());
