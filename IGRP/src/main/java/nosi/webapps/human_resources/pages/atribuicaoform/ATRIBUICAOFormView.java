...
public class ATRIBUICAOFormView extends View {
	...
	public ATRIBUICAOFormView(){

		this.setPageTitle("Registar ATRIBUICAO");
			
		form_1 = new IGRPForm("form_1","Registar ATRIBUICAO");
		...
		btn_list = new IGRPButton("List","human_resources","ATRIBUICAOForm","list","_self","default|fa-list","","");
		btn_list.propertie.add("type","specific").add("rel","list");

		btn_save = new IGRPButton("Save","human_resources","ATRIBUICAOForm","save","submit","primary|fa-save","","");
