...
public class DEPARTAMENTOListController extends Controller {		

	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		
		DEPARTAMENTOList model = new DEPARTAMENTOList();
		model.load();
		DEPARTAMENTOListView view = new DEPARTAMENTOListView();
	...
	public Response actionDelete() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		----#gen-example */
		/*----#start-code(delete)----*/
		ResultSet r = Core.delete("devnosi","PAYB","DEPARTAMENTO").where("id=:id")
