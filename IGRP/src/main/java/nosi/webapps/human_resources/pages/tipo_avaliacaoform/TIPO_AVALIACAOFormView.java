...
public class TIPO_AVALIACAOFormView extends View {
	...
	public TIPO_AVALIACAOFormView(){

		this.setPageTitle("Registar TIPO_AVALIACAO");
			
		form_1 = new IGRPForm("form_1","Registar TIPO_AVALIACAO");
		...
		btn_list = new IGRPButton("List","human_resources","TIPO_AVALIACAOForm","list","_self","default|fa-list","","");
		btn_list.propertie.add("type","specific").add("rel","list");

		btn_save = new IGRPButton("Save","human_resources","TIPO_AVALIACAOForm","save","submit","primary|fa-save","","");
