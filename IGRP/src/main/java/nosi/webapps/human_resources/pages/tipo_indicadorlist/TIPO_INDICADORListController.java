...
public class TIPO_INDICADORListController extends Controller {		

	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		
		TIPO_INDICADORList model = new TIPO_INDICADORList();
		model.load();
		TIPO_INDICADORListView view = new TIPO_INDICADORListView();
	...
	public Response actionDelete() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		----#gen-example */
		/*----#start-code(delete)----*/
		ResultSet r = Core.delete("devnosi","PAYB","TIPO_INDICADOR").where("id=:id")
