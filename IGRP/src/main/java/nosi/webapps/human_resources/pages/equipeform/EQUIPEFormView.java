...
public class EQUIPEFormView extends View {
	...
	public EQUIPEFormView(){

		this.setPageTitle("Registar EQUIPE");
			
		form_1 = new IGRPForm("form_1","Registar EQUIPE");
		...
		btn_list = new IGRPButton("List","human_resources","EQUIPEForm","list","_self","default|fa-list","","");
		btn_list.propertie.add("type","specific").add("rel","list");

		btn_save = new IGRPButton("Save","human_resources","EQUIPEForm","save","submit","primary|fa-save","","");
