...
package nosi.webapps.human_resources.pages.departamentolist;
...
public class DEPARTAMENTOListView extends View {
	...
	public DEPARTAMENTOListView(){
		...
		this.setPageTitle("Listar DEPARTAMENTO");
			
		table_1 = new IGRPTable("table_1","Listar DEPARTAMENTO");
		...
		btn_new = new IGRPButton("New","human_resources","DEPARTAMENTOList","new","modal|refresh","success|fa-plus","","");
		btn_new.propertie.add("type","specific").add("rel","new");

		btn_update = new IGRPButton("Update","human_resources","DEPARTAMENTOList","update","mpsubmit|refresh","warning|fa-pencil","","");
		btn_update.propertie.add("type","specific").add("rel","update");

		btn_delete = new IGRPButton("Delete","human_resources","DEPARTAMENTOList","delete","confirm","danger|fa-trash","","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((DEPARTAMENTOList) model).getTable_1());
