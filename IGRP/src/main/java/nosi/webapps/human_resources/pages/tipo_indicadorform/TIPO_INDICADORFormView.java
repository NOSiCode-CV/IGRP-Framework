...
public class TIPO_INDICADORFormView extends View {
	...
	public TIPO_INDICADORFormView(){

		this.setPageTitle("Registar TIPO_INDICADOR");
			
		form_1 = new IGRPForm("form_1","Registar TIPO_INDICADOR");
		...
		nome.propertie().add("name","p_nome").add("type","text").add("maxlength","20").add("required","false");
		

		toolsbar_1 = new IGRPToolsBar("toolsbar_1");

		btn_list = new IGRPButton("List","human_resources","TIPO_INDICADORForm","list","_self","default|fa-list","","");
		btn_list.propertie.add("type","specific").add("rel","list");

		btn_save = new IGRPButton("Save","human_resources","TIPO_INDICADORForm","save","submit","primary|fa-save","","");
