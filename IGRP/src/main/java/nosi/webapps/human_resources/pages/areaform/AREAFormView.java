...
public class AREAFormView extends View {
	...
	public AREAFormView(){
		...
		this.setPageTitle("Registar AREA");
			
		form_1 = new IGRPForm("form_1","Registar AREA");
		...
		btn_list = new IGRPButton("List","human_resources","AREAForm","list","_self","default|fa-list","","");
		btn_list.propertie.add("type","specific").add("rel","list");

		btn_save = new IGRPButton("Save","human_resources","AREAForm","save","submit","primary|fa-save","","");
