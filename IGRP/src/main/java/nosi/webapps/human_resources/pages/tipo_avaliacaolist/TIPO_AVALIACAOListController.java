...
public class TIPO_AVALIACAOListController extends Controller {		

	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		
		TIPO_AVALIACAOList model = new TIPO_AVALIACAOList();
		model.load();
		TIPO_AVALIACAOListView view = new TIPO_AVALIACAOListView();
	...
	public Response actionDelete() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		----#gen-example */
		/*----#start-code(delete)----*/
		ResultSet r = Core.delete("devnosi","PAYB","TIPO_AVALIACAO").where("id=:id")
