...
public class PartilhageralController extends Controller {
	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		model.loadTable_1(Core.query(null,"SELECT '1' as estado,'Mollit elit sed perspiciatis labore laudantium totam sit iste natus elit deserunt ipsum consectetur' as nome "));
     ...
     //model.setDocumento(this.getConfig().getResolveUrl("tutorial","Listar_documentos","index&p_type=partilha")); 
      ...
      String dad = Core.getCurrentDad();
		...
		Optional.of(model.getAplicacao_origem()).ifPresent(v -> view.aplicacao_destino.setValue(new Application().getAllAppsActiveByFilterId(Core.toInt(v))));
...
/*----#start-code(custom_actions)----*/
	...
	private static class SortbyStatus implements Comparator<Partilhageral.Table_1> {
