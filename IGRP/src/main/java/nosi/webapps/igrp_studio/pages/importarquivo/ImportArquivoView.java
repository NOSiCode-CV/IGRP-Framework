...
public class ImportArquivoView extends View {
	...
	public ImportArquivoView(){
		...
		sectionheader_5_text.setValue(gt("Sectionheader"));
		...
		jar_file.propertie().add("name","p_jar_file").add("type","file").add("accept","[object Object]").add("targetrend","[object Object]").add("multiple","true").add("rendvalue","false").add("maxlength","10000").add("required","true");
		...
		sql_script.propertie().add("name","p_sql_script").add("type","file").add("accept","").add("targetrend","").add("multiple","false").add("rendvalue","false").add("maxlength","250").add("required","true");
