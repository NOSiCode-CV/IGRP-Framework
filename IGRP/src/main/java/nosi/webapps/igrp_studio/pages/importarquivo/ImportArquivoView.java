...
public class ImportArquivoView extends View {
	...
	public ImportArquivoView(){
		...
		arquivo_pagina.propertie().add("name","p_arquivo_pagina").add("type","file").add("accept","").add("targetrend","").add("multiple","false").add("rendvalue","false").add("maxlength","100").add("required","true");
