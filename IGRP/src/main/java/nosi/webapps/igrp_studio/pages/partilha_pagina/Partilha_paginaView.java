...
public class Partilha_paginaView extends View {
	...
	public Partilha_paginaView(){
		...
		btn_partilhar = new IGRPButton("Partilhar","igrp_studio","Partilha_pagina","partilhar","submit","success|fa-share-alt-square","","");
	...
	public void setModel(Partilha_pagina model) {
