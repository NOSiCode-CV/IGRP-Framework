...
public class Wizard_export_step_2View extends View {
	...
	public Wizard_export_step_2View(){
		...
		others_class_ids.propertie().add("name","p_others_class_ids").add("type","checkbox").add("maxlength","30").add("java-type","String").add("switch","false").add("showLabel","true").add("check","true").add("desc","true");
		
		others_class_ids_check = new CheckBoxField(model,"others_class_ids_check");
		others_class_ids_check.propertie().add("name","p_others_class_ids").add("type","checkbox").add("maxlength","30").add("java-type","String").add("switch","false").add("showLabel","true").add("check","true").add("desc","true");
