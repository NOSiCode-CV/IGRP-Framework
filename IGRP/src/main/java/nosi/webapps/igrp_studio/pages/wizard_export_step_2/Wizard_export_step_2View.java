...
public class Wizard_export_step_2View extends View {
	...
	public Wizard_export_step_2View(){
		...
		tipo_doc_ids.propertie().add("name","p_tipo_doc_ids").add("type","checkbox").add("maxlength","30").add("java-type","").add("switch","false").add("check","true").add("desc","true");
		
		tipo_doc_ids_check = new CheckBoxField(model,"tipo_doc_ids_check");
		tipo_doc_ids_check.propertie().add("name","p_tipo_doc_ids").add("type","checkbox").add("maxlength","30").add("java-type","").add("switch","false").add("check","true").add("desc","true");
		
		descricao_tipo_doc = new TextField(model,"descricao_tipo_doc");
		descricao_tipo_doc.setLabel(gt("Descrição"));
		descricao_tipo_doc.propertie().add("name","p_descricao_tipo_doc").add("type","text").add("maxlength","30");
		...
		btn_finalizar = new IGRPButton("Finalizar","igrp_studio","Wizard_export_step_2","finalizar","alert_submit","primary|fa-certificate","","");
