...
public class Editar_documentacaoView extends View {
	...
	public Editar_documentacaoView(){

		this.setPageTitle("Editar Documentação");
		...
		btn_editar = new IGRPButton("Editar","tutorial","Editar_documentacao","editar","mpsubmit|refresh","warning|fa-edit","","");
		btn_editar.propertie.add("type","specific").add("class","warning").add("rel","editar").add("refresh_components","");

		btn_eliminar = new IGRPButton("Eliminar","tutorial","Editar_documentacao","eliminar","confirm","danger|fa-times-circle-o","","");
	...
	public void setModel(Model model) {
		...
		table_1.loadModel(((Editar_documentacao) model).getTable_1());
		}
}
