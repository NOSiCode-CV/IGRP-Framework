...
public class GestaodeacessoController extends Controller {
	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		model.loadOrg_table(Core.query(null,"SELECT '1' as estado,'Aperiam natus magna aperiam to' as org_nome,'/IGRP/images/IGRP/IGRP2.3/app/igrp/dominio/Dominio.xml' as mostrar_perfis,'hidden-954b_9350' as id "));
