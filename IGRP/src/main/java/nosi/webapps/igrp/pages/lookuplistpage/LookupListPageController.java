...
public class LookupListPageController extends Controller {
	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		model.loadFormlist_1(Core.query(null,"SELECT '1' as checkbox,'1' as obrigatorio,'2' as tipo,'Ut anim adipiscing doloremque' as nome,'Totam sed ut lorem stract' as descricao_documento,'hidden-cb00_211f' as type_doc "));
		model.loadTable_1(Core.query(null,"SELECT 'Unde ipsum ut sit officia' as descricao,'Sit adipiscing consectetur sit' as nome_pagina,'hidden-22d9_24cb' as id "));
