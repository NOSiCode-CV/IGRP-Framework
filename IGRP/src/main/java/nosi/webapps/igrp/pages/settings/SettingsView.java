...
public class SettingsView extends View {
	...
	public SettingsView(){
		...
		sectionheader_1_text.setValue(gt("<p>&Aacute;rea pessoal de</p>"));
		sectionheader_1_text.propertie().add("type","text").add("name","p_sectionheader_1_text").add("maxlength","4000");
		
		nome = new TextField(model,"nome");
		nome.setLabel(gt("Nome"));
		nome.propertie().add("name","p_nome").add("type","text").add("maxlength","100").add("class","default").add("img","fa-user").add("showlabel","true");
		
		email = new TextField(model,"email");
		email.setLabel(gt("Email"));
		email.propertie().add("name","p_email").add("type","text").add("maxlength","100").add("class","default").add("img","fa-at").add("showlabel","true");
		
		username = new TextField(model,"username");
		username.setLabel(gt("Username"));
		username.propertie().add("name","p_username").add("type","text").add("maxlength","30").add("class","default").add("img","fa-user-circle").add("showlabel","true");
		
		telefone = new TextField(model,"telefone");
		telefone.setLabel(gt("Telefone"));
		telefone.propertie().add("name","p_telefone").add("type","text").add("maxlength","30").add("class","default").add("img","fa-phone").add("showlabel","true");
		
		telemovel = new TextField(model,"telemovel");
		telemovel.setLabel(gt("Telemóvel"));
		telemovel.propertie().add("name","p_telemovel").add("type","text").add("maxlength","30").add("class","default").add("img","fa-mobile").add("showlabel","true");
		
		cni = new TextField(model,"cni");
		cni.setLabel(gt("CNI"));
		cni.propertie().add("name","p_cni").add("type","text").add("maxlength","250").add("class","default").add("img","fa-id-card-o").add("showlabel","true");
		
		ultimo_acesso_igrp = new TextField(model,"ultimo_acesso_igrp");
		ultimo_acesso_igrp.setLabel(gt("Ultimo Acesso IGRP"));
		ultimo_acesso_igrp.propertie().add("name","p_ultimo_acesso_igrp").add("type","text").add("maxlength","30").add("class","default").add("img","fa-hourglass-end").add("showlabel","true");
		...
		ultimo_acesso_rede_estado.propertie().add("name","p_ultimo_acesso_rede_estado").add("type","text").add("maxlength","30").add("class","default").add("img","fa-hourglass-o").add("showlabel","true");
		
		password_expira_em = new TextField(model,"password_expira_em");
		password_expira_em.setLabel(gt("Password Expira em"));
		password_expira_em.propertie().add("name","p_password_expira_em").add("type","text").add("maxlength","30").add("class","default").add("img","fa-unlock-alt").add("showlabel","true");
