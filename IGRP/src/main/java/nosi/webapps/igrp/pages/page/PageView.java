...
public class PageView extends View {
	...
	public PageView(){
		...
		gen_auto_code.propertie().add("name","p_gen_auto_code").add("type","checkbox").add("maxlength","30").add("required","false").add("check","true");
		...
		p_action_descr = new HiddenField(model,"p_action_descr");
		p_action_descr.setLabel(gt(""));
		p_action_descr.propertie().add("name","p_action_descr").add("type","hidden").add("maxlength","30").add("java-type","").add("tag","action_descr");
	...
	public void render(){
		...
		form_1.addField(p_action_descr);
