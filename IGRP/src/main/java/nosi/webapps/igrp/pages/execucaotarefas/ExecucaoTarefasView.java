...
public class ExecucaoTarefasView extends View {
	...
	public IGRPTabContent exec_task_tabs;
	...
	public ExecucaoTarefasView(){
		...
		exec_task_tabs = new IGRPTabContent("exec_task_tabs","");
	...
	public void render(){
		...
		exec_task_tabs.addField(disponiveis);
		exec_task_tabs.addField(minhas_tarefas);
		exec_task_tabs.addField(estatistica);
		exec_task_tabs.addField(gerir_tarefas);
		exec_task_tabs.addField(colaboradores);
