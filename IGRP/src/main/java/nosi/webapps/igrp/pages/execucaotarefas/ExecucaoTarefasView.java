...
public class ExecucaoTarefasView extends View {
	...
	public ExecucaoTarefasView(){
		...
		disponiveis.propertie().add("name","p_disponiveis").add("type","button").add("request_fields","").add("refresh_submit","false").add("maxlength","50");
		
		minhas_tarefas = new TextField(model,"minhas_tarefas");
		minhas_tarefas.setLabel(gt("Minhas Tarefas"));
		minhas_tarefas.propertie().add("name","p_minhas_tarefas").add("type","button").add("request_fields","").add("refresh_submit","false").add("maxlength","50");
		
		estatistica = new TextField(model,"estatistica");
		estatistica.setLabel(gt("Estatística"));
		estatistica.propertie().add("name","p_estatistica").add("type","button").add("request_fields","").add("refresh_submit","false").add("maxlength","50");
		
		gerir_tarefas = new TextField(model,"gerir_tarefas");
		gerir_tarefas.setLabel(gt("Gerir Tarefas"));
		gerir_tarefas.propertie().add("name","p_gerir_tarefas").add("type","button").add("request_fields","").add("refresh_submit","false").add("maxlength","50");
		
		colaboradores = new TextField(model,"colaboradores");
		colaboradores.setLabel(gt("Colaboradores"));
		colaboradores.propertie().add("name","p_colaboradores").add("type","button").add("request_fields","").add("refresh_submit","false").add("maxlength","50");
		...
		btn_pesquisar_button_disponiveis = new IGRPButton("Pesquisar","igrp","ExecucaoTarefas","pesquisar_button_disponiveis","submit_form","primary|fa-search","","");
		btn_pesquisar_button_disponiveis.propertie.add("type","form").add("rel","pesquisar_button_disponiveis");

		btn_pesquisar_button_minhas_tarefas = new IGRPButton("Pesquisar","igrp","ExecucaoTarefas","pesquisar_button_minhas_tarefas","submit_form","primary|fa-search","","");
		btn_pesquisar_button_minhas_tarefas.propertie.add("type","form").add("rel","pesquisar_button_minhas_tarefas");

		btn_pesquisar_tarefa = new IGRPButton("Pesquisar","igrp","ExecucaoTarefas","pesquisar_tarefa","submit_form","primary|fa-search","","");
		btn_pesquisar_tarefa.propertie.add("type","form").add("rel","pesquisar_tarefa");

		btn_pesquisar_colaborador = new IGRPButton("Pesquisar","igrp","ExecucaoTarefas","pesquisar_colaborador","submit_form","primary|fa-search","","");
		btn_pesquisar_colaborador.propertie.add("type","form").add("rel","pesquisar_colaborador");

		btn_pesquisar_estatistica = new IGRPButton("Pesquisar","igrp","ExecucaoTarefas","pesquisar_estatistica","submit_form","primary|fa-search","","");
