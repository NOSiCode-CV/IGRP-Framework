...
public class ExecucaoTarefasView extends View {
	...
	public ExecucaoTarefasView(){
		...
		tipo_processo_gerir_tarefa.propertie().add("name","p_tipo_processo_gerir_tarefa").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		numero_processo_gerir_tarefa.propertie().add("name","p_numero_processo_gerir_tarefa").add("type","text").add("maxlength","30").add("required","false");
		
		data_inicio_gerir_tarefa = new DateField(model,"data_inicio_gerir_tarefa");
		data_inicio_gerir_tarefa.setLabel(gt("Data inicio"));
		data_inicio_gerir_tarefa.propertie().add("name","p_data_inicio_gerir_tarefa").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		data_fim_gerir_tarefa = new DateField(model,"data_fim_gerir_tarefa");
		data_fim_gerir_tarefa.setLabel(gt("Data Fim"));
		data_fim_gerir_tarefa.propertie().add("name","p_data_fim_gerir_tarefa").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		prioridade_gerir_tarefa = new ListField(model,"prioridade_gerir_tarefa");
		prioridade_gerir_tarefa.setLabel(gt("Prioridade"));
		prioridade_gerir_tarefa.propertie().add("name","p_prioridade_gerir_tarefa").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		tipo_processo_colaborador.propertie().add("name","p_tipo_processo_colaborador").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		numero_processo_colaborador.propertie().add("name","p_numero_processo_colaborador").add("type","text").add("maxlength","30").add("required","false");
		
		tipo_etapa_colaborador = new ListField(model,"tipo_etapa_colaborador");
		tipo_etapa_colaborador.setLabel(gt("Tipo Etapa"));
		tipo_etapa_colaborador.propertie().add("name","p_tipo_etapa_colaborador").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		
		data_inicio_colaborador = new DateField(model,"data_inicio_colaborador");
		data_inicio_colaborador.setLabel(gt("Data Inicio"));
		data_inicio_colaborador.propertie().add("name","p_data_inicio_colaborador").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		data_fim_colaborador = new DateField(model,"data_fim_colaborador");
		data_fim_colaborador.setLabel(gt("Data Fim"));
		data_fim_colaborador.propertie().add("name","p_data_fim_colaborador").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		prioridade_colaborador = new ListField(model,"prioridade_colaborador");
		prioridade_colaborador.setLabel(gt("Prioridade"));
		prioridade_colaborador.propertie().add("name","p_prioridade_colaborador").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		tipo_processo_minhas_tarefas.propertie().add("name","p_tipo_processo_minhas_tarefas").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		numero_processo_minhas_tarefas.propertie().add("name","p_numero_processo_minhas_tarefas").add("type","text").add("maxlength","30").add("required","false");
		
		data_inicio_minhas_tarefas = new DateField(model,"data_inicio_minhas_tarefas");
		data_inicio_minhas_tarefas.setLabel(gt("Data Inicio"));
		data_inicio_minhas_tarefas.propertie().add("name","p_data_inicio_minhas_tarefas").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		data_fim_minhas_tarefas = new DateField(model,"data_fim_minhas_tarefas");
		data_fim_minhas_tarefas.setLabel(gt("Data Fim"));
		data_fim_minhas_tarefas.propertie().add("name","p_data_fim_minhas_tarefas").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		prioridade_minhas_tarefas = new ListField(model,"prioridade_minhas_tarefas");
		prioridade_minhas_tarefas.setLabel(gt("Prioridade"));
		prioridade_minhas_tarefas.propertie().add("name","p_prioridade_minhas_tarefas").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		tipo_processo_form_disponiveis.propertie().add("name","p_tipo_processo_form_disponiveis").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		numero_processo_form_disponiveis.propertie().add("name","p_numero_processo_form_disponiveis").add("type","text").add("maxlength","30").add("required","false");
		
		data_inicio_form_disponiveis = new DateField(model,"data_inicio_form_disponiveis");
		data_inicio_form_disponiveis.setLabel(gt("Data Inicio"));
		data_inicio_form_disponiveis.propertie().add("name","p_data_inicio_form_disponiveis").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		data_fim_form_disponiveis = new DateField(model,"data_fim_form_disponiveis");
		data_fim_form_disponiveis.setLabel(gt("Data Fim"));
		data_fim_form_disponiveis.propertie().add("name","p_data_fim_form_disponiveis").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		...
		prioridade_form_disponiveis.propertie().add("name","p_prioridade_form_disponiveis").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		tipo_processo_estatistica.propertie().add("name","p_tipo_processo_estatistica").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		...
		numero_processo_estatistica.propertie().add("name","p_numero_processo_estatistica").add("type","text").add("maxlength","30").add("required","false");
		
		data_inicio_estatistica = new DateField(model,"data_inicio_estatistica");
		data_inicio_estatistica.setLabel(gt("Data Inicio"));
		data_inicio_estatistica.propertie().add("name","p_data_inicio_estatistica").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		data_fim_estatistica = new DateField(model,"data_fim_estatistica");
		data_fim_estatistica.setLabel(gt("Data Fim"));
		data_fim_estatistica.propertie().add("name","p_data_fim_estatistica").add("type","date").add("maxlength","30").add("required","false").add("range","false");
		
		prioridade_estatistica = new ListField(model,"prioridade_estatistica");
		prioridade_estatistica.setLabel(gt("Prioridade"));
		prioridade_estatistica.propertie().add("name","p_prioridade_estatistica").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		
		estado_estatistica = new ListField(model,"estado_estatistica");
		estado_estatistica.setLabel(gt("Estado"));
		estado_estatistica.propertie().add("name","p_estado_estatistica").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("tags","false").add("java-type","");
		
		numero_processo_tabela = new TextField(model,"numero_processo_tabela");
		numero_processo_tabela.setLabel(gt("Nº mero Processo"));
		...
		p_id_g.setLabel(gt(""));
		p_id_g.propertie().add("name","p_p_id_g").add("type","hidden").add("maxlength","30").add("tag","p_id_g");
		...
		n_tarefas_colab_tabela.setLabel(gt("N. Tarefas"));
		...
		n_atendimento_colab_tabela.setLabel(gt("N. Atendimento"));
		...
		percentagem_colab_tabela.setLabel(gt("Percentagem"));
		...
		p_id_c.setLabel(gt(""));
		p_id_c.propertie().add("name","p_p_id_c").add("type","hidden").add("maxlength","30").add("tag","p_id_c");
		
		n_processo_estat_tabela = new TextField(model,"n_processo_estat_tabela");
		n_processo_estat_tabela.setLabel(gt("N. Processo"));
		...
		p_id_e.setLabel(gt(""));
		p_id_e.propertie().add("name","p_p_id_e").add("type","hidden").add("maxlength","30").add("tag","p_id_e");
		
		n_tarefa_m = new TextField(model,"n_tarefa_m");
		n_tarefa_m.setLabel(gt("Nº de Tarefa"));
		...
		n_tarefa_d.setLabel(gt("Nº de Tarefa"));
		...
		p_id_d.setLabel(gt(""));
		p_id_d.propertie().add("name","p_p_id_d").add("type","hidden").add("maxlength","30").add("tag","p_id_d");
		...
		btn_detalhes_tarefa = new IGRPButton("Detalhes Tarefa","igrp","ExecucaoTarefas","detalhes_tarefa","modal","info|fa-tasks","","");
		btn_detalhes_tarefa.propertie.add("type","specific").add("rel","detalhes_tarefa");

		btn_detalhes_processo = new IGRPButton("Detalhes Processo","igrp","ExecucaoTarefas","detalhes_processo","modal","grey|fa-reorder","","");
		...
		btn_ver_estatistica = new IGRPButton("Ver Estatistica","igrp","ExecucaoTarefas","ver_estatistica","modal","default|fa-angle-right","","");
		btn_ver_estatistica.propertie.add("type","specific").add("rel","ver_estatistica");

		btn_ver_detalhes = new IGRPButton("Ver Detalhes","igrp","ExecucaoTarefas","ver_detalhes","modal","default|fa-angle-right","","");
		btn_ver_detalhes.propertie.add("type","specific").add("rel","ver_detalhes");

		btn_enviar_msg = new IGRPButton("Enviar Msg","igrp","ExecucaoTarefas","enviar_msg","modal","default|fa-angle-right","","");
		...
		btn_detalhes_minha_tarefa = new IGRPButton("Detalhes Tarefa","igrp","ExecucaoTarefas","detalhes_minha_tarefa","modal","info|fa-tasks","","");
		btn_detalhes_minha_tarefa.propertie.add("type","specific").add("rel","detalhes_minha_tarefa");

		btn_detalhes_processos_button_minha_tarefas = new IGRPButton("Detalhes Processos","igrp","ExecucaoTarefas","detalhes_processos_button_minha_tarefas","modal","grey|fa-reorder","","");
		btn_detalhes_processos_button_minha_tarefas.propertie.add("type","specific").add("rel","detalhes_processos_button_minha_tarefas");

		btn_leberar_tarefa_button_minha_tarefas = new IGRPButton("Leberar Tarefa","igrp","ExecucaoTarefas","leberar_tarefa_button_minha_tarefas","alert_submit","warning|fa-free-code-camp","","");
