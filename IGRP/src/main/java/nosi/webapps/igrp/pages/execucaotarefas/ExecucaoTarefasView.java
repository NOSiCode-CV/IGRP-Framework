...
public class ExecucaoTarefasView extends View {
	...
	public Field limite_maximo_de_registos_dist_taref;
	...
	public Field limite_maximo_de_registos_minhas_taref;
	...
	public Field tarefa_gerir_tarefa;
	public Field ________;
	public Field atribuido_por_gerir_tarefa;
	public Field atribuido_a_gerir_tarefa;
	public Field prioridade_gerir_tarefa;
	public Field nada_;
	public Field data_inicio_gerir_tarefa;
	public Field data_fim_gerir_tarefa;
	public Field limite_maximo_de_registos_gerir_tarefa;
	...
	public IGRPTabContent exex_task_tabs;
	...
	public ExecucaoTarefasView(){
		...
		exex_task_tabs = new IGRPTabContent("exex_task_tabs","");
		...
		limite_maximo_de_registos_dist_taref = new NumberField(model,"limite_maximo_de_registos_dist_taref");
		limite_maximo_de_registos_dist_taref.setLabel(gt("Limite máximo de registos"));
		limite_maximo_de_registos_dist_taref.propertie().add("name","p_limite_maximo_de_registos_dist_taref").add("type","number").add("min","").add("max","").add("calculation","false").add("mathcal","").add("numberformat","").add("maxlength","250").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false").add("java-type","").add("tooltip","false").add("disable_copy_paste","false");
		...
		limite_maximo_de_registos_minhas_taref = new NumberField(model,"limite_maximo_de_registos_minhas_taref");
		limite_maximo_de_registos_minhas_taref.setLabel(gt("Limite máximo de registos"));
		limite_maximo_de_registos_minhas_taref.propertie().add("name","p_limite_maximo_de_registos_minhas_taref").add("type","number").add("min","").add("max","").add("calculation","false").add("mathcal","").add("numberformat","").add("maxlength","250").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false").add("java-type","").add("tooltip","false").add("disable_copy_paste","false");
		...
		tipo_processo_gerir_tarefa.propertie().add("remote-step",Core.getIGRPLink("igrp","ExecucaoTarefas","step")).add("name","p_tipo_processo_gerir_tarefa").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","false").add("disabled","false").add("tags","false").add("java-type","").add("load_service_data","false").add("tooltip","false").add("disable_copy_paste","false");
		...
		tarefa_gerir_tarefa = new ListField(model,"tarefa_gerir_tarefa");
		tarefa_gerir_tarefa.setLabel(gt("Tarefa (etapa)"));
		tarefa_gerir_tarefa.propertie().add("name","p_tarefa_gerir_tarefa").add("type","select").add("multiple","false").add("tags","false").add("load_service_data","false").add("domain","").add("maxlength","250").add("required","false").add("disabled","false").add("java-type","").add("tooltip","false").add("disable_copy_paste","false");
		
		________ = new SeparatorField(model,"________");
		________.setLabel(gt(""));
		________.propertie().add("name","p_________").add("type","separator").add("maxlength","250").add("placeholder",gt("")).add("desclabel","false").add("tooltip","false").add("disable_copy_paste","false");
		
		atribuido_por_gerir_tarefa = new ListField(model,"atribuido_por_gerir_tarefa");
		atribuido_por_gerir_tarefa.setLabel(gt("Atribuido por"));
		atribuido_por_gerir_tarefa.propertie().add("name","p_atribuido_por_gerir_tarefa").add("type","select").add("multiple","false").add("tags","false").add("load_service_data","false").add("domain","").add("maxlength","250").add("required","false").add("disabled","false").add("java-type","").add("tooltip","false").add("disable_copy_paste","false");
		
		atribuido_a_gerir_tarefa = new ListField(model,"atribuido_a_gerir_tarefa");
		atribuido_a_gerir_tarefa.setLabel(gt("Atribuido a"));
		atribuido_a_gerir_tarefa.propertie().add("name","p_atribuido_a_gerir_tarefa").add("type","select").add("multiple","false").add("tags","false").add("load_service_data","false").add("domain","").add("maxlength","250").add("required","false").add("disabled","false").add("java-type","").add("tooltip","false").add("disable_copy_paste","false");
		...
		limite_maximo_de_registos_gerir_tarefa = new NumberField(model,"limite_maximo_de_registos_gerir_tarefa");
		limite_maximo_de_registos_gerir_tarefa.setLabel(gt("Limite máximo de registos"));
		limite_maximo_de_registos_gerir_tarefa.propertie().add("name","p_limite_maximo_de_registos_gerir_tarefa").add("type","number").add("min","").add("max","").add("calculation","false").add("mathcal","").add("numberformat","").add("maxlength","250").add("required","false").add("readonly","false").add("disabled","false").add("placeholder",gt("")).add("desclabel","false").add("java-type","").add("tooltip","false").add("disable_copy_paste","false");
		...
		tarefas_tabela_disponiveis.setLabel(gt("Tarefa (etapa)"));
		...
		desc_tarefa_estat_tabela.setLabel(gt("Tarefa (etapa)"));
		...
		desc_tarefa.setLabel(gt("Tarefa (etapa)"));
		...
		desc_tarefa_tabela_minhas_tarefas.setLabel(gt("Tarefa (etapa)"));
		...
		btn_transferir_tarefa = new IGRPButton("Transferir Tarefa","igrp","ExecucaoTarefas","transferir_tarefa","mpsubmit","primary|fa-exchange","","");
	...
	public void render(){
		...
		exex_task_tabs.addField(disponiveis);
		exex_task_tabs.addField(minhas_tarefas);
		exex_task_tabs.addField(estatistica);
		exex_task_tabs.addField(gerir_tarefas);
		exex_task_tabs.addField(colaboradores);
		...
		form_disponiveis.addField(limite_maximo_de_registos_dist_taref);
		...
		form_minhas_tarefas.addField(limite_maximo_de_registos_minhas_taref);
		...
		form_gerir_tarefa.addField(tarefa_gerir_tarefa);
		form_gerir_tarefa.addField(________);
		form_gerir_tarefa.addField(atribuido_por_gerir_tarefa);
		form_gerir_tarefa.addField(atribuido_a_gerir_tarefa);
		...
		form_gerir_tarefa.addField(limite_maximo_de_registos_gerir_tarefa);
	...
	public void setModel(Model model) {
		...
		limite_maximo_de_registos_dist_taref.setValue(model);
		...
		limite_maximo_de_registos_minhas_taref.setValue(model);
		...
		tarefa_gerir_tarefa.setValue(model);
		________.setValue(model);
		atribuido_por_gerir_tarefa.setValue(model);
		atribuido_a_gerir_tarefa.setValue(model);
		...
		limite_maximo_de_registos_gerir_tarefa.setValue(model);
