...
public class ExecucaoTarefasView extends View {
	...
	public ExecucaoTarefasView(ExecucaoTarefas model){
		...
		n_tarefas_cocluidas_view_estatistica.setLabel(gt("Nº Tarefas Concluídas"));
		...
		n_tarefas_pendentes_view_estatistica.setLabel(gt("Nº Tarefas Pendentes"));
		...
		n_atendimento_dia_view_estatistica.setLabel(gt("Nº Atendimento Dia"));
