...
public class DominioView extends View {		
	...
	public DominioView(Dominio model){			
		...
		btn_pesquisar = new IGRPButton(gt("Pesquisar"),"RED","Teste","Action","_self","default|fa-search","default||fa-search|www","http://igrp.teste.gov.cv/images/IGRP/Teste.xml");
		btn_pesquisar.propertie.add("type","specific").add("code","").add("rel","pesquisar");
		btn_novo = new IGRPButton(gt("Novo"),"RED","Teste","Action","_self","success|fa-plus-circle","default||fa-plus-circle|www","http://igrp.teste.gov.cv/images/IGRP/Teste.xml");
