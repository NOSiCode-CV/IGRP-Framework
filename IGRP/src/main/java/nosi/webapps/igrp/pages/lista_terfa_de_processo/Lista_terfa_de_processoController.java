	...
	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		if(Core.isNotNull(processInstanceId)) {
			...
			for(TaskServiceQuery task : taskQuery.queryHistoryTask(processKey)) {
				...
				t.setData_inicio(Core.convertTimeStampToDateString(task.getStartTime(), "yyyy-MM-dd HH:mm:ss"));
				t.setData_fim(Core.convertTimeStampToDateString(task.getEndTime(), "yyyy-MM-dd HH:mm:ss"));
