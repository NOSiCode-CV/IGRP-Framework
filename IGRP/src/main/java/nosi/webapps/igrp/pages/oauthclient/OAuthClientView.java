...
public class OAuthClientView extends View {
	...
	public OAuthClientView(OAuthClient model){
		...
		scope.propertie().add("name","p_scope").add("type","select").add("multiple","true").add("domain","").add("maxlength","30").add("required","false").add("change","false").add("disabled","false").add("right","false").add("java-type","");
