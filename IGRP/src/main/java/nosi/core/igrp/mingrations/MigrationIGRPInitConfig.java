...
//			config = new Config("igrp_images", "FrontIGRP");
			...
			User user0_IGRP = new User("IGRP SysAdmin", "igrpweb@nosi.cv", nosi.core.webapp.component.User.encryptToHash("igrpweb@nosi.cvigrp.admin.Pa$$w0rd", "SHA-256"), "ADMIN", null, 1, null, "123456789", "igrpweb@nosi.cv",null, null, null, null, null,"123456789", 2017, 2017);
			user0_IGRP = user0_IGRP.insert();
			User user1demo = new User("Nositeste", "demo@nosi.cv", nosi.core.webapp.component.User.encryptToHash("demo@nosi.cvdemo", "SHA-256"), "ADMIN", null, 1, null, "123456789", "demo@nosi.cv",null, null, null, null, null,"123456", 2017, 2017);
