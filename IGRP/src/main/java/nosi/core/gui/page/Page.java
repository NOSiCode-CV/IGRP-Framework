...
public class Page{
	...
	private void createTemplate(){
		...
		XMLWritter xml = new XMLWritter("rows", path_xsl+vTimeStamp, "utf-8");
	...
	private String[] resolveViewContext(String defaultApp, String defaultPage) {
		...
		Package viewPackage = this.view.getClass().getPackage();
		String packageName = viewPackage != null ? viewPackage.getName() : "";
