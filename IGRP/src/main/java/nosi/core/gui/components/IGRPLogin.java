...
public class IGRPLogin extends IGRPForm{
	...
	public String toString(){
		...
		this.xml.setElement("action", "app/webapps?r=igrp/login/login"/*Igrp.getInstance().getRequest().getRequestURL().toString() + "?" + Igrp.getInstance().getRequest().getQueryString()*/);
