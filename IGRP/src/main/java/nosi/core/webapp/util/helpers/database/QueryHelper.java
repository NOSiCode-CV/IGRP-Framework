...
public abstract class QueryHelper implements QueryInterface{
	...
	public QueryHelper(Object connectionName) {
		...
		this.connectionName = nosi.core.webapp.util.helpers.database.Connection.getMyConnectionName(connectionName);
	}	
	...
	public ResultSet execute() {
		...
		Connection conn = nosi.core.webapp.util.helpers.database.Connection.getConnection(this.getConnectionName());
		if(conn!=null) {
			try {
