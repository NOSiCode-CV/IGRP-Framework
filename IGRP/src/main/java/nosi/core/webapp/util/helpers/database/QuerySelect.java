...
public class QuerySelect extends CommonFIlter{
	...
	public ResultSet executeQuery(Config_env env) {
		return executeQuery(nosi.core.webapp.util.helpers.database.Connection.getConnection(env));
	}
	
	public ResultSet executeQuery(String connectionName) {
		return executeQuery(nosi.core.webapp.util.helpers.database.Connection.getConnection(connectionName));
	}
