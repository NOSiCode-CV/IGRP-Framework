...
public class ReportImport extends AbstractImport implements IImport {
		...
		if (sources != null) {
			sources.forEach(source -> {
				...
				if (repSource == null) {					
					...
					mapReportSource(source, config, repSource, app);
	...
	private void mapReportSource(ReportSourcesSerializable source, Config_env config, RepSource repSource, Application app) {
