...
public enum OptionsImportExport {
	...
	OTHERS_CLASS(9,"Outras classes","OthersClass"),TRANSATION(10,"Transations","Transations"),DOCUMENT_TYPE(11,"Tipo Documento","DocumentType");//,SERVICE(9,"Serviços","Services");
