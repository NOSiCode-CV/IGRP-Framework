...
public class Report extends Controller{
	...
	public Report setContraProva(String contraProva) {
		 ...
		 * @throws IOException 
		 */
		public Response processPDF(String filename, CLob cLob, String xml) throws TransformerFactoryConfigurationError, IOException {
			try {
				...
				String xsl = new String(cLob.getC_lob_content());
				xsl = xsl.replace(
...
//					return this.renderView(doc.toString());
			...
			//Ver PDF ou Download direto
				return this.xSend(actual.toByteArray(),System.currentTimeMillis()+"_"+filename, "application/pdf",false);
