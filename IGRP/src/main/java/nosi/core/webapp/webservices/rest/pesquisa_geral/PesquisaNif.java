...
public class PesquisaNif implements Serializable{
	...
	public String toString() {
		return "PesquisaNif [NU_NIF=" + NU_NIF + ", NM_CONTRIBUINTE=" + NM_CONTRIBUINTE + ", DT_NASC=" + DT_NASC
				+ ", NM_PAI=" + NM_PAI + ", NM_MAE=" + NM_MAE + ", NU_BI=" + NU_BI + "]";
	}
	public PesquisaNif getListNif(String json) {
		return (PesquisaNif) Core.fromJsonWithJsonBuilder(json, new TypeToken<PesquisaNif>() {
