   ...
   /**
	...
	public T whereBetween(String columnName, Object o1, Object o2) {
		if (Core.isNotNullMultiple(columnName, o1, o2) && o1.getClass().equals(o2.getClass())) {
			...
			String paramName1 = paramBase + "1";
			String paramName2 = paramBase + "2";
			Class<?> classType = this.resolveBetweenClassType(columnName, o1);
			this.where("");
			this.filterWhere(recq.resolveColumnName(this.getAlias(), columnName) + " BETWEEN :" + paramName1 + " AND :" + paramName2 + " ");
			this.addParameter(columnName, paramName1, this.resolveBetweenValue(o1, classType), classType);
			this.addParameter(columnName, paramName2, this.resolveBetweenValue(o2, classType), classType);
		}
		return (T) this;
	}
