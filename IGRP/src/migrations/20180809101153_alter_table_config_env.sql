...
ALTER TABLE public.tbl_config_env ADD COLUMN url_connection character varying(150) NOT NULL;;
ALTER TABLE public.tbl_config_env ADD COLUMN driver_connection character varying(120) NOT NULL;