...
public class ImportArquivoView extends View {
	...
	public ImportArquivoView(ImportArquivo model){
		this.setPageTitle(gt("Import Arquivo"));
		...
		sectionheader_1_text.setValue(gt("Import Arquivos Jar/Zip (Páginas/Aplicações)"));
		...
		btn_btm_import_aplicacao = new IGRPButton(gt("Import"),"igrp","ImportArquivo","btm_import_aplicacao","submit_form","success|fa-download","","");
		btn_btm_import_aplicacao.propertie.add("type","form").add("code","").add("class","success").add("rel","btm_import_aplicacao");
		btn_btm_importar_page = new IGRPButton(gt("Import"),"igrp","ImportArquivo","btm_importar_page","submit_form","success|fa-download","","");
