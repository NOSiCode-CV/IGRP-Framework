...
public class ImportArquivoView extends View {
	...
	public ImportArquivoView(ImportArquivo model){
		...
		importar_jar_file.setLabel("Importar Jar File");
		...
		btn_btm_import_aplicacao = new IGRPButton("Import","igrp","ImportArquivo","btm_import_aplicacao","submit_form","success|fa-upload","","");
		btn_btm_import_aplicacao.propertie.add("type","form").add("code","").add("class","success").add("rel","btm_import_aplicacao");
		btn_btm_importar_page = new IGRPButton("Import","igrp","ImportArquivo","btm_importar_page","submit_form","success|fa-upload","","");
		btn_btm_importar_page.propertie.add("type","form").add("code","").add("class","success").add("rel","btm_importar_page");
		btn_importar_jar_file = new IGRPButton("Importar","igrp","ImportArquivo","importar_jar_file","submit_form","success|fa-upload","","");
