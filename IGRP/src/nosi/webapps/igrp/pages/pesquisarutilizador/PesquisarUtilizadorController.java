...
public class PesquisarUtilizadorController extends Controller {		
	...
	public Response actionIndex() throws IOException, IllegalArgumentException, IllegalAccessException{
		...
		if(Igrp.getInstance().getRequest().getMethod().toUpperCase().equals("POST")){
      	...
      	int idApp = (model.getAplicacao()!=null && !model.getAplicacao().equals(""))?Integer.parseInt(model.getAplicacao()):0;
      	int idOrg = (model.getOrganica()!=null && !model.getOrganica().equals(""))?Integer.parseInt(model.getOrganica()):0;
