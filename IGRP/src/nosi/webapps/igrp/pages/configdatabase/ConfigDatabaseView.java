...
public class ConfigDatabaseView extends View {
	...
	public ConfigDatabaseView(ConfigDatabase model){
		...
		nome_de_conxeao.setLabel(gt("Nome de Conxeão"));
		...
		btn_testar_conexao = new IGRPButton(gt("Testar Conexão"),"igrp","ConfigDatabase","testar_conexao","submit","success|fa-check","","");
