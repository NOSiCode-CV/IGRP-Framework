...
//			app.setTemplates(model.getTemplates());
			...
			if(app!=null){
				...
				Igrp.getInstance().getFlashMessage().addMessage("success", "Aplica��o registada com sucesso!");
				User user = new User();
				...
				if(org!=null){	
					...
					Igrp.getInstance().getFlashMessage().addMessage("error", "Falha ao registar a Org�nica!");
				}
				...
				Igrp.getInstance().getFlashMessage().addMessage("error", "Falha ao registar a aplica��o!");
			}
		}
