...
public class LookupListUserView extends View {
	...
	public LookupListUserView(LookupListUser model){
		this.setPageTitle(gt("Lista de Utilizadores para Lookup"));
		...
		btn_pesquisar = new IGRPButton(gt("Pesquisar"),"igrp","LookupListUser","pesquisar","submit","primary|fa-search","","");
