...
public class Transferir_tarefasView extends View {
	...
	public Transferir_tarefasView(Transferir_tarefas model){
		this.setPageTitle("permite transferir tarefas");
		...
		numero_processo = new NumberField(model,"numero_processo");
		numero_processo.setLabel("Número Processo");
		
		numero_processo.propertie().add("name","p_numero_processo").add("type","number").add("min","").add("max","").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
		codigo_processo = new NumberField(model,"codigo_processo");
		codigo_processo.setLabel("Código Processo");
		
		codigo_processo.propertie().add("name","p_codigo_processo").add("type","number").add("min","").add("max","").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
		tipo_processo = new TextField(model,"tipo_processo");
		tipo_processo.setLabel("Tipo Processo");
		
		tipo_processo.propertie().add("name","p_tipo_processo").add("type","text").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
		data_criacao = new DateField(model,"data_criacao");
		data_criacao.setLabel("Data Criação");
		
		data_criacao.propertie().add("name","p_data_criacao").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false").add("class","default");
		...
		criado_por_.propertie().add("name","p_criado_por_").add("type","text").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
		atribuido_por = new TextField(model,"atribuido_por");
		atribuido_por.setLabel("Atribuido Por");
		
		atribuido_por.propertie().add("name","p_atribuido_por").add("type","text").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
		utilizador_actual = new TextField(model,"utilizador_actual");
		utilizador_actual.setLabel("Utilizador Actual");
		
		utilizador_actual.propertie().add("name","p_utilizador_actual").add("type","text").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
