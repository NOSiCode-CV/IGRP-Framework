...
public class Transferir_tarefasView extends View {
	...
	public Transferir_tarefasView(Transferir_tarefas model){
		this.setPageTitle(gt("Transferir tarefas"));
		...
		utilizador_actual.setLabel(gt("Utilizador Actual"));
		...
		btn_gravar = new IGRPButton(gt("Gravar"),"igrp","Transferir_tarefas","gravar","submit","success|fa-save","","");
