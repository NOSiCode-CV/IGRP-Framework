...
public class BPMNDesignerView extends View {
	...
	public BPMNDesignerView(BPMNDesigner model){
		...
		page_title_text.setValue("BPMN Designer");
		...
		id_pai.setLabel("Identificacao pai");
		...
		link_add.setLabel("Adicionar Sub Area");
		...
		link_edit.setLabel("Editar Area");
		...
		btn_exporar_imagem = new IGRPButton("Exporar Imagem","igrp","BPMNDesigner","exporar_imagem","_link","warning|fa-picture-o","","");
