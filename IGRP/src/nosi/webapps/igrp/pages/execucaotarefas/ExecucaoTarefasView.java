...
public class ExecucaoTarefasView extends View {
	...
	public ExecucaoTarefasView(ExecucaoTarefas model){
		...
		gerir_tarefas.propertie().add("name","p_gerir_tarefas").add("type","button").add("target_fields","").add("closerefresh","false").add("iconColor","#333").add("iconClass","").add("img","fa-angle-right").add("maxlength","50");
		colaboradores = new TextField(model,"colaboradores");
		colaboradores.setLabel("Colaboradores");
		
		colaboradores.propertie().add("name","p_colaboradores").add("type","button").add("target_fields","").add("closerefresh","false").add("iconColor","#333").add("iconClass","").add("img","fa-angle-right").add("maxlength","50");
		estatistica = new TextField(model,"estatistica");
		estatistica.setLabel("Estatística");
		
		estatistica.propertie().add("name","p_estatistica").add("type","button").add("target_fields","").add("closerefresh","false").add("iconColor","#333").add("iconClass","").add("img","fa-angle-right").add("maxlength","50");
		minhas_tarefas = new TextField(model,"minhas_tarefas");
		minhas_tarefas.setLabel("Minhas Tarefas");
		
		minhas_tarefas.propertie().add("name","p_minhas_tarefas").add("type","button").add("target_fields","").add("closerefresh","false").add("iconColor","#333").add("iconClass","").add("img","fa-angle-right").add("maxlength","50");
		disponiveis = new TextField(model,"disponiveis");
		disponiveis.setLabel("Disponíveis");
		
		disponiveis.propertie().add("name","p_disponiveis").add("type","button").add("target_fields","").add("closerefresh","false").add("iconColor","#333").add("iconClass","").add("img","fa-angle-right").add("maxlength","50");
