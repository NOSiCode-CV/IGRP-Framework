...
public class ExecucaoTarefasView extends View {
	...
	public ExecucaoTarefasView(ExecucaoTarefas model){
		...
		organica_colaborador.setLabel("Org�nica");
		...
		numero_processo_colaborador.setLabel("N�mero Processo");
		...
		posicao_ranking_view_estatistica.setLabel("Posi��o Ranking");
		...
		organica_minhas_tarefas.setLabel("Orgánica");
		...
		numero_processo_estatistica.setLabel("N�mero Processo");
		...
		data_conclusao_estat_tabela.setLabel("Data Conclus�o");
