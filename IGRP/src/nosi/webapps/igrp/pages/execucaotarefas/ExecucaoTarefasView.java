...
public class ExecucaoTarefasView extends View {
	...
	public ExecucaoTarefasView(ExecucaoTarefas model){
		this.setPageTitle(gt("Execucao Tarefas"));
		...
		organica_gerir_tarefa.setLabel(gt("Orgânica"));
		...
		data_inicio_gerir_tarefa.setLabel(gt("Data início"));
		...
		pesquisa_gerir_tarefa.setLabel(gt("Pesquisa"));
		...
		organica_colaborador.setLabel(gt("Orgânica"));
		...
		data_inicio_colaborador.setLabel(gt("Data Início"));
		...
		n_tarefas_cocluidas_view_estatistica.setLabel(gt("N. Tarefas Concluídas"));
		...
		media_tempo_view_estatistica.setLabel(gt("Média Tempo"));
		...
		posicao_ranking_view_estatistica.setLabel(gt("Posição Ranking"));
		...
		organica_minhas_tarefas.setLabel(gt("Orgânica"));
		...
		data_inicio_minhas_tarefas.setLabel(gt("Data Início"));
		...
		pesquisa_minhas_tarefas.setLabel(gt("Pesquisa"));
		...
		organica_form_disponiveis.setLabel(gt("Orgânica"));
		...
		data_inicio_form_disponiveis.setLabel(gt("Data Início"));
		...
		pesquisar_form_disponiveis.setLabel(gt("Pesquisar"));
		...
		data_inicio_estatistica.setLabel(gt("Data Início"));
		...
		numero_processo_estatistica.setLabel(gt("Número Processo"));
		...
		media_tempo_colab_tabela.setLabel(gt("Média Tempo"));
		...
		atribuido_por_tabela_minhas_tarefas.setLabel(gt("Atribuído Por"));
		...
		data_fim_m.propertie().add("name","p_data_fim_m").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("align","left").add("lookup_parser","false").add("iskey","false");
		...
		data_fim_d.propertie().add("name","p_data_fim_d").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("align","left").add("lookup_parser","false").add("iskey","false");
		...
		data_fim_g.propertie().add("name","p_data_fim_g").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("align","left").add("lookup_parser","false").add("iskey","false");
		...
		btn_ver_detalhes = new IGRPButton(gt("Ver Detalhes"),"igrp","ExecucaoTarefas","ver_detalhes","_blank","default|fa-angle-right","","");
		...
		btn_detalhes_processos_button_minha_tarefas = new IGRPButton(gt("Detalhes Processos"),"igrp","ExecucaoTarefas","detalhes_processos_button_minha_tarefas","submit","default|fa-angle-right","","");
		...
		btn_leberar_tarefa_button_minha_tarefas = new IGRPButton(gt("Liberar Tarefa"),"igrp","ExecucaoTarefas","leberar_tarefa_button_minha_tarefas","alert_submit","default|fa-angle-right","","");
		...
		btn_assumir_button_tabela = new IGRPButton(gt("Assumir"),"igrp","ExecucaoTarefas","assumir_button_tabela","alert_submit","success|fa-check","","");
		btn_assumir_button_tabela.propertie.add("type","specific").add("code","").add("class","success").add("rel","assumir_button_tabela");
		btn_transferir_tarefa = new IGRPButton(gt("Transferir Tarefa"),"igrp","ExecucaoTarefas","transferir_tarefa","_blank","default|fa-angle-right","","");
		btn_transferir_tarefa.propertie.add("type","specific").add("code","").add("class","default").add("rel","transferir_tarefa");
		btn_detalhes_tarefa = new IGRPButton(gt("Detalhes Tarefa"),"igrp","ExecucaoTarefas","detalhes_tarefa","_blank","default|fa-angle-right","","");
		btn_detalhes_tarefa.propertie.add("type","specific").add("code","").add("class","default").add("rel","detalhes_tarefa");
		btn_detalhes_processo = new IGRPButton(gt("Detalhes Processo"),"igrp","ExecucaoTarefas","detalhes_processo","_blank","default|fa-angle-right","","");
		btn_detalhes_processo.propertie.add("type","specific").add("code","").add("class","default").add("rel","detalhes_processo");
		btn_alterar_prioridade_tarefa = new IGRPButton(gt("Alterar Prioridade Tarefa"),"igrp","ExecucaoTarefas","alterar_prioridade_tarefa","_blank","default|fa-angle-right","","");
