...
public class Alter_prioridade_tarefaView extends View {
	...
	public Alter_prioridade_tarefaView(Alter_prioridade_tarefa model){
		...
		tipo_da_tarefa.propertie().add("name","p_tipo_da_tarefa").add("type","text").add("maxlength","30").add("required","true").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
		data_criacao_da_tarefa = new DateField(model,"data_criacao_da_tarefa");
		data_criacao_da_tarefa.setLabel("Data Criação da Tarefa");
		
		data_criacao_da_tarefa.propertie().add("name","p_data_criacao_da_tarefa").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("required","true").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false").add("class","default");
		...
		tipo_de_processo.propertie().add("name","p_tipo_de_processo").add("type","text").add("maxlength","30").add("required","true").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
		data_criacao_do_processo = new DateField(model,"data_criacao_do_processo");
		data_criacao_do_processo.setLabel("Data Criaçãoo do Processo");
		
		data_criacao_do_processo.propertie().add("name","p_data_criacao_do_processo").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("required","true").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false").add("class","default");
		...
		data_inicio_do_processo.propertie().add("name","p_data_inicio_do_processo").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false").add("class","default");
		data_fim_do_processo = new DateField(model,"data_fim_do_processo");
		data_fim_do_processo.setLabel("Data Fim do Processo");
		
		data_fim_do_processo.propertie().add("name","p_data_fim_do_processo").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("required","false").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false").add("class","default");
