...
public class AgendarView extends View {
	...
	public AgendarView(Agendar model){
		...
		entidade.propertie().add("name","p_entidade").add("type","select").add("multiple","false").add("maxlength","30").add("required","true").add("change","false").add("disabled","false").add("right","false").add("visible","true").add("domain","").add("desc","true");
		...
		balcao.propertie().add("name","p_balcao").add("type","select").add("multiple","false").add("maxlength","30").add("required","true").add("change","false").add("disabled","false").add("right","false").add("visible","true").add("domain","").add("desc","true");
		...
		hora.setLabel("Hora");
		hora.propertie().add("name","p_hora").add("type","select").add("multiple","true").add("maxlength","30").add("required","true").add("change","false").add("disabled","false").add("right","false").add("visible","true").add("domain","").add("desc","true");
		...
		tipo_requisito.propertie().add("name","p_tipo_requisito").add("type","text").add("maxlength","30").add("align","left").add("lookup_parser","false").add("iskey","false");
		descritivo = new TextField(model,"descritivo");
		descritivo.setLabel("Descritivo");
		descritivo.propertie().add("name","p_descritivo").add("type","text").add("maxlength","30").add("align","left").add("lookup_parser","false").add("iskey","false");
		formulario = new LinkField(model,"formulario");
		formulario.setLabel("Formulário");
		formulario.propertie().add("name","p_formulario").add("type","link").add("target","_self").add("class","link").add("iconColor","#333").add("iconClass","").add("img","fa-link").add("maxlength","30").add("align","left").add("lookup_parser","false").add("target_fields","").add("action","index").add("page","Agendar").add("app","agenda").add("btnSize","[object Object]").add("iskey","false").add("desc","true");
		nome2 = new TextField(model,"nome2");
		nome2.setLabel("Nome");
		nome2.propertie().add("name","p_nome2").add("type","text").add("maxlength","100").add("required","true").add("change","false").add("readonly","false").add("disabled","false").add("placeholder","").add("right","false");
