...
public class ConsultaPendenteView extends View {
	public String title = "Consultas Pendentes";		
	...
	public ConsultaPendenteView(ConsultaPendente model){			
		...
		medico_a_consultar.propertie().add("name","p_medico_a_consultar").add("type","text").add("maxlength","30").add("align","left").add("lookup_parser","false");
		data_da_consulta = new DateField(model,"data_da_consulta");
		data_da_consulta.setLabel("Data da Consulta");
		data_da_consulta.propertie().add("name","p_data_da_consulta").add("type","date").add("format","IGRP_datePicker").add("maxlength","30").add("align","left").add("lookup_parser","false");
		p_id = new HiddenField(model,"p_id");
		p_id.setLabel("");
		p_id.propertie().add("name","p_id").add("type","hidden").add("maxlength","30").add("tag","id");

		toolsbar_1 = new IGRPToolsBar("toolsbar_1");
		btn_nova_consulta = new IGRPButton("Nova Consulta","marcao_consulta","ConsultaPendente","nova_consulta","_self","default|fa-plus-circle","","");
		btn_nova_consulta.propertie.add("type","specific").add("code","").add("rel","nova_consulta");
		btn_pesquisar = new IGRPButton("Pesquisar","marcao_consulta","ConsultaPendente","pesquisar","submit","default|fa-search","","");
		btn_pesquisar.propertie.add("type","form").add("code","").add("class","default").add("rel","pesquisar");
		btn_cancelar_consulta = new IGRPButton("Cancelar Consulta","marcao_consulta","ConsultaPendente","cancelar_consulta","confirm","default|fa-remove","","");
		btn_cancelar_consulta.propertie.add("type","specific").add("code","").add("class","default").add("rel","cancelar_consulta");
		btn_confirmar_consulta = new IGRPButton("Confirmar Consulta","marcao_consulta","ConsultaPendente","confirmar_consulta","confirm","default|fa-chevron-down","","");
		btn_confirmar_consulta.propertie.add("type","specific").add("code","").add("class","default").add("rel","confirmar_consulta");
