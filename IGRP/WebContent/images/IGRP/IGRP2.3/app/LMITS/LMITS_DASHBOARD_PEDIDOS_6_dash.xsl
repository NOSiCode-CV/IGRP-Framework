<xsl:stylesheet
                                                    ...
                                                    <div class="box box-table-contents gen-container-item " gen-class="" item-name="table_1">
                                                        ...
                                                        <div class="box-body table-box">
                                                            ...
                                                            <table id="table_1" class="table table-striped gen-data-table IGRP_contextmenu">
                                                                <thead>
                                                                    <tr>
                                                                        <xsl:if test="rows/content/table_1/fields/tipo_cobranca">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/tipo_cobranca/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="tipo_cobranca">
                                                                                <td align="left" data-row="{position()}" data-title="{../../label/tipo_cobranca}" class="link">
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="tipo_cobranca != ''">
                                                                                            <a href="{tipo_cobranca}" class="link bClick" target="_self" name="tipo_cobranca">
                                                                                                <xsl:value-of select="tipo_cobranca_desc" disable-output-escaping="yes"/>
                                                                                            </a>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <span>
                                                                            ...
                                                                            <xsl:if test="total">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/total/label}" class="text">
                                                                                    <span class="">
                                                    ...
                                                    <div class="box gen-container-item " gen-structure="graphic" gen-class="" item-name="chart_1">
                                                        ...
                                                        <div class="box-body">
                                                            <xsl:call-template name="igrp-graph">
                                                                ...
                                                                <xsl:with-param name="title" select="'Montante Por Zona'"/>
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1487867131911"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1487867131911"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1487867131911"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1487867131911"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1487867131911"/>
    <xsl:include href="../../xsl/tmpl/IGRP-charts.tmpl.xsl?v=1487867131914"/>
</xsl:stylesheet>