                ...
                <div class="col">
                  <xsl:if test="rows/content/filter/label/rv_domain">
                    <div class="col-1-4 item" item-name="rv_domain">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/filter/value/rv_domain/@name}" value="{rows/content/filter/value/rv_domain}" class="text" maxlength="100">
                  ...
                  <xsl:if test="rows/content/filter/label/rv_low_value">
                    <div class="col-1-4 item" item-name="rv_low_value">
                      <div class="igrp_item text">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/rv_low_value) > 45">
                            <xsl:attribute name="title">
                        ...
                        <input type="text" name="{rows/content/filter/value/rv_low_value/@name}" value="{rows/content/filter/value/rv_low_value}" class="text" maxlength="240">
                          <xsl:call-template name="FIELD_validator">
                  ...
                  <xsl:if test="rows/content/filter/label/rv_high_value">
                    <div class="col-1-4 item" item-name="rv_high_value">
                      <div class="igrp_item text">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/rv_high_value) > 45">
                            <xsl:attribute name="title">
                  ...
                  <xsl:if test="rows/content/filter/label/rv_abbreviation">
                    <div class="col-1-4 item" item-name="rv_abbreviation">
                      <div class="igrp_item text">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/rv_abbreviation) > 45">
                            <xsl:attribute name="title">
                  ...
                  <xsl:if test="rows/content/filter/label/rv_meaning">
                    <div class="col-1-4 item" item-name="rv_meaning">
                      <div class="igrp_item text">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/rv_meaning) > 45">
                            <xsl:attribute name="title">
                        ...
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="rv_high_value">
                              <td align="left" data-row="{position()}" data-title="{../../label/rv_high_value}" class="text">
                                <xsl:value-of select="rv_high_value"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="rv_abbreviation">
                              <td align="left" data-row="{position()}" data-title="{../../label/rv_abbreviation}" class="text">
