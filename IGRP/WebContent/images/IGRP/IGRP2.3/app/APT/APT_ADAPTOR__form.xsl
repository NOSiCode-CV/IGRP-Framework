                ...
                <xsl:if test="rows/content/form/label/database_type">
                  <div class="col-1-4 item" item-name="database_type">
                    <div class="igrp_item select">
                      ...
                      <select name="{rows/content/form/list/database_type/@name}" chosen="select" id="{rows/content/form/list/database_type/@name}" data-placeholder="{rows/content/form/list/database_type/option[position() = 1]}" class="select required">
