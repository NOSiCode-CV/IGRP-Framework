<xsl:stylesheet
                                                    ...
                                                    <div class="box box-table-contents gen-container-item " gen-class="" item-name="table_1">
                                                        <div class="box-body table-box">
                                                            ...
                                                            <table id="table_1" class="table table-striped gen-data-table " exports="">
                                                                <thead>
                                                                    <tr>
                                                                        <xsl:if test="rows/content/table_1/fields/text_6">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/text_6/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        <xsl:if test="rows/content/table_1/fields/text_5">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/text_5/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        <xsl:if test="rows/content/table_1/fields/text_4">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/text_4/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        <xsl:if test="rows/content/table_1/fields/text_3">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/text_3/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        ...
                                                                        <xsl:if test="rows/content/table_1/fields/text_2">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/text_2/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        ...
                                                                        <xsl:if test="rows/content/table_1/fields/date_2">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/date_2/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                    </tr>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="text_6">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/text_6/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="text_6"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            <xsl:if test="text_5">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/text_5/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="text_5"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            <xsl:if test="text_4">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/text_4/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="text_4"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            <xsl:if test="text_3">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/text_3/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="text_3"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            <xsl:if test="text_1">
                                                                            ...
                                                                            <xsl:if test="text_2">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/text_2/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="text_2"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            <xsl:if test="date_1">
                                                                            ...
                                                                            <xsl:if test="date_2">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/date_2/label}" class="date">
                                                                                    <span class="">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1492443736425"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1492443736425"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1492443736425"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1492443736425"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1492443736425"/>
</xsl:stylesheet>