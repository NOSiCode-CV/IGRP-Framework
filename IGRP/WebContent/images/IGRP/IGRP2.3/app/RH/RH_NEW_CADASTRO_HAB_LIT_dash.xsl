<xsl:stylesheet
                                                    ...
                                                    <div class="box box-table-contents gen-container-item " gen-class="" item-name="table_1">
                                                        <div class="box-body table-box">
                                                            ...
                                                            <table id="table_1" class="table table-striped gen-data-table IGRP_contextmenu" exports="">
                                                                <thead>
                                                                    <tr>
                                                                        <xsl:if test="rows/content/table_1/fields/habilitacoes_literarias">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/habilitacoes_literarias/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        <xsl:if test="rows/content/table_1/fields/nivel_de_habilitacao">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/nivel_de_habilitacao/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="habilitacoes_literarias">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/habilitacoes_literarias/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="habilitacoes_literarias"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            <xsl:if test="nivel_de_habilitacao">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/nivel_de_habilitacao/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="nivel_de_habilitacao"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1492428114928"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1492428114928"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1492428114928"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1492428114928"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1492428114928"/>
</xsl:stylesheet>