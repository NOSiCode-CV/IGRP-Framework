<xsl:stylesheet
                                                                            ...
                                                                            <div class="box igrp-forms gen-container-item " gen-class="" item-name="form_2">
                                                                                ...
                                                                                <div class="box-body">
                                                                                    <div role="form">
                                                                                        ...
                                                                                        <xsl:if test="rows/content/form_2/fields/nome_familiar">
                                                                                            <div class="form-group col-md-6   gen-fields-holder" item-name="nome_familiar" item-type="text">
                                                                                                <label for="{rows/content/form_2/fields/nome_familiar/@name}">
                                                                                                    <span>
                                                                                                        <xsl:value-of select="rows/content/form_2/fields/nome_familiar/label"/>
                                                                                                    </span>
                                                                                                </label>
                                                                                                <input type="text" value="{rows/content/form_2/fields/nome_familiar/value}" class="form-control " id="{rows/content/form_2/fields/nome_familiar/@name}" name="{rows/content/form_2/fields/nome_familiar/@name}" readonly="readonly" maxlength="100" placeholder=""></input>
                                                                                            </div>
                                                                                        </xsl:if>
                                                                                    </div>
                                                                                </div>
                                                    ...
                                                    <div class="box box-table-contents gen-container-item " gen-class="" item-name="table_1">
                                                        <div class="box-body table-box">
                                                            ...
                                                            <table id="table_1" class="table table-striped gen-data-table IGRP_contextmenu" exports="">
                                                                <thead>
                                                                    <tr>
                                                                        <xsl:if test="rows/content/table_1/fields/anexos">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/table_1/fields/anexos/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="anexos">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/anexos/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="anexos"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            ...
                                                                            <xsl:if test="ver">
                                                                                <td align="left" data-row="{position()}" data-title="{../../label/ver}" class="link">
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="ver != ''">
                                                                                            <a href="{ver}" class="link bClick" target="_blank" name="ver">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1492430844917"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1492430844917"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1492430844917"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1492430844917"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1492430844917"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1492430844917"/>
</xsl:stylesheet>