<xsl:stylesheet
                                                    ...
                                                    <div class="box igrp-forms gen-container-item " gen-class="" item-name="form_1">
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/utilizador_filtro">
                                                                    <div class="form-group col-md-3  gen-fields-holder" item-name="utilizador_filtro" item-type="lookup">
                                                                        <label for="{rows/content/form_1/fields/utilizador_filtro/@name}">
                                                                            <xsl:value-of select="rows/content/form_1/fields/utilizador_filtro/label"/>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <input type="text" value="{rows/content/form_1/fields/utilizador_filtro/value}" class="form-control gen-lookup " id="form_1_utilizador_filtro" name="{rows/content/form_1/fields/utilizador_filtro/@name}" maxlength="100"/>
                                                                            <xsl:call-template name="lookup-tool">
                                                                                <xsl:with-param name="page" select="rows/page"/>
                                                                                <xsl:with-param name="ad_hoc" select="'1'"/>
                                                                                <xsl:with-param name="action" select="'LOOKUP'"/>
                                                                                <xsl:with-param name="name" select="rows/content/form_1/fields/utilizador_filtro/@name"/>
                                                                                <xsl:with-param name="js_lookup" select="rows/content/form_1/fields/utilizador_filtro/lookup"/>
                                                                                <xsl:with-param name="input-id" select="'form_1_utilizador_filtro'"/>
                                                                                <xsl:with-param name="btnClass" select="'primary'"/>
                                                                            </xsl:call-template>
                                                                        </div>
                                                                    </div>
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1492014459060"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1492014459060"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1492014459060"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1492014459060"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1492014459060"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1492014459060"/>
</xsl:stylesheet>