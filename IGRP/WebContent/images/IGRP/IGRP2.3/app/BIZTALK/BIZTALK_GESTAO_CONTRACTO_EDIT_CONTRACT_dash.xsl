                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/cliente">
                      <label>
                        ...
                        <input type="text" name="{rows/content/form/value/cliente/@name}" value="{rows/content/form/value/cliente}" class="text required" readonly="readonly" Tread="readonly" maxlength="300">
                    ...
                    <xsl:if test="rows/content/form/label/cliente_prestador">
                      <label>
                        ...
                        <input type="text" name="{rows/content/form/value/cliente_prestador/@name}" value="{rows/content/form/value/cliente_prestador}" class="text required" readonly="readonly" Tread="readonly" maxlength="300">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/valor_contrato">
                      <label>
                        ...
                        <input type="number" name="{rows/content/form/value/valor_contrato/@name}" value="{rows/content/form/value/valor_contrato}" class="number" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                            ...
                            <tbody>
                              <xsl:for-each select="rows/content/form/table/documentos/value/row[not(@total='yes')]">
                                ...
                                <tr>
                                  ...
                                  <input type="hidden" name="p_id_anexo_fk" value="{id_anexo}"/>
                                  <input type="hidden" name="p_id_anexo_fk_desc" value="{id_anexo_desc}"/>
                                </tr>
                              </xsl:for-each>
                            </tbody>
                          </table>
                      ...
                      <div rel="intervenientes" name="sep_intervenientes">
                        ...
                        <xsl:if test="rows/content/form/label/tipo">
                          <label>
                            ...
                            <select name="{rows/content/form/list/tipo/@name}" class="select required" maxlength="50" rel="F_intervenientes">
                              <xsl:call-template name="FIELD_validator">
                            ...
                            <tbody>
                              <xsl:for-each select="rows/content/form/table/intervenientes/value/row[not(@total='yes')]">
                                ...
                                <tr>
                                  ...
                                  <input type="hidden" name="p_tipo_id_fk" value="{tipo_id}"/>
                                  <input type="hidden" name="p_tipo_id_fk_desc" value="{tipo_id_desc}"/>
                                  <input type="hidden" name="p_cl_i_id_fk" value="{cl_i_id}"/>
                                  <input type="hidden" name="p_cl_i_id_fk_desc" value="{cl_i_id_desc}"/>
                                </tr>
                              </xsl:for-each>
                            </tbody>
                          </table>
                        </div><!-- END TABELA LIST--></div>
                    </xsl:if><!-- INICIO SEPARADOR list_prod_cons--><xsl:if test="rows/content/form/label/list_prod_cons">
                      <div rel="list_prod_cons" name="sep_list_prod_cons">
                        <div id="list_prod_cons">
                          <xsl:call-template name="page-title">
                            <xsl:with-param name="title" select="rows/content/form/label/list_prod_cons"/>
                            <xsl:with-param name="class" select="'subtitle'"/>
                          </xsl:call-template>
                        </div><!-- START TABELA LIST--><div class="simple-table table-responsive" rel="DIV_list_prod_cons">
                          <table rel="T_list_prod_cons">
                            <thead>
                              <tr>
                                <xsl:if test="rows/content/form/table/list_prod_cons/label/produto_cons">
                                  <xsl:if test="not(rows/content/form/table/list_prod_cons/label/produto_cons/@visible)">
                                    <th>
                                      <xsl:value-of select="rows/content/form/table/list_prod_cons/label/produto_cons"/>
                                    </th>
                                  </xsl:if>
                                </xsl:if>
                                <xsl:if test="rows/content/form/table/list_prod_cons/label/data_ini_cons">
                                  <xsl:if test="not(rows/content/form/table/list_prod_cons/label/data_ini_cons/@visible)">
                                    <th>
                                      <xsl:value-of select="rows/content/form/table/list_prod_cons/label/data_ini_cons"/>
                                    </th>
                                  </xsl:if>
                                </xsl:if>
                                <xsl:if test="rows/content/form/table/list_prod_cons/label/data_fim_cons">
                                  <xsl:if test="not(rows/content/form/table/list_prod_cons/label/data_fim_cons/@visible)">
                                    <th>
                                      <xsl:value-of select="rows/content/form/table/list_prod_cons/label/data_fim_cons"/>
                                    </th>
                                  </xsl:if>
                                </xsl:if>
                                <xsl:if test="rows/content/form/table/list_prod_cons/label/tipo_consumo_cons">
                                  <xsl:if test="not(rows/content/form/table/list_prod_cons/label/tipo_consumo_cons/@visible)">
                                    <th>
                                      <xsl:value-of select="rows/content/form/table/list_prod_cons/label/tipo_consumo_cons"/>
                                    </th>
                                  </xsl:if>
                                </xsl:if>
                                <xsl:if test="rows/content/form/table/list_prod_cons/label/quota_cons">
                                  <xsl:if test="not(rows/content/form/table/list_prod_cons/label/quota_cons/@visible)">
                                    <th>
                                      <xsl:value-of select="rows/content/form/table/list_prod_cons/label/quota_cons"/>
                                    </th>
                                  </xsl:if>
                                </xsl:if>
                                <xsl:if test="rows/content/form/table/list_prod_cons/label/consumo">
                                  <xsl:if test="not(rows/content/form/table/list_prod_cons/label/consumo/@visible)">
                                    <th>
                                      <xsl:value-of select="rows/content/form/table/list_prod_cons/label/consumo"/>
                                    </th>
                                  </xsl:if>
                                </xsl:if>
                              </tr>
                            ...
                            <tbody>
                              <xsl:for-each select="rows/content/form/table/list_prod_cons/value/row[not(@total='yes')]">
                                <xsl:variable name="pos" select="(position()+1) mod 2"/>
                                <tr>
                                  <xsl:if test="produto_cons">
                                    <xsl:if test="not(produto_cons/@visible)">
                                      <td class="table_row{$pos}" data-title="{../../label/produto_cons}">
                                        <xsl:value-of select="produto_cons"/>
                                        <input type="hidden" name="p_produto_cons_fk" value="{produto_cons}"/>
                                      </td>
                                    </xsl:if>
                                    <xsl:if test="produto_cons/@visible = 'false'">
                                      <input type="hidden" name="p_produto_cons_fk" value="{produto_cons}"/>
                                    </xsl:if>
                                  </xsl:if>
                                  <xsl:if test="data_ini_cons">
                                    <xsl:if test="not(data_ini_cons/@visible)">
                                      <td class="table_row{$pos}" data-title="{../../label/data_ini_cons}">
                                        <xsl:value-of select="data_ini_cons"/>
                                        <input type="hidden" name="p_data_ini_cons_fk" value="{data_ini_cons}"/>
                                      </td>
                                    </xsl:if>
                                    <xsl:if test="data_ini_cons/@visible = 'false'">
                                      <input type="hidden" name="p_data_ini_cons_fk" value="{data_ini_cons}"/>
                                    </xsl:if>
                                  </xsl:if>
                                  <xsl:if test="data_fim_cons">
                                    <xsl:if test="not(data_fim_cons/@visible)">
                                      <td class="table_row{$pos}" data-title="{../../label/data_fim_cons}">
                                        <xsl:value-of select="data_fim_cons"/>
                                        <input type="hidden" name="p_data_fim_cons_fk" value="{data_fim_cons}"/>
                                      </td>
                                    </xsl:if>
                                    <xsl:if test="data_fim_cons/@visible = 'false'">
                                      <input type="hidden" name="p_data_fim_cons_fk" value="{data_fim_cons}"/>
                                    </xsl:if>
                                  </xsl:if>
                                  <xsl:if test="tipo_consumo_cons">
                                    <xsl:if test="not(tipo_consumo_cons/@visible)">
                                      <td class="table_row{$pos}" data-title="{../../label/tipo_consumo_cons}">
                                        <xsl:value-of select="tipo_consumo_cons"/>
                                        <input type="hidden" name="p_tipo_consumo_cons_fk" value="{tipo_consumo_cons}"/>
                                      </td>
                                    </xsl:if>
                                    <xsl:if test="tipo_consumo_cons/@visible = 'false'">
                                      <input type="hidden" name="p_tipo_consumo_cons_fk" value="{tipo_consumo_cons}"/>
                                    </xsl:if>
                                  </xsl:if>
                                  <xsl:if test="quota_cons">
                                    <xsl:if test="not(quota_cons/@visible)">
                                      <td class="table_row{$pos}" data-title="{../../label/quota_cons}">
                                        <xsl:value-of select="quota_cons"/>
                                        <input type="hidden" name="p_quota_cons_fk" value="{quota_cons}"/>
                                      </td>
                                    </xsl:if>
                                    <xsl:if test="quota_cons/@visible = 'false'">
                                      <input type="hidden" name="p_quota_cons_fk" value="{quota_cons}"/>
                                    </xsl:if>
                                  </xsl:if>
                                  <xsl:if test="consumo">
                                    <xsl:if test="not(consumo/@visible)">
                                      <td class="table_row{$pos}" data-title="{../../label/consumo}">
                                        <xsl:value-of select="consumo"/>
                                        <input type="hidden" name="p_consumo_fk" value="{consumo}"/>
                                      </td>
                                    </xsl:if>
                                    <xsl:if test="consumo/@visible = 'false'">
                                      <input type="hidden" name="p_consumo_fk" value="{consumo}"/>
                                    </xsl:if>
                                  </xsl:if>
                                  <input type="hidden" name="p_list_prod_cons_id" value="{list_prod_cons_id}"/>
                                </tr>
                              </xsl:for-each>
                            </tbody>
                          </table>
                      ...
                      <div rel="produtos" name="sep_produtos">
                        ...
                        <xsl:if test="rows/content/form/label/produto">
                          <label>
                            ...
                            <input type="LOOKUP" name="{rows/content/form/value/produto/@name}" value="{rows/content/form/value/produto}" class="LOOKUP required" maxlength="300" rel="F_produtos">
                              <xsl:call-template name="FIELD_validator">
                        ...
                        <xsl:if test="rows/content/form/label/percentagem">
                          <label>
                            ...
                            <input type="text" name="{rows/content/form/value/percentagem/@name}" value="{rows/content/form/value/percentagem}" class="text" maxlength="30" rel="F_produtos">
                              <xsl:call-template name="FIELD_validator">
                        ...
                        <xsl:if test="rows/content/form/label/consumo_prod">
                          <label>
                            <span>
                              <xsl:value-of select="rows/content/form/label/consumo_prod"/>
                            </span>
                            <input type="number" name="{rows/content/form/value/consumo_prod/@name}" value="{rows/content/form/value/consumo_prod}" class="number" readonly="readonly" Tread="readonly" maxlength="30" rel="F_produtos">
                              <xsl:call-template name="FIELD_validator">
                                <xsl:with-param name="field" select="rows/content/form/label/consumo_prod"/>
                              </xsl:call-template>
                            </input>
                          </label>
                        </xsl:if>
                        <xsl:if test="rows/content/form/label/saldo_trans">
                          <label>
                            <span>
                              <xsl:value-of select="rows/content/form/label/saldo_trans"/>
                            </span>
                            <input type="number" name="{rows/content/form/value/saldo_trans/@name}" value="{rows/content/form/value/saldo_trans}" class="number" readonly="readonly" Tread="readonly" maxlength="20" rel="F_produtos">
                              <xsl:call-template name="FIELD_validator">
                                <xsl:with-param name="field" select="rows/content/form/label/saldo_trans"/>
                              </xsl:call-template>
                            </input>
                          </label>
                          ...
                          <table rel="T_produtos">
                            <thead>
                              <tr>
                                ...
                                <xsl:if test="rows/content/form/table/produtos/label/consumo_prod">
                                  <xsl:if test="not(rows/content/form/table/produtos/label/consumo_prod/@visible)">
                                    <th>
                                      <xsl:value-of select="rows/content/form/table/produtos/label/consumo_prod"/>
                                    </th>
                                  </xsl:if>
                                </xsl:if>
                                <xsl:if test="rows/content/form/table/produtos/label/saldo_trans">
                                  <xsl:if test="not(rows/content/form/table/produtos/label/saldo_trans/@visible)">
                                    <th>
                                      <xsl:value-of select="rows/content/form/table/produtos/label/saldo_trans"/>
                                    </th>
                                  </xsl:if>
                                </xsl:if>
                                <th align="center" width="10"/>
                            ...
                            <tbody>
                              <xsl:for-each select="rows/content/form/table/produtos/value/row[not(@total='yes')]">
                                ...
                                <tr>
                                  ...
                                  <xsl:if test="consumo_prod">
                                    <xsl:if test="not(consumo_prod/@visible)">
                                      <td class="table_row{$pos}" data-title="{../../label/consumo_prod}">
                                        <xsl:value-of select="consumo_prod_desc"/>
                                        <input type="hidden" name="p_consumo_prod_fk" value="{consumo_prod}"/>
                                        <input type="hidden" name="p_consumo_prod_fk_desc" value="{consumo_prod_desc}"/>
                                      </td>
                                    </xsl:if>
                                    <xsl:if test="consumo_prod/@visible = 'false'">
                                      <input type="hidden" name="p_consumo_prod_fk" value="{consumo_prod}"/>
                                      <input type="hidden" name="p_consumo_prod_fk_desc" value="{consumo_prod_desc}"/>
                                    </xsl:if>
                                  </xsl:if>
                                  <xsl:if test="saldo_trans">
                                    <xsl:if test="not(saldo_trans/@visible)">
                                      <td class="table_row{$pos}" data-title="{../../label/saldo_trans}">
                                        <xsl:value-of select="saldo_trans_desc"/>
                                        <input type="hidden" name="p_saldo_trans_fk" value="{saldo_trans}"/>
                                        <input type="hidden" name="p_saldo_trans_fk_desc" value="{saldo_trans_desc}"/>
                                      </td>
                                    </xsl:if>
                                    <xsl:if test="saldo_trans/@visible = 'false'">
                                      <input type="hidden" name="p_saldo_trans_fk" value="{saldo_trans}"/>
                                      <input type="hidden" name="p_saldo_trans_fk_desc" value="{saldo_trans_desc}"/>
                                    </xsl:if>
                                  </xsl:if>
