                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/aplication">
                      <label>
                        ...
                        <select name="{rows/content/form/list/aplication/@name}" class="selectchange IGRP_change" maxlength="100">
                    ...
                    <xsl:if test="rows/content/form/label/code">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/form/label/code"/>
                        </span>
                        <input type="text" name="{rows/content/form/value/code/@name}" value="{rows/content/form/value/code}" class="text" maxlength="10">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/type">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/form/label/type"/>
                        </span>
                        <select name="{rows/content/form/list/type/@name}" class="select" maxlength="22">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/status">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/form/label/status"/>
                        </span>
                        <select name="{rows/content/form/list/status/@name}" class="select" maxlength="22">
                          <xsl:call-template name="FIELD_validator">
                        ...
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          ...
                          <tr class="IGRP_contextMenu">
                            ...
                            <xsl:if test="aplication">
                              <td align="left" class="table_row{$pos}" data-title="{../../label/aplication}">
                                <xsl:value-of select="aplication"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="code">
                              <td align="center" class="table_row{$pos}" data-title="{../../label/code}">
                                <xsl:value-of select="code"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="type">
                              <td align="left" class="table_row{$pos}" data-title="{../../label/type}">
                                <xsl:value-of select="type"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="function">
                              <td align="left" class="table_row{$pos}" data-title="{../../label/function}">
                                <xsl:value-of select="function"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="status">
                              <td align="left" class="table_row{$pos}" data-title="{../../label/status}">
