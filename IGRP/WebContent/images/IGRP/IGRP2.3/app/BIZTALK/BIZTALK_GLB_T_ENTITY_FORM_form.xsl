                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/code">
                      <label>
                        ...
                        <input type="number" name="{rows/content/form/value/code/@name}" value="{rows/content/form/value/code}" class="number required" maxlength="10">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/cliente_id"/>
                    ...
                    <xsl:if test="rows/content/form/label/produto_id"/>
                    <xsl:if test="rows/content/form/label/percentagem">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/form/label/percentagem"/>
                        </span>
                        <input type="text" name="{rows/content/form/value/percentagem/@name}" value="{rows/content/form/value/percentagem}" class="text" maxlength="6">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/valor">
                      <label>
                        ...
                        <input type="text" name="{rows/content/form/value/valor/@name}" value="{rows/content/form/value/valor}" class="text" maxlength="9">
                          <xsl:call-template name="FIELD_validator">
