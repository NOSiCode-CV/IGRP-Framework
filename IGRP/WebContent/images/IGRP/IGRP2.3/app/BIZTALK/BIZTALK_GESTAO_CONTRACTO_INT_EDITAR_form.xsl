<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/interveniente">
                      <label>
                        ...
                        <input type="LOOKUP" name="{rows/content/form/value/interveniente/@name}" value="{rows/content/form/value/interveniente}" class="LOOKUP" maxlength="30">
                        ...
                        <xsl:call-template name="lookup-tool">
                          ...
                          <xsl:with-param name="name" select="rows/content/form/value/interveniente/@name"/>
                          <xsl:with-param name="js_lookup" select="rows/content/form/lookup/interveniente"/>
                        </xsl:call-template>
                      </label>
                    </xsl:if>
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20140703"/>
  <xsl:include href="../../xsl/tmpl/IGRP-JSvalidation.tmpl.xsl?v=20140703"/>
  <xsl:include href="../../xsl/tmpl/IGRP-field-validator.tmpl.xsl?v=20140703"/>
  <xsl:include href="../../xsl/tmpl/IGRP-others.tmpl.xsl?v=20140703"/>
</xsl:stylesheet>
