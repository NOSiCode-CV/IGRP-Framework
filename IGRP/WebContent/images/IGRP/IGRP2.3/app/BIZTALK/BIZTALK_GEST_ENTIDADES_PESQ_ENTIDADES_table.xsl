                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/aplicacao">
                      <label>
                        ...
                        <select name="{rows/content/form/list/aplicacao/@name}" class="select" maxlength="200">
                    ...
                    <xsl:if test="rows/content/form/label/codigo">
                      <label>
                        ...
                        <input type="text" name="{rows/content/form/value/codigo/@name}" value="{rows/content/form/value/codigo}" class="text" maxlength="10">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <table class="sortable IGRP_table">
                      <thead>
                        <tr>
                          ...
                          <xsl:if test="rows/content/table/label/entidade_id">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/entidade_id"/>
                            </th>
                          </xsl:if>
                        </tr>
                      </thead>
                        ...
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          ...
                          <tr class="">
                            ...
                            <xsl:if test="aplicacao">
                              <td align="" class="table_row{$pos}" data-title="{../../label/aplicacao}">
                            ...
                            <xsl:if test="entidade_id">
                              <td align="" class="table_row{$pos}" data-title="{../../label/entidade_id}">
                                <xsl:value-of select="entidade_id"/>
                              </td>
                            </xsl:if>
                          </tr>
                        </xsl:for-each>
