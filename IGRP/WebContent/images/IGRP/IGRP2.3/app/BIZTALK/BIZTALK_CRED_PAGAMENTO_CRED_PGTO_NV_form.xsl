<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
            ...
            <div class="ui-layout-center">
              <xsl:call-template name="dialog-modal"/><!-- START YOUR CODE HERE --><div class="box-content"><!--PAGE TITLE--><xsl:call-template name="page-title">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/chave_encriptacao">
                      <label>
                        <span>(*)<xsl:value-of select="rows/content/form/label/chave_encriptacao"/>
                        </span>
                        <input type="text" name="{rows/content/form/value/chave_encriptacao/@name}" value="{rows/content/form/value/chave_encriptacao}" class="text required" maxlength="6">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/chave_encriptacao"/>
                          </xsl:call-template>
                        </input>
                      </label>
                    </xsl:if>
                    <xsl:if test="rows/content/form/label/numero_cartao">
                      <label>
                        ...
                        <input type="number" name="{rows/content/form/value/numero_cartao/@name}" value="{rows/content/form/value/numero_cartao}" class="number required" maxlength="19">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/mes_expiracao">
                      <label>
                        ...
                        <select name="{rows/content/form/list/mes_expiracao/@name}" class="select required" maxlength="2">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/ano_expiracao">
                      <label>
                        ...
                        <select name="{rows/content/form/list/ano_expiracao/@name}" class="select required" maxlength="2">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/cvv2_confirmacao">
                      <label>
                        <span>(*)<xsl:value-of select="rows/content/form/label/cvv2_confirmacao"/>
                        </span>
                        <input type="password" name="{rows/content/form/value/cvv2_confirmacao/@name}" value="{rows/content/form/value/cvv2_confirmacao}" class="password required" maxlength="3">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/cvv2_confirmacao"/>
                          </xsl:call-template>
                        </input>
                      </label>
                    </xsl:if>
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20141003"/>
  <xsl:include href="../../xsl/tmpl/IGRP-JSvalidation.tmpl.xsl?v=20141003"/>
  <xsl:include href="../../xsl/tmpl/IGRP-field-validator.tmpl.xsl?v=20141003"/>
  <xsl:include href="../../xsl/tmpl/IGRP-others.tmpl.xsl?v=20141003"/>
</xsl:stylesheet>
