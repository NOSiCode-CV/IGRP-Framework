<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
            ...
            <div class="ui-layout-center">
              <xsl:call-template name="dialog-modal"/><!-- START YOUR CODE HERE --><div class="box-content"><!--PAGE TITLE--><xsl:call-template name="page-title">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/filter/label/descrisao">
                      <label>
                        <span>(*)<xsl:value-of select="rows/content/filter/label/descrisao"/>
                        </span>
                        <input type="text" name="{rows/content/filter/value/descrisao/@name}" value="{rows/content/filter/value/descrisao}" class="text required" maxlength="20">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/filter/label/descrisao"/>
                          </xsl:call-template>
                        </input>
                      </label>
                      ...
                      <thead>
                        <tr>
                          ...
                          <xsl:if test="rows/content/table/label/descrisao">
                            <th align="left">
                              <xsl:value-of select="rows/content/table/label/descrisao"/>
                            </th>
                          </xsl:if>
                        </tr>
                      </thead>
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20140212"/>
  <xsl:include href="../../xsl/tmpl/IGRP-JSvalidation.tmpl.xsl?v=20140212"/>
  <xsl:include href="../../xsl/tmpl/IGRP-field-validator.tmpl.xsl?v=20140212"/>
  <xsl:include href="../../xsl/tmpl/IGRP-others.tmpl.xsl?v=20140212"/>
</xsl:stylesheet>
