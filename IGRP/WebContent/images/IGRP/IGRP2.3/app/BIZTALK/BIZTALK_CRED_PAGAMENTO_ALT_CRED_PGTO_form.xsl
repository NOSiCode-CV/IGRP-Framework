                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/mes_expiracao">
                      <label>
                        ...
                        <input type="number" name="{rows/content/form/value/mes_expiracao/@name}" value="{rows/content/form/value/mes_expiracao}" class="number required" maxlength="2">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/ano_expiracao">
                      <label>
                        ...
                        <input type="number" name="{rows/content/form/value/ano_expiracao/@name}" value="{rows/content/form/value/ano_expiracao}" class="number required" maxlength="4">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/cvv2_confirmacao">
                      <label>
                        ...
                        <input type="number" name="{rows/content/form/value/cvv2_confirmacao/@name}" value="{rows/content/form/value/cvv2_confirmacao}" class="number required" maxlength="7">
                          <xsl:call-template name="FIELD_validator">
