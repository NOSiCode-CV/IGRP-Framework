                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/description">
                      <label>
                        ...
                        <input type="text" name="{rows/content/form/value/description/@name}" value="{rows/content/form/value/description}" class="text required" maxlength="60">
                    ...
                    <xsl:if test="rows/content/form/label/link">
                      <label>
                        <span>(*)<xsl:value-of select="rows/content/form/label/link"/>
                        </span>
                        <input type="text" name="{rows/content/form/value/link/@name}" value="{rows/content/form/value/link}" class="text required" maxlength="1000">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/method">
                      <label>
                        ...
                        <input type="text" name="{rows/content/form/value/method/@name}" value="{rows/content/form/value/method}" class="text" maxlength="100">
                          <xsl:call-template name="FIELD_validator">
                    ...
                    <xsl:if test="rows/content/form/label/status">
                      <label>
                        ...
                        <input type="text" name="{rows/content/form/value/status/@name}" value="{rows/content/form/value/status}" class="text required" maxlength="20">
                          <xsl:call-template name="FIELD_validator">
