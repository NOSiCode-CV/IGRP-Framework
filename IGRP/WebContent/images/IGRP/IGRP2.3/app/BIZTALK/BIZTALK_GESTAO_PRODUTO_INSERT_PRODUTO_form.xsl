                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/tipo">
                      <label>
                        ...
                        <select name="{rows/content/form/list/tipo/@name}" class="select" maxlength="1">
                          <xsl:call-template name="FIELD_validator">
                      ...
                      <div rel="adiciona_servicos" name="sep_adiciona_servicos">
                        ...
                        <xsl:if test="rows/content/form/label/servico">
                          <label>
                            ...
                            <input type="LOOKUP" name="{rows/content/form/value/servico/@name}" value="{rows/content/form/value/servico}" class="LOOKUP" maxlength="200" rel="F_adiciona_servicos">
                              <xsl:call-template name="FIELD_validator">
                        ...
                        <xsl:if test="rows/content/form/label/bd_user">
                          <label>
                            ...
                            <input type="text" name="{rows/content/form/value/bd_user/@name}" value="{rows/content/form/value/bd_user}" class="text required" maxlength="30" rel="F_adiciona_servicos">
                              <xsl:call-template name="FIELD_validator">
                        ...
                        <xsl:if test="rows/content/form/label/id_host">
                          <label>
                            ...
                            <select name="{rows/content/form/list/id_host/@name}" class="select required" maxlength="30" rel="F_adiciona_servicos">
                              <xsl:call-template name="FIELD_validator">
                        ...
                        <xsl:if test="rows/content/form/label/id_server">
                          <label>
                            ...
                            <select name="{rows/content/form/list/id_server/@name}" class="select required" maxlength="30" rel="F_adiciona_servicos">
                              <xsl:call-template name="FIELD_validator">
                        ...
                        <xsl:if test="rows/content/form/label/biztalk">
                          <label>
                            ...
                            <select name="{rows/content/form/list/biztalk/@name}" class="select" maxlength="30" rel="F_adiciona_servicos">
                              <xsl:call-template name="FIELD_validator">
                      ...
                      <div rel="lista_prod" name="sep_lista_prod">
                        ...
                        <xsl:if test="rows/content/form/label/produto">
                          <label>
                            ...
                            <input type="LOOKUP" name="{rows/content/form/value/produto/@name}" value="{rows/content/form/value/produto}" class="LOOKUP" maxlength="300" rel="F_lista_prod">
                              <xsl:call-template name="FIELD_validator">
