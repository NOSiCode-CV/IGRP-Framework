<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/comentar">
                                                                    <div class="form-group col-md-12  gen-fields-holder" item-name="comentar" item-type="textarea">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1484852454329"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1484852454329"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1484852454329"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1484852454329"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1484852454330"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1484852454330"/>
</xsl:stylesheet>