<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/ilha">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-type="select" item-name="ilha">
                                                                        ...
                                                                        <select class="form-control select2 IGRP_change" name="{rows/content/form_1/fields/ilha/@name}" id="form_1_ilha">
                                        ...
                                        <div class="gen-column col-md-3">
                                            <div class="gen-inner">
                                                <xsl:if test="rows/content/smallbox_2">
                                                    <div class="small-box panel {rows/content/smallbox_2/fields/smallbox_2_bg/value} gen-container-item " item-name="smallbox_2" gen-class="">
                                                        <div class="panel-heading clearfix">
                                                            <div class="sb-icon">
                                                        ...
                                                        <xsl:if test="rows/content/smallbox_2/fields/smallbox_2_lbl/value and rows/content/smallbox_2/fields/smallbox_2_lbl/value != ''">
                                                            <a href="{rows/content/smallbox_2/fields/smallbox_2_url/value}" class="{rows/content/smallbox_2/fields/smallbox_2_bg/value}-text" target="modal">
                                                                <div class="panel-footer">
                                                                    <span class="pull-left">
                                                    ...
                                                    <div class="box gen-container-item " item-name="chart_1" gen-class="" gen-structure="graphic">
                                                        ...
                                                        <div class="box-body">
                                                            <xsl:call-template name="igrp-graph">
                                                                ...
                                                                <xsl:with-param name="title" select="'Total Por Ilha'" />
                                                    ...
                                                    <div class="box gen-container-item " item-name="chart_2" gen-class="" gen-structure="graphic">
                                                        ...
                                                        <div class="box-body">
                                                            <xsl:call-template name="igrp-graph">
                                                                ...
                                                                <xsl:with-param name="height" select="'250'" />
                                                                <xsl:with-param name="title" select="'Funcionalidades / Lentidão'" />
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1485434372929" />
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1485434372929" />
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1485434372929" />
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1485434372929" />
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1485434372929" />
    <xsl:include href="../../xsl/tmpl/IGRP-charts.tmpl.xsl?v=1485434372929" />
</xsl:stylesheet>