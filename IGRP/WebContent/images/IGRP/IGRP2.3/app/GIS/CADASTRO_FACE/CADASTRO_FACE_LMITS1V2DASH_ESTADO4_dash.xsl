<xsl:stylesheet
                                            ...
                                            <div class="gen-inner">
                                                <xsl:if test="rows/content/smallbox_3">
                                                    <div class="small-box panel {rows/content/smallbox_3/fields/smallbox_3_bg/value} gen-container-item " item-name="smallbox_3">
                                                        ...
                                                        <xsl:if test="rows/content/smallbox_3/fields/smallbox_3_lbl/value">
                                            ...
                                            <div class="gen-inner">
                                                <xsl:if test="rows/content/smallbox_2">
                                                    <div class="small-box panel {rows/content/smallbox_2/fields/smallbox_2_bg/value} gen-container-item " item-name="smallbox_2">
                                                        ...
                                                        <xsl:if test="rows/content/smallbox_2/fields/smallbox_2_lbl/value">
                                                            <a href="{rows/content/smallbox_2/fields/smallbox_2_url/value}" class="{rows/content/smallbox_2/fields/smallbox_2_bg/value}-text">
                                                                <div class="panel-footer">
                                                                    <span class="pull-left">
                                            ...
                                            <div class="gen-inner">
                                                <xsl:if test="rows/content/smallbox_1">
                                                    <div class="small-box panel {rows/content/smallbox_1/fields/smallbox_1_bg/value} gen-container-item " item-name="smallbox_1">
                                                        ...
                                                        <xsl:if test="rows/content/smallbox_1/fields/smallbox_1_lbl/value">
                                            ...
                                            <div class="gen-inner">
                                                <xsl:if test="rows/content/sb_parc_user">
                                                    <div class="small-box panel {rows/content/sb_parc_user/fields/sb_parc_user_bg/value} gen-container-item " item-name="sb_parc_user">
                                                        <div class="panel-heading clearfix">
                                                            <div class="sb-icon">
                                                                <i class="fa {rows/content/sb_parc_user/fields/sb_parc_user_icn/value} fa-3x"/>
                                                            </div>
                                                            <div class="col-xs-12 text-right pull-right sb-contents">
                                                                <div class="huge">
                                                                    <xsl:value-of select="rows/content/sb_parc_user/fields/sb_parc_user_val/value"/>
                                                                </div>
                                                                <div>
                                                                    <xsl:value-of select="rows/content/sb_parc_user/fields/sb_parc_user_tit/value"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <xsl:if test="rows/content/sb_parc_user/fields/sb_parc_user_lbl/value">
                                                            <a href="{rows/content/sb_parc_user/fields/sb_parc_user_url/value}" class="{rows/content/sb_parc_user/fields/sb_parc_user_bg/value}-text">
                                                                <div class="panel-footer">
                                                                    <span class="pull-left">
                                                                        <xsl:value-of select="rows/content/sb_parc_user/fields/sb_parc_user_lbl/value"/>
                                                                    </span>
                                                                    <span class="pull-right">
                                                                        <i class="fa fa-arrow-circle-right"/>
                                                                    </span>
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1483709540218"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1483709540218"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1483709540218"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1483709540218"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1483709540218"/>
    <xsl:include href="../../xsl/tmpl/IGRP-charts.tmpl.xsl?v=1483709540218"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1483709540218"/>
</xsl:stylesheet>