<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/nome_f">
                                                                    <div class="form-group col-md-4   gen-fields-holder" item-name="nome_f" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/nome_f/value}" class="form-control " id="{rows/content/form_1/fields/nome_f/@name}" name="{rows/content/form_1/fields/nome_f/@name}" maxlength="200" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_1/fields/mac">
                                                                    <div class="form-group col-md-2   gen-fields-holder" item-name="mac" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/mac/value}" class="form-control " id="{rows/content/form_1/fields/mac/@name}" name="{rows/content/form_1/fields/mac/@name}" maxlength="200" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                                    ...
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="export != ''">
                                                                                            <a href="{export}" class="link bClick" target="_self" name="export">
                                                                                                <xsl:value-of select="export_desc"/>
                                                                                            </a>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <span>
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1492020634750"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1492020634750"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1492020634750"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1492020634750"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1492020634750"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1492020634750"/>
</xsl:stylesheet>