<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/titulo">
                                                                    <div class="form-group col-md-4   gen-fields-holder" item-name="titulo" item-type="text" required="required">
                                                                        <label for="{rows/content/form_1/fields/titulo/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_1/fields/titulo/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/form_1/fields/titulo/value}" class="form-control " id="{rows/content/form_1/fields/titulo/@name}" name="{rows/content/form_1/fields/titulo/@name}" required="required" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_1/fields/atribuir_a">
                                                                    <div class="col-md-4 form-group  gen-fields-holder" item-name="atribuir_a" item-type="select" required="required">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1491842121902"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1491842121902"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1491842121902"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1491842121902"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1491842121904"/>
</xsl:stylesheet>