<xsl:stylesheet
                                    ...
                                    <div class="row">
                                        <div class="gen-column col-md-12">
                                            <div class="gen-inner">
                                                ...
                                                <xsl:if test="rows/content/lista">
                                                    <div class="box box-table-contents gen-container-item " gen-class="" item-name="lista">
                                                        <xsl:call-template name="box-header">
                                                            <xsl:with-param name="title" select="rows/content/lista/@title"/>
                                                            <xsl:with-param name="collapsible" select="'true'"/>
                                                        </xsl:call-template>
                                                        <div class="box-body table-box">
                                                            <xsl:apply-templates mode="form-hidden-fields" select="rows/content/lista/fields"/>
                                                            <table id="lista" class="table table-striped gen-data-table " exports="">
                                                                <thead>
                                                                    <tr>
                                                                        <xsl:if test="rows/content/lista/fields/link2">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/lista/fields/link2/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                    </tr>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/lista/table/value/row">
                                                                        <tr>
                                                                            <xsl:apply-templates mode="context-param" select="context-menu"/>
                                                                            <xsl:if test="link2">
                                                                                <td align="left" data-row="{position()}" data-title="{../../label/link2}" class="link">
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="link2 != ''">
                                                                                            <a href="{link2}" class="link bClick" target="_self" name="link2">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1491217598909"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1491217598909"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1491217598909"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1491217598909"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1491217598910"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1491217598910"/>
</xsl:stylesheet>