        ...
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:if test="not(rows/target) or rows/target!='_blank'"><!--MENU--><div class="bodyPageLeft">
              ...
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FILTER--><div class="box-content resetPadding">
                <div class="col">
                  ...
                  <xsl:if test="rows/content/filter/label/id_morada">
                    <div class="col-1-4 item" item-name="id_morada">
                      <div class="igrp_item hidden">
                        <label>
                          <span class="riquired">*</span>
                          <xsl:value-of select="rows/content/filter/label/id_morada" disable-output-escaping="yes"/>
                        </label>
                        <div class="_clear"/>
                      </div>
                      <div class="_clear"/>
                  ...
                  <xsl:if test="rows/content/filter/label/nu_bi">
                    <div class="col-1-4 item" item-name="nu_bi">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/filter/value/nu_bi/@name}" value="{rows/content/filter/value/nu_bi}" class="text" maxlength="20">
                          <xsl:call-template name="FIELD_validator">
            ...
            <div class="box-content resetPadding">
              ...
              <div class="box-content resetPadding">
                <div class="box-content resetPadding">
                  <xsl:if test="rows/content/tm"><!-- START CHARTS--><div class="col" graph-name="tm">
                      <xsl:call-template name="igrp-graph">
                        <xsl:with-param name="table" select="rows/content/tm"/>
                        <xsl:with-param name="chart_type" select="rows/content/tm/chart_type"/>
                        <xsl:with-param name="height" select="150"/>
                        <xsl:with-param name="title" select="rows/content/tm/caption"/>
                      </xsl:call-template>
                    </div><!-- END CHARTS--></xsl:if>
                  <xsl:if test="rows/content/ts"><!-- START CHARTS--><div class="col" graph-name="ts">
                      <xsl:call-template name="igrp-graph">
                        <xsl:with-param name="table" select="rows/content/ts"/>
                        <xsl:with-param name="chart_type" select="rows/content/ts/chart_type"/>
                        <xsl:with-param name="height" select="150"/>
                        <xsl:with-param name="title" select="rows/content/ts/caption"/>
                      </xsl:call-template>
                    </div><!-- END CHARTS--></xsl:if>
                  <div class="_clear"/>
                </div>
