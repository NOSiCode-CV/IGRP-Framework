            ...
            <div class="ui-layout-center">
              <xsl:call-template name="dialog-modal"/><!-- START YOUR CODE HERE --><div class="box-content"><!--PAGE TITLE--><xsl:call-template name="page-title">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    </xsl:if><!-- INICIO SEPARADOR conteudo_ficheiro--><xsl:if test="rows/content/form/label/conteudo_ficheiro">
                      <xsl:if test="rows/content/form/label/conteudo_ficheiro">
                        <div name="sep_conteudo_ficheiro">
                          <xsl:call-template name="page-title">
                            <xsl:with-param name="title" select="rows/content/form/label/conteudo_ficheiro"/>
                    ...
                    <xsl:if test="rows/content/form/label/texto">
                      <label>
                        ...
                        <textarea name="{rows/content/form/value/texto/@name}" class="textarea" readonly="readonly" maxlength="4000">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/texto"/>
                          </xsl:call-template>
                          <xsl:value-of select="rows/content/form/value/texto"/>
                        </textarea>
                      </label>
                    </xsl:if>
