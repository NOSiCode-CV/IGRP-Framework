                  ...
                  <xsl:if test="rows/content/form/label/capa">
                    <div class="col-1-4 item" item-name="capa">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/form/value/capa/@name}" value="{rows/content/form/value/capa}" class="text required" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                  ...
                  <xsl:if test="rows/content/form/label/estado">
                    <div class="col-1-4 item" item-name="estado">
                      <div class="igrp_item select">
                        ...
                        <select name="{rows/content/form/list/estado/@name}" chosen="select" data-placeholder="{rows/content/form/list/estado/option[position() = 1]}" class="select required">
                          <xsl:call-template name="FIELD_validator">
                  ...
                  <xsl:if test="rows/content/form/label/tipo_filme">
                    <div class="col-1-4 item" item-name="tipo_filme">
                      <div class="igrp_item select">
                        ...
                        <select name="{rows/content/form/list/tipo_filme/@name}" chosen="select" data-placeholder="{rows/content/form/list/tipo_filme/option[position() = 1]}" class="select required">
                          <xsl:call-template name="FIELD_validator">
