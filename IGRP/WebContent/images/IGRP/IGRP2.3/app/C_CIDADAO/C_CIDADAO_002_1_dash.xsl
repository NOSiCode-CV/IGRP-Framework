                ...
                <div class="col">
                  ...
                  <div class="table-container"><!--  CONTEXT-MENU  --><xsl:apply-templates mode="context-menu" select="rows/content/table/context-menu">
                    ...
                    <table class="IGRP_table default-table" data-control="table">
                      <thead>
                        <tr>
                          <xsl:if test="rows/content/table/label/valor_inicial">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/valor_inicial"/>
                            </th>
                          </xsl:if>
                          <xsl:if test="rows/content/table/label/valor_final">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/valor_final"/>
                            </th>
                          </xsl:if>
                      ...
                      <tbody>
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="valor_inicial">
                              <td align="" data-row="{position()}" data-title="{../../label/valor_inicial}">
                                <xsl:value-of select="valor_inicial"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="valor_final">
                              <td align="" data-row="{position()}" data-title="{../../label/valor_final}">
                                <xsl:value-of select="valor_final"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="descricao">
                              <td align="" data-row="{position()}" data-title="{../../label/descricao}">
