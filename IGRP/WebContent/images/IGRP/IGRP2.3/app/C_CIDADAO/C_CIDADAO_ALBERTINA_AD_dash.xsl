        ...
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:if test="not(rows/target) or rows/target!='_blank'"><!--MENU--><div class="bodyPageLeft">
            ...
            <div class="box-content resetPadding">
              ...
              <div class="box-content resetPadding"><!-- START SIMPLE-MENU --><xsl:apply-templates mode="menu-simple" select="rows/content/menu"/><!-- END SIMPLE-MENU --><div class="box-content resetPadding">
                  <xsl:if test="rows/content/dado_identificativo"><!-- START CHARTS--><div class="col" graph-name="dado_identificativo">
                      <xsl:call-template name="igrp-graph">
                        <xsl:with-param name="table" select="rows/content/dado_identificativo"/>
                        <xsl:with-param name="chart_type" select="rows/content/dado_identificativo/chart_type"/>
                        <xsl:with-param name="height" select="150"/>
                        <xsl:with-param name="title" select="rows/content/dado_identificativo/caption"/>
                      </xsl:call-template>
