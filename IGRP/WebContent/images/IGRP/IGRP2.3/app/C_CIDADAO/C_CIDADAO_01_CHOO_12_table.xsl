            ...
            <div class="ui-layout-center">
              <xsl:call-template name="dialog-modal"/><!-- START YOUR CODE HERE --><div class="box-content"><!--PAGE TITLE--><xsl:call-template name="page-title">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/cc">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/form/label/cc"/>
                        </span>
                        <input type="text" name="{rows/content/form/value/cc/@name}" value="{rows/content/form/value/cc}" class="text" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/cc"/>
                          </xsl:call-template>
                        </input>
                      </label>
                  ...
                  <div class="table">
                    <table class="sortable IGRP_table">
                      <thead>
                        <tr>
                          <xsl:if test="rows/content/table/label/aa">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/aa"/>
                            </th>
                          </xsl:if>
                          <xsl:if test="rows/content/table/label/cc">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/cc"/>
                            </th>
                          </xsl:if>
                        </tr>
                      </thead>
