        ...
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:if test="not(rows/target) or rows/target!='_blank'"><!--MENU--><div class="bodyPageLeft">
              ...
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FILTER--><div class="box-content resetPadding">
                <div class="col">
                  ...
                  <xsl:if test="rows/content/filter/label/numero_socio">
                    <div class="col-1-4 item" item-name="numero_socio">
                      <div class="igrp_item text">
                        <label>
                          <xsl:value-of select="rows/content/filter/label/numero_socio" disable-output-escaping="yes"/>
                        </label>
                        <input type="text" name="{rows/content/filter/value/numero_socio/@name}" value="{rows/content/filter/value/numero_socio}" class="text" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/filter/label/numero_socio"/>
                          </xsl:call-template>
                        </input>
                        <div class="_clear"/>
                      </div>
                      ...
                      <tbody>
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="estado">
                              <td align="" data-row="{position()}" data-title="{../../label/estado}">
                                <xsl:choose>
                                  <xsl:when test="estado != ''">
                                    <a href="{estado}" class="link bClick" target="_blank" name="estado">
                                      <xsl:value-of select="estado_desc" disable-output-escaping="yes"/>
                                    </a>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <xsl:value-of select="estado_desc" disable-output-escaping="yes"/>
            ...
            <div class="box-content resetPadding">
              ...
              <div class="box-content resetPadding">
                <div class="box-content resetPadding">
                  ...
                  <xsl:if test="rows/content/top_tres_socios"><!-- START CHARTS--><div class="col" graph-name="top_tres_socios">
                      <xsl:call-template name="igrp-graph">
                        <xsl:with-param name="table" select="rows/content/top_tres_socios"/>
                        <xsl:with-param name="chart_type" select="rows/content/top_tres_socios/chart_type"/>
                        <xsl:with-param name="height" select="150"/>
