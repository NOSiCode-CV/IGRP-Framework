              ...
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START TABELA--><div class="box-content resetPadding"><!--START TOOL BAR TABLE--><xsl:apply-templates mode="tools-bar" select="rows/content/table/tools-bar">
                  ...
                  <div class="table-container">
                    <table class="IGRP_table default-table" data-control="table">
                      <thead>
                        <tr>
                          <xsl:if test="rows/content/table/label/documentos">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/documentos"/>
                            </th>
                          </xsl:if>
                        ...
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="">
                            ...
                            <xsl:if test="documentos">
                              <td align="" data-row="{position()}" data-title="{../../label/documentos}">
                            ...
                            <xsl:if test="observacao">
                              <td align="" data-row="{position()}" data-title="{../../label/observacao}">
