                  ...
                  <xsl:if test="rows/content/form/label/capa_id">
                    <div class="col-1-4 item" item-name="capa_id">
                      <div class="igrp_item file">
                        ...
                        <div class="itemIcon">
                          <input class="notForm" placeholder="Choose File" disabled="disabled" file="id_{rows/content/form/value/capa_id/@name}"/>
                          <span class="upload">File</span>
                          <input type="file" name="{rows/content/form/value/capa_id/@name}" value="{rows/content/form/value/capa_id}" class="file uploadFile">
                            <xsl:call-template name="FIELD_validator">
