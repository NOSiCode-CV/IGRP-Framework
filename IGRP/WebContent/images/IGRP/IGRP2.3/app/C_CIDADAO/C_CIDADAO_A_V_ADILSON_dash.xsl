            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_filter"><!-- SHOW HIDDEN--><xsl:apply-templates mode="form-hidden" select="rows/content/filter/value"/>
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FILTER--><div class="box-content resetPadding">
                <div class="col">
                  ...
                  <xsl:if test="rows/content/filter/label/capa_id">
                    <div class="col-1-4 item" item-name="capa_id">
                      <div class="igrp_item number">
                        <label>
                          <xsl:value-of select="rows/content/filter/label/capa_id" disable-output-escaping="yes"/>
                        </label>
                        <input type="number" name="{rows/content/filter/value/capa_id/@name}" value="{rows/content/filter/value/capa_id}" class="number" maxlength="22">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/filter/label/capa_id"/>
                          </xsl:call-template>
                        </input>
                        <div class="_clear"/>
                      </div>
