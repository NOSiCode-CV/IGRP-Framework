      ...
      <body class="bodyColor">
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:if test="not(rows/target) or rows/target!='_blank'"><!--MENU--><div class="bodyPageLeft">
                  ...
                  <xsl:if test="rows/content/form/label/idade">
                    <div class="col-1-4 item" item-name="idade">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/form/value/idade/@name}" value="{rows/content/form/value/idade}" class="text" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
            ...
            <div class="box-content resetPadding">
              <xsl:if test="rows/content/teste"><!-- START CHARTS--><div class="col-1-373" graph-name="teste">
                  <xsl:call-template name="igrp-graph">
                    <xsl:with-param name="table" select="rows/content/teste"/>
                    <xsl:with-param name="chart_type" select="rows/content/teste/chart_type"/>
