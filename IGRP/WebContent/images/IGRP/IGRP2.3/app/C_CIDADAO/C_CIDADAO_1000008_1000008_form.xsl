                        ...
                        <table rel="T_lista_resp" data-control="data-lista_resp">
                          <thead>
                            <tr>
                              ...
                              <xsl:if test="rows/content/form/table/lista_resp/label/data_nasc_resp">
                                <xsl:if test="not(rows/content/form/table/lista_resp/label/data_nasc_resp/@visible)">
                                  <th>
                                    <xsl:value-of select="rows/content/form/table/lista_resp/label/data_nasc_resp" disable-output-escaping="yes"/>
                                  </th>
                                </xsl:if>
                              </xsl:if>
                            </tr>
                          ...
                          <tbody>
                            <xsl:for-each select="rows/content/form/table/lista_resp/value/row[not(@total='yes')]">
                              <tr row="{position()}">
                                ...
                                <xsl:if test="data_nasc_resp">
                                  <xsl:if test="not(data_nasc_resp/@visible)">
                                    <td data-row="{position()}" data-title="{../../label/data_nasc_resp}">
                                      <xsl:value-of select="data_nasc_resp" disable-output-escaping="yes"/>
                                      <input type="hidden" name="p_data_nasc_resp_fk" value="{data_nasc_resp}"/>
                                    </td>
                                  </xsl:if>
                                  <xsl:if test="data_nasc_resp/@visible = 'false'">
                                    <input type="hidden" name="p_data_nasc_resp_fk" value="{data_nasc_resp}"/>
                                  </xsl:if>
                                </xsl:if>
