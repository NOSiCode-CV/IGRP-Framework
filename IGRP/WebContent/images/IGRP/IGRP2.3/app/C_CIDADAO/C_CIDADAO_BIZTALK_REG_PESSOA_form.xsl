                  ...
                  <xsl:if test="rows/content/form/label/id">
                    <div class="col-1-4 item" item-name="id">
                      <div class="igrp_item number">
                        ...
                        <input type="number" name="{rows/content/form/value/id/@name}" value="{rows/content/form/value/id}" class="number required" maxlength="30">
                  ...
                  <xsl:if test="rows/content/form/label/servico">
                    <div class="col-1-4 item" item-name="servico">
                      <div class="igrp_item select">
                        ...
                        <select name="{rows/content/form/list/servico/@name}" chosen="select" data-placeholder="{rows/content/form/list/servico/option[position() = 1]}" class="select required">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/servico"/>
                          </xsl:call-template>
                          <option value=""/>
                          <xsl:for-each select="rows/content/form/list/servico/option[position() != 1]">
                            <option value="{value}">
