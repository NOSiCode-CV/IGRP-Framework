            ...
            <div class="ui-layout-center">
              <xsl:call-template name="dialog-modal"/><!-- START YOUR CODE HERE --><div class="box-content"><!--PAGE TITLE--><xsl:call-template name="page-title">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/filter/label/um">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/filter/label/um"/>
                        </span>
                        <input type="text" name="{rows/content/filter/value/um/@name}" value="{rows/content/filter/value/um}" class="text" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/filter/label/um"/>
                          </xsl:call-template>
                        </input>
                      </label>
                  ...
                  <div class="table">
                    <table class="sortable IGRP_table">
                      <thead>
                        <tr>
                          <xsl:if test="rows/content/table/label/t">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/t"/>
                            </th>
                          </xsl:if>
                          <xsl:if test="rows/content/table/label/test">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/test"/>
                            </th>
                          </xsl:if>
                        </tr>
                      </thead>
