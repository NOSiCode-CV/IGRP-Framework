            ...
            <div class="ui-layout-center">
              <xsl:call-template name="dialog-modal"/><!-- START YOUR CODE HERE --><div class="box-content"><!--PAGE TITLE--><xsl:call-template name="page-title">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/filter/label/flitro">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/filter/label/flitro"/>
                        </span>
                        <input type="text" name="{rows/content/filter/value/flitro/@name}" value="{rows/content/filter/value/flitro}" class="text" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/filter/label/flitro"/>
                          </xsl:call-template>
                        </input>
                      </label>
