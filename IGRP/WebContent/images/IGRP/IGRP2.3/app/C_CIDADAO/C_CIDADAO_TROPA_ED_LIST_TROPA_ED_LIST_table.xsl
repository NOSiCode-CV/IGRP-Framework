                ...
                <div class="col">
                  ...
                  <xsl:if test="rows/content/form/label/apelido">
                    <div class="col-1-4 item" item-name="apelido">
                      <div class="igrp_item text">
                        <label>
                          <xsl:if test="string-length(rows/content/form/label/apelido) > 45">
                            <xsl:attribute name="title">
                    ...
                    <table class="IGRP_table default-table" data-control="table">
                      <thead>
                        <tr>
                          ...
                          <xsl:if test="rows/content/table/label/tel">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/tel"/>
                            </th>
                          </xsl:if>
                          <xsl:if test="rows/content/table/label/nasc">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/nasc"/>
                            </th>
                          </xsl:if>
                        </tr>
                      </thead>
                      <tbody>
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="apelido">
                              <td align="" data-row="{position()}" data-title="{../../label/apelido}" class="text">
                                <xsl:value-of select="apelido"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="tel">
                              <td align="" data-row="{position()}" data-title="{../../label/tel}" class="text">
                                <xsl:value-of select="tel"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="nasc">
                              <td align="" data-row="{position()}" data-title="{../../label/nasc}" class="text">
                                <xsl:value-of select="nasc"/>
                              </td>
                            </xsl:if>
                          </tr>
                        </xsl:for-each>
