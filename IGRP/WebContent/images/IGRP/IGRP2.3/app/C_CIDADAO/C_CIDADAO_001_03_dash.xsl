            ...
            <div class="ui-layout-center">
              <xsl:call-template name="dialog-modal"/><!-- START YOUR CODE HERE --><div class="box-content"><!--PAGE TITLE--><xsl:call-template name="page-title">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/filter/label/curso_est">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/filter/label/curso_est"/>
                        </span>
                        <input type="text" name="{rows/content/filter/value/curso_est/@name}" value="{rows/content/filter/value/curso_est}" class="text" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/filter/label/curso_est"/>
                          </xsl:call-template>
                        </input>
                      </label>
                    ...
                    <table class="sortable IGRP_table">
                      <thead>
                        <tr>
                          <xsl:if test="rows/content/table/label/numero_est">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/numero_est"/>
                            </th>
                          </xsl:if>
                      ...
                      <tbody>
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          ...
                          <tr class="">
                            ...
                            <xsl:if test="numero_est">
                              <td align="" class="table_row{$pos}">
                                <xsl:value-of select="numero_est"/>
                              </td>
                            </xsl:if>
