<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/password_1">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="password_1" item-type="password" required="required">
                                                                        ...
                                                                        <input type="password" value="{rows/content/form_1/fields/password_1/value}" class="form-control " id="{rows/content/form_1/fields/password_1/@name}" name="{rows/content/form_1/fields/password_1/@name}" required="required" maxlength="30" placeholder="">
                                                                            <xsl:call-template name="setAttributes">
                                                                                <xsl:with-param name="field" select="rows/content/form_1/fields/password_1"/>
                                                                            </xsl:call-template>
                                                                        </input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_1/fields/confirm_password">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="confirm_password" item-type="password" required="required">
                                                                        <label for="{rows/content/form_1/fields/confirm_password/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_1/fields/confirm_password/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="password" value="{rows/content/form_1/fields/confirm_password/value}" class="form-control " id="{rows/content/form_1/fields/confirm_password/@name}" name="{rows/content/form_1/fields/confirm_password/@name}" required="required" maxlength="30" placeholder="">
                                                                            <xsl:call-template name="setAttributes">
                                                                                <xsl:with-param name="field" select="rows/content/form_1/fields/confirm_password"/>
                                                                            </xsl:call-template>
                                                                        </input>
                                                                    </div>
                                                                </xsl:if>
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1516547505355"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1516547505355"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1516547505355"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1516547505355"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1516547505355"/>
</xsl:stylesheet>
