<xsl:stylesheet
                                                        ...
                                                        <div class="box-body ">
                                                            ...
                                                            <div class="table-box">
                                                                <div class="table-box-inner">
                                                                    <table id="table_1" class="table table-striped   " exports="null">
                                                                        <thead>
                                                                            <tr>
                                                                                <xsl:if test="rows/content/table_1/fields/transacao">
                                                                                    <th class="bs-checkbox gen-fields-holder" align="center">
                                                                                        <span>Transacao</span>
                                                                                        <input type="checkbox" class="IGRP_checkall" check-rel="transacao" title="Transacao" data-toggle="tooltip"/>
                                                                                    </th>
                                                                                </xsl:if>
                                                                            ...
                                                                            <xsl:for-each select="rows/content/table_1/table/value/row[not(@total='yes')]">
                                                                                <tr>
                                                                                    ...
                                                                                    <xsl:if test="transacao">
                                                                                        <td align="" data-row="{position()}" data-title="{../../label/transacao}" class="bs-checkbox" item-name="transacao">
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1515000244197"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1515000244197"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1515000244197"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1515000244197"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1515000244198"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1515000244198"/>
</xsl:stylesheet>
