<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/number_1">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="number_1" item-type="number">
                                                                        ...
                                                                        <input type="number" value="{rows/content/form_1/fields/number_1/value}" class="form-control " id="{rows/content/form_1/fields/number_1/@name}" name="{rows/content/form_1/fields/number_1/@name}" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/text_1">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="text_1" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/text_1/value}" class="form-control " id="{rows/content/form_1/fields/text_1/@name}" name="{rows/content/form_1/fields/text_1/@name}" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="number_1">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/number_1/label}" class="number">
                                                                                    <span class="">
    ...
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-functions.tmpl.xsl?v=1495102931340"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-variables.tmpl.xsl?v=1495102931340"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1495102931340"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-utils.tmpl.xsl?v=1495102931340"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1495102931341"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1495102931341"/>
</xsl:stylesheet>
