<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                          ...
                          <div class="box igrp-forms gen-container-item " gen-class="" item-name="form_1">
                            <div class="box-body">
                              <div role="form">
                                ...
                                <xsl:if test="rows/content/form_1/fields/nome_de_conxeao">
                                  <div class="form-group col-sm-3   gen-fields-holder" item-name="nome_de_conxeao" item-type="text" required="required">
                                    <label for="{rows/content/form_1/fields/nome_de_conxeao/@name}">
                                      <span>
                                        <xsl:value-of select="rows/content/form_1/fields/nome_de_conxeao/label"/>
                                      </span>
                                    </label>
                                    <input type="text" value="{rows/content/form_1/fields/nome_de_conxeao/value}" class="form-control " id="{rows/content/form_1/fields/nome_de_conxeao/@name}" name="{rows/content/form_1/fields/nome_de_conxeao/@name}" required="required" maxlength="30" placeholder="">
                                      <xsl:call-template name="setAttributes">
                                        <xsl:with-param name="field" select="rows/content/form_1/fields/nome_de_conxeao"/>
                                      </xsl:call-template>
                                    </input>
                                  </div>
                                </xsl:if>
  ...
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1510332679285"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1510332679285"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1510332679285"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1510332679285"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1510332679285"/>
</xsl:stylesheet>
