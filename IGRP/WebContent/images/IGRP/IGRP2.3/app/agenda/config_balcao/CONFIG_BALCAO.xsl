<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                                            ...
                                            <div role="form">
                                              ...
                                              <xsl:if test="rows/content/form_1/fields/localizacao">
                                                <div class="form-group col-sm-3   gen-fields-holder" item-name="localizacao" item-type="text" required="required">
                                                  ...
                                                  <input type="text" value="{rows/content/form_1/fields/localizacao/value}" class="form-control " id="{rows/content/form_1/fields/localizacao/@name}" name="{rows/content/form_1/fields/localizacao/@name}" readonly="readonly" required="required" maxlength="300" placeholder="">
                                                  </input>
                                                </div>
                                              </xsl:if>
                                              <xsl:if test="rows/content/form_1/fields/fuso_horario">
                                                <div class="form-group col-sm-3   gen-fields-holder" item-name="fuso_horario" item-type="text" required="required">
                                                  ...
                                                  <input type="text" value="{rows/content/form_1/fields/fuso_horario/value}" class="form-control " id="{rows/content/form_1/fields/fuso_horario/@name}" name="{rows/content/form_1/fields/fuso_horario/@name}" readonly="readonly" required="required" maxlength="300" placeholder="">
                                                  </input>
                                                </div>
                                              </xsl:if>
  ...
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1502300195050"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1502300195050"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1502300195050"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1502300195050"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1502300195050"/>
</xsl:stylesheet>
