<xsl:stylesheet
                                                                ...
                                                                <div class="splist-form" role="form">
                                                                    ...
                                                                    <xsl:if test="rows/content/separatorlist_2/fields/nome">
                                                                        <div class="form-group col-md-2   gen-fields-holder" item-name="nome" item-type="text" required="required">
                                                                            ...
                                                                            <input type="text" value="{rows/content/separatorlist_2/fields/nome/value}" class="form-control " id="{rows/content/separatorlist_2/fields/nome/@name}" name="{rows/content/separatorlist_2/fields/nome/@name}" required="required" maxlength="6" placeholder=""></input>
                                                                        </div>
                                                                    </xsl:if>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/documento_de_identificacao">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="documento_de_identificacao" item-type="number" required="required">
                                                                        ...
                                                                        <input type="number" value="{rows/content/form_1/fields/documento_de_identificacao/value}" class="form-control " id="{rows/content/form_1/fields/documento_de_identificacao/@name}" name="{rows/content/form_1/fields/documento_de_identificacao/@name}" required="required" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1501680274464"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1501680274464"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1501680274464"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1501680274464"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1501680274464"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1501680274464"/>
</xsl:stylesheet>
