<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                              ...
                              <div class="splist-form-holder">
                                <div class="splist-form" role="form">
                                  ...
                                  <xsl:if test="rows/content/separatorlist_2/fields/entidade">
                                    <div class="col-md-2 form-group  gen-fields-holder" item-name="entidade" item-type="select" required="required">
                                      ...
                                      <select class="form-control select2 IGRP_change" id="separatorlist_2_entidade" name="{rows/content/separatorlist_2/fields/entidade/@name}" required="required">
                                  ...
                                  <xsl:if test="rows/content/separatorlist_2/fields/servico">
                                    <div class="col-md-2 form-group  gen-fields-holder" item-name="servico" item-type="select" required="required">
                                      ...
                                      <select class="form-control select2 IGRP_change" id="separatorlist_2_servico" name="{rows/content/separatorlist_2/fields/servico/@name}" required="required">
                                  ...
                                  <xsl:if test="rows/content/separatorlist_2/fields/balcao">
                                    <div class="col-md-2 form-group  gen-fields-holder" item-name="balcao" item-type="select" required="required">
                                      ...
                                      <select class="form-control select2 IGRP_change" id="separatorlist_2_balcao" name="{rows/content/separatorlist_2/fields/balcao/@name}" required="required">
                                  ...
                                  <xsl:if test="rows/content/separatorlist_2/fields/data">
                                    <div class="form-group col-md-2  gen-fields-holder" item-name="data" item-type="date" required="required">
                                  ...
                                  <xsl:if test="rows/content/separatorlist_2/fields/hora">
                                    <div class="col-md-2 form-group  gen-fields-holder" item-name="hora" item-type="select" required="required">
                                  ...
                                  <xsl:if test="rows/content/separatorlist_2/fields/nome">
                                    <div class="form-group col-md-2   gen-fields-holder" item-name="nome" item-type="text" required="required">
                                        ...
                                        <xsl:if test="entidade">
                                          <xsl:choose>
                                            <xsl:when test="not(entidade/@visible)">
                                              <td field="entidade" data-row="{position()}" data-title="{../../../fields/entidade/label}" class="select">
                                        ...
                                        <xsl:if test="data">
                                          <xsl:choose>
                                            <xsl:when test="not(data/@visible)">
                                              <td field="data" data-row="{position()}" data-title="{../../../fields/data/label}" class="date">
                                                <span class="separator-list-td-val">
                                        ...
                                        <xsl:if test="hora">
                                          <xsl:choose>
                                            <xsl:when test="not(hora/@visible)">
                                              <td field="hora" data-row="{position()}" data-title="{../../../fields/hora/label}" class="select">
                                                <span class="separator-list-td-val">
                                  ...
                                  <xsl:for-each select="rows/content/table_1/table/value/row">
                                    <tr>
                                      ...
                                      <xsl:if test="tipo_requisito">
                                        <td align="left" data-row="{position()}" data-title="{../../fields/tipo_requisito/label}" class="text">
                                          <span class="">
                                      ...
                                      <xsl:if test="descritivo">
                                        <td align="left" data-row="{position()}" data-title="{../../fields/descritivo/label}" class="text">
                                          <span class="">
                                      ...
                                      <xsl:if test="formulario">
                                        <td align="left" data-row="{position()}" data-title="{../../label/formulario}" class="link">
                                          <xsl:choose>
                                            <xsl:when test="formulario != ''">
                                              <a href="{formulario}" class="link bClick" target="_self" name="formulario">
                            ...
                            <div class="box-body">
                              <div role="form">
                                ...
                                <xsl:if test="rows/content/form_1/fields/nome2">
                                  <div class="form-group col-md-3   gen-fields-holder" item-name="nome2" item-type="text" required="required">
                                ...
                                <xsl:if test="rows/content/form_1/fields/tipo_documento_de_identificacao">
                                  <div class="col-md-3 form-group  gen-fields-holder" item-name="tipo_documento_de_identificacao" item-type="select" required="required">
                                ...
                                <xsl:if test="rows/content/form_1/fields/documento_de_identificacao">
                                  <div class="form-group col-md-3   gen-fields-holder" item-name="documento_de_identificacao" item-type="number" required="required">
                                    ...
                                    <input type="number" value="{rows/content/form_1/fields/documento_de_identificacao/value}" class="form-control " id="{rows/content/form_1/fields/documento_de_identificacao/@name}" name="{rows/content/form_1/fields/documento_de_identificacao/@name}" required="required" maxlength="30" placeholder="">
                                    </input>
                                  </div>
                                </xsl:if>
                                ...
                                <xsl:if test="rows/content/form_1/fields/telemovel">
                                  <div class="form-group col-md-3   gen-fields-holder" item-name="telemovel" item-type="number">
                                    ...
                                    <input type="number" value="{rows/content/form_1/fields/telemovel/value}" class="form-control " id="{rows/content/form_1/fields/telemovel/@name}" name="{rows/content/form_1/fields/telemovel/@name}" maxlength="30" placeholder="">
                                    </input>
                                  </div>
                                </xsl:if>
                                <xsl:if test="rows/content/form_1/fields/telefone">
                                  <div class="form-group col-md-3   gen-fields-holder" item-name="telefone" item-type="number">
                                    ...
                                    <input type="number" value="{rows/content/form_1/fields/telefone/value}" class="form-control " id="{rows/content/form_1/fields/telefone/@name}" name="{rows/content/form_1/fields/telefone/@name}" maxlength="30" placeholder="">
                                    </input>
                                  </div>
                                </xsl:if>
                              </div>
  ...
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1502277028004"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1502277028004"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1502277028004"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1502277028004"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1502277028004"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1502277028004"/>
</xsl:stylesheet>
