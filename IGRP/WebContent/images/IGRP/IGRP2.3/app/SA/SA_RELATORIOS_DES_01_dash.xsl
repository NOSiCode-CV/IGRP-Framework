<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/filter_1/fields/requisito">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="requisito" item-type="select">
                                                                        ...
                                                                        <select class="form-control select2 IGRP_change" id="filter_1_requisito" name="{rows/content/filter_1/fields/requisito/@name}">
                                                                ...
                                                                <xsl:if test="rows/content/filter_1/fields/organica_">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="organica_" item-type="select">
                                                                        <label for="{rows/content/filter_1/fields/organica_/@name}">
                                                                            <xsl:value-of select="rows/content/filter_1/fields/organica_/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 IGRP_change" id="filter_1_organica_" name="{rows/content/filter_1/fields/organica_/@name}">
                                                                            <xsl:for-each select="rows/content/filter_1/fields/organica_/list/option">
                                                                                <option value="{value}" label="{text}">
                                                                                    <xsl:if test="@selected='true'">
                                                                                        <xsl:attribute name="selected">selected</xsl:attribute>
                                                                                    </xsl:if>
                                                            ...
                                                            <table id="gen_table" class="table table-striped gen-data-table " exports="pdf,excel">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <xsl:if test="rows/content/gen_table/fields/requisto_list">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/gen_table/fields/requisto_list/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        <xsl:if test="rows/content/gen_table/fields/n_de_avaliacao">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/gen_table/fields/n_de_avaliacao/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                    ...
                                                                    <xsl:for-each select="rows/content/gen_table/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="n_atendimentos">
                                                                                <td align="center" data-row="{position()}" data-title="{../../fields/n_atendimentos/label}" class="text">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="requisto_list">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/requisto_list/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="requisto_list"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                            <xsl:if test="n_de_avaliacao">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/n_de_avaliacao/label}" class="text">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="n_de_avaliacao"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1488886676184"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1488886676184"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1488886676184"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1488886676184"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1488886676184"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1488886676184"/>
</xsl:stylesheet>