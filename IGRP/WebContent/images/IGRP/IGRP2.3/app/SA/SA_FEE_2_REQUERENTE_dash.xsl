                    ...
                    <div class="box-body" first-type-container="" last-type-container="">
                      <div role="form" gen-id="drop-zone">
                        ...
                        <xsl:if test="rows/content/form/label/descricao">
                          <div class="col-md-12 clearfix clear form-group" item-name="descricao" item-type="plaintext">
                        ...
                        <xsl:if test="rows/content/form/label/nome">
                          <div class="form-group col-md-3" item-name="nome" item-type="LOOKUP">
                            ...
                            <div class="input-group">
                              <input type="text" value="{rows/content/form/value/nome}" class="form-control gen-lookup " id="{rows/content/form/value/nome/@name}" name="{rows/content/form/value/nome/@name}"/>
                        ...
                        <xsl:if test="rows/content/form/label/numero_documento">
                          <div class="form-group col-md-3" item-name="numero_documento" item-type="text">
                            ...
                            <input type="text" value="{rows/content/form/value/numero_documento}" class="form-control " id="{rows/content/form/value/numero_documento/@name}" name="{rows/content/form/value/numero_documento/@name}"/>
                          </div>
                        </xsl:if>
                        <xsl:if test="rows/content/form/label/telemovel">
                          <div class="form-group col-md-3" item-name="telemovel" item-type="text">
                            ...
                            <input type="text" value="{rows/content/form/value/telemovel}" class="form-control " id="{rows/content/form/value/telemovel/@name}" name="{rows/content/form/value/telemovel/@name}"/>
                          </div>
                        </xsl:if>
                  ...
                  <div class="box igrp-forms gen-container-item">
                    <div class="box-body" first-type-container="" last-type-container="">
                      <div role="form" gen-id="drop-zone">
                        ...
                        <xsl:if test="rows/content/filter/label/code_page">
                          <div class="form-group col-md-3" item-name="code_page" item-type="text">
                            <label for="{rows/content/filter/value/code_page/@name}">
                              <xsl:value-of select="rows/content/filter/label/code_page"/>
                            </label>
                            <input type="text" value="{rows/content/filter/value/code_page}" class="form-control " id="{rows/content/filter/value/code_page/@name}" name="{rows/content/filter/value/code_page/@name}"/>
                          </div>
                        </xsl:if>
                      </div>
                    </div>
