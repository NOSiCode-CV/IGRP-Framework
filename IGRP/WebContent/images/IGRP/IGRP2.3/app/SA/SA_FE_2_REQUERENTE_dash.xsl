                      ...
                      <div role="form" gen-id="drop-zone">
                        ...
                        <xsl:if test="rows/content/form/label/telefone">
                          <div class="form-group col-md-3" item-name="telefone" item-type="number">
                            <label for="{rows/content/form/label/telefone/@name}">
                              <xsl:value-of select="rows/content/form/label/telefone"/>
                            </label>
                            <input type="number" value="{rows/content/form/value/telefone}" class="form-control" id="{rows/content/form/label/telefone/@name}" name="{rows/content/form/label/telefone/@name}"/>
                          </div>
                        </xsl:if>
                      ...
                      <div role="form" gen-id="drop-zone">
                        ...
                        <xsl:if test="rows/content/filter/label/code_page">
                          <div class="form-group col-md-3" item-name="code_page" item-type="text">
                            <label for="{rows/content/filter/label/code_page/@name}">
                              <xsl:value-of select="rows/content/filter/label/code_page"/>
                            </label>
                            <input type="text" value="{rows/content/filter/value/code_page}" class="form-control" id="{rows/content/filter/label/code_page/@name}" name="{rows/content/filter/label/code_page/@name}"/>
                          </div>
                        </xsl:if>
                      </div>
                    </div>
