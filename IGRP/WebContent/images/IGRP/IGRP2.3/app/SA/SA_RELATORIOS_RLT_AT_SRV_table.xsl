<xsl:stylesheet
                                                            ...
                                                            <table id="gen_table" class="table table-striped gen-data-table " exports="pdf,excel">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <xsl:if test="rows/content/gen_table/fields/n_de_registos">
                                                                            <th align="center" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/gen_table/fields/n_de_registos/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                    </tr>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/gen_table/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="n_de_registos">
                                                                                <td align="center" data-row="{position()}" data-title="{../../fields/n_de_registos/label}" class="number">
                                                                                    <span class="">
                                                                                        <xsl:value-of select="n_de_registos"/>
                                                                                    </span>
                                                                                </td>
                                                                            </xsl:if>
                                                                        </tr>
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1488910881583"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1488910881583"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1488910881583"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1488910881583"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1488910881583"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1488910881584"/>
</xsl:stylesheet>