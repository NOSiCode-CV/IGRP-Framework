<xsl:stylesheet
                                                    ...
                                                    <div class="box igrp-forms gen-container-item " gen-class="" item-name="filter_1">
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/filter_1/fields/utilizador">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="utilizador" item-type="select">
                                                                        <label for="{rows/content/filter_1/fields/utilizador/@name}">
                                                                            <xsl:value-of select="rows/content/filter_1/fields/utilizador/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 " id="filter_1_utilizador" name="{rows/content/filter_1/fields/utilizador/@name}">
                                                                            <xsl:for-each select="rows/content/filter_1/fields/utilizador/list/option">
                                                                                <option value="{value}" label="{text}">
                                                                                    <xsl:if test="@selected='true'">
                                                                                        <xsl:attribute name="selected">selected</xsl:attribute>
                                                                                    </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/filter_1/fields/requisito">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="requisito" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/filter_1/fields/requisito/value}" class="form-control" id="{rows/content/filter_1/fields/requisito/@name}" name="{rows/content/filter_1/fields/requisito/@name}" maxlength="100"></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/filter_1/fields/atendimento">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="atendimento" item-type="text">
                                                                        <label for="{rows/content/filter_1/fields/atendimento/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/filter_1/fields/atendimento/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/filter_1/fields/atendimento/value}" class="form-control" id="{rows/content/filter_1/fields/atendimento/@name}" name="{rows/content/filter_1/fields/atendimento/@name}" maxlength="22"></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/filter_1/fields/data">
                                                                    <div class="form-group col-md-3  gen-fields-holder" item-name="data" item-type="date">
                                                                        <label for="{rows/content/filter_1/fields/data/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/filter_1/fields/data/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <input type="text" value="{rows/content/filter_1/fields/data/value}" class="form-control gen-date" id="filter_1-data" name="{rows/content/filter_1/fields/data/@name}" format="IGRP_datePicker" maxlength="30"/>
                                                            ...
                                                            <table id="gen_table" class="table table-striped gen-data-table IGRP_contextmenu">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <xsl:if test="rows/content/gen_table/fields/requisito">
                                                                            <th align="center" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/gen_table/fields/requisito/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                    ...
                                                                    <xsl:for-each select="rows/content/gen_table/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="id_atendimento">
                                                                                <td align="center" data-row="{position()}" data-title="{../../fields/id_atendimento/label}" class="text">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="requisito">
                                                                                <td align="center" data-row="{position()}" data-title="{../../fields/requisito/label}" class="text">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="id_grau">
                                                                                <td align="center" data-row="{position()}" data-title="{../../fields/id_grau/label}" class="text">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="id_motivo">
                                                                                <td align="center" data-row="{position()}" data-title="{../../fields/id_motivo/label}" class="text">
                                                                                    <span class="">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1488198119530"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1488198119530"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1488198119530"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1488198119530"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1488198119530"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1488198119530"/>
</xsl:stylesheet>