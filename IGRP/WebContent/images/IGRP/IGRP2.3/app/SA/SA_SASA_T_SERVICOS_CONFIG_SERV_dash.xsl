<xsl:stylesheet
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <style>#tb-ctx .igrp-table-ctx-th{  width:40px}</style>
            </head>
                                        ...
                                        <div class="gen-column col-md-12">
                                            <div class="gen-inner">
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/filter_1/fields/organica">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="organica" item-type="select" required="required">
                                                                        ...
                                                                        <select class="form-control select2 " id="filter_1_organica" name="{rows/content/filter_1/fields/organica/@name}" required="required">
                                                                ...
                                                                <xsl:if test="rows/content/filter_1/fields/tipo">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="tipo" item-type="select" required="required">
                                                                        <label for="{rows/content/filter_1/fields/tipo/@name}">
                                                                            <xsl:value-of select="rows/content/filter_1/fields/tipo/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 " id="filter_1_tipo" name="{rows/content/filter_1/fields/tipo/@name}" required="required">
                                                                            <xsl:for-each select="rows/content/filter_1/fields/tipo/list/option">
                                                                                <option value="{value}" label="{text}">
                                                                                    <xsl:if test="@selected='true'">
                                                                                        <xsl:attribute name="selected">selected</xsl:attribute>
                                                                                    </xsl:if>
                                                ...
                                                <xsl:if test="rows/content/list">
                                                    <div class="box box-table-contents gen-container-item " id="tb-ctx" gen-class="" item-name="list">
                                                        <div class="box-body table-box">
                                                            ...
                                                            <table id="list" class="table table-striped gen-data-table IGRP_contextmenu">
                                                                <thead>
                                                                    <tr>
                                                                        <xsl:if test="rows/content/list/fields/descricao">
                                                                            <th align="left" class=" gen-fields-holder">
                                                                                <span>
                                                                                    <xsl:value-of select="rows/content/list/fields/descricao/label"/>
                                                                                </span>
                                                                            </th>
                                                                        </xsl:if>
                                                                        <xsl:if test="rows/content/list/fields/sel">
                                                                            <th class="bs-checkbox gen-fields-holder" align="center">
                                                                                <input type="checkbox" class="IGRP_checkall" check-rel="sel"/>
                                                                            </th>
                                                                        </xsl:if>
                                                                ...
                                                                <tbody>
                                                                    <xsl:for-each select="rows/content/list/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="sel">
                                                                                <td align="" data-row="{position()}" data-title="{../../label/sel}" class="bs-checkbox">
                                                                                    <xsl:if test="sel != '-0'">
                                                                                        <input type="checkbox" name="p_sel" value="{sel}" check-rel="sel">
                                                                                            <xsl:if test="sel_check=sel">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1486663651997"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1486663651997"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1486663651997"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1486663651997"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1486663651998"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1486663651998"/>
</xsl:stylesheet>