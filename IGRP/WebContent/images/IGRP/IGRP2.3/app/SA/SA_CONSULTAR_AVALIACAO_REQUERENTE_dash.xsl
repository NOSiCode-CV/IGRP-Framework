                    ...
                    <div class="box-body">
                      <div role="form" gen-id="drop-zone" first-type-container="" last-type-container="">
                        ...
                        <xsl:if test="rows/content/form/label/numero_documento">
                          <div class="form-group col-md-3 " item-name="numero_documento" item-type="select">
                            <label for="{rows/content/form/label/numero_documento/@name}">
                              <xsl:value-of select="rows/content/form/label/numero_documento"/>
                            </label>
                            <select class="form-control select2 " id="{rows/content/form/label/numero_documento/@name}" name="{rows/content/form/label/numero_documento/@name}">
                              <xsl:for-each select="rows/content/form/list/numero_documento/option">
                                <option value="{value}">
                        ...
                        <xsl:if test="rows/content/form/label/numero_documento">
                          <div class="form-group col-md-3" item-name="numero_documento" item-type="number">
                            ...
                            <input type="number" value="{rows/content/form/value/numero_documento}" class="form-control" id="{rows/content/form/label/numero_documento/@name}" name="{rows/content/form/label/numero_documento/@name}"/>
                          </div>
                        </xsl:if>
