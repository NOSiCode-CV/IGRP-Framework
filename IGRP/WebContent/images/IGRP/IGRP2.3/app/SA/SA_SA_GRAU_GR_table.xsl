<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/nome">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="nome" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/nome/value}" class="form-control" id="{rows/content/form_1/fields/nome/@name}" name="{rows/content/form_1/fields/nome/@name}" maxlength="50"></input>
                                                                    </div>
                                                                </xsl:if>
                                                                                ...
                                                                                <td align="left" data-row="{position()}" data-title="{../../label/imagem}" class="link">
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="imagem != ''">
                                                                                            <a href="{imagem}" class="link bClick" target="_blank" name="imagem">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1487338952452"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1487338952452"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1487338952452"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1487338952452"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1487338952453"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1487338952453"/>
</xsl:stylesheet>