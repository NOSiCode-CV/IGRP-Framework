<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/objetivo">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="objetivo" item-type="select">
                                                                        <label for="{rows/content/form_1/fields/objetivo/@name}">
                                                                            <xsl:value-of select="rows/content/form_1/fields/objetivo/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 " id="form_1_objetivo" name="{rows/content/form_1/fields/objetivo/@name}">
                                                                            <xsl:for-each select="rows/content/form_1/fields/objetivo/list/option">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1488476091939"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1488476091939"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1488476091939"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1488476091939"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1488476091940"/>
</xsl:stylesheet>