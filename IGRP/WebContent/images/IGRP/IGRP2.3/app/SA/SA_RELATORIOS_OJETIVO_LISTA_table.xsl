<xsl:stylesheet
                                    ...
                                    <div class="row">
                                        <div class="gen-column col-md-12">
                                            <div class="gen-inner">
                                                ...
                                                <xsl:if test="rows/content/for">
                                                    <div class="box igrp-forms gen-container-item " gen-class="" item-name="for">
                                                        <xsl:call-template name="box-header">
                                                            <xsl:with-param name="title" select="rows/content/for/@title"/>
                                                            <xsl:with-param name="collapsible" select="'false'"/>
                                                        </xsl:call-template>
                                                        <div class="box-body">
                                                            <div role="form">
                                                                <xsl:apply-templates mode="form-hidden-fields" select="rows/content/for/fields"/>
                                                                <xsl:if test="rows/content/for/fields/organica_filt">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="organica_filt" item-type="select">
                                                                        <label for="{rows/content/for/fields/organica_filt/@name}">
                                                                            <xsl:value-of select="rows/content/for/fields/organica_filt/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 " id="for_organica_filt" name="{rows/content/for/fields/organica_filt/@name}">
                                                                            <xsl:for-each select="rows/content/for/fields/organica_filt/list/option">
                                                                ...
                                                                <xsl:if test="rows/content/for/fields/grupo">
                                                                    <div class="col-md-3 form-group  gen-fields-holder" item-name="grupo" item-type="select">
                                                                        <label for="{rows/content/for/fields/grupo/@name}">
                                                                            <xsl:value-of select="rows/content/for/fields/grupo/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 " id="for_grupo" name="{rows/content/for/fields/grupo/@name}">
                                                                            <xsl:for-each select="rows/content/for/fields/grupo/list/option">
                                                                                <option value="{value}" label="{text}">
                                                                                    <xsl:if test="@selected='true'">
                                                                                        <xsl:attribute name="selected">selected</xsl:attribute>
                                                                                    </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/for/fields/objetivo">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="objetivo" item-type="text">
                                                                        <label for="{rows/content/for/fields/objetivo/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/for/fields/objetivo/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/for/fields/objetivo/value}" class="form-control" id="{rows/content/for/fields/objetivo/@name}" name="{rows/content/for/fields/objetivo/@name}" maxlength="500"></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/for/fields/data_de">
                                                                    <div class="form-group col-md-3  gen-fields-holder" item-name="data_de" item-type="date">
                                                                        <label for="{rows/content/for/fields/data_de/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/for/fields/data_de/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <input type="text" value="{rows/content/for/fields/data_de/value}" class="form-control gen-date" id="for-data_de" name="{rows/content/for/fields/data_de/@name}" format="IGRP_datePicker" maxlength="30"/>
                                                                ...
                                                                <xsl:if test="rows/content/for/fields/data_ate">
                                                                    <div class="form-group col-md-3  gen-fields-holder" item-name="data_ate" item-type="date">
                                                                        <label for="{rows/content/for/fields/data_ate/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/for/fields/data_ate/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <input type="text" value="{rows/content/for/fields/data_ate/value}" class="form-control gen-date" id="for-data_ate" name="{rows/content/for/fields/data_ate/@name}" format="IGRP_datePicker" maxlength="30"/>
                                                                            <span class="input-group-btn gen-date-icon">
                                                                                <span class="btn btn-success">
                                                                                    <i class="fa fa-calendar"/>
                                                                                </span>
                                                        ...
                                                        <xsl:apply-templates select="rows/content/for/tools-bar" mode="form-buttons"/>
                                                    </div>
                                                </xsl:if>
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1488562626323"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1488562626323"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1488562626323"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1488562626323"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1488562626323"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1488562626323"/>
</xsl:stylesheet>