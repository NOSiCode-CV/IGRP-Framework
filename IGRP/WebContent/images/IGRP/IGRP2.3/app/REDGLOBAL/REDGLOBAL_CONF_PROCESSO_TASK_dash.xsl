        ...
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:if test="not(rows/target) or rows/target!='_blank'"><!--MENU--><div class="bodyPageLeft">
            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_form" enctype="multipart/form-data"><!-- SHOW HIDDEN--><xsl:apply-templates mode="form-hidden" select="rows/content/filter/value"/>
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FORM--><!--START TOOLS BAR FROM--><xsl:apply-templates mode="tools-bar" select="rows/content/form/tools-bar"/><!--END TOOLS BAR FORM--><div class="col addMarginTop" sep-name="form">
                ...
                <xsl:if test="rows/content/form/label/ver_etapa">
                  <xsl:if test="rows/content/form/label/ver_etapa">
                    <div class="col-1-4 item" item-name="ver_etapa">
                      <div class="igrp_item link">
                        <a href="{rows/content/form/value/ver_etapa}" class="link bClick" name="p_ver_etapa" target="_blank">
                          <xsl:value-of select="rows/content/form/label/ver_etapa" disable-output-escaping="yes"/>
                        </a>
                        <div class="_clear"/>
                      </div>
                      <div class="_clear"/>
                ...
                <xsl:if test="rows/content/form/label/flag_payment">
                  <xsl:if test="rows/content/form/label/flag_payment">
                    <div class="col-1-4 item" item-name="flag_payment">
                      <div class="igrp_item select">
                        <label>
                          <xsl:value-of select="rows/content/form/label/flag_payment" disable-output-escaping="yes"/>
                        </label>
                        <select name="{rows/content/form/list/flag_payment/@name}" chosen="select" data-placeholder="{rows/content/form/list/flag_payment/option[position() = 1]}" class="select">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/flag_payment"/>
                          </xsl:call-template>
                          <option value=""/>
                          <xsl:for-each select="rows/content/form/list/flag_payment/option[position() != 1]">
                            <option value="{value}">
                              <xsl:if test="@selected='true'">
                                <xsl:attribute name="selected">selected</xsl:attribute>
                              </xsl:if>
                  ...
                  <xsl:if test="rows/content/form/label/start_mode">
                    <div class="col-1-4 item" item-name="start_mode">
                      <div class="igrp_item checkbox">
                        <div class="col-1-1">
                          <input type="checkbox" name="{rows/content/form/value/start_mode/@name}" value="1" class="checkbox">
                            <xsl:call-template name="FIELD_validator">
                ...
                <xsl:if test="rows/content/form/label/flag_step">
                  <xsl:if test="rows/content/form/label/flag_step">
                    <div class="col-1-4 item" item-name="flag_step">
                      <div class="igrp_item checkbox">
                        <div class="col-1-1">
                          <input type="checkbox" name="{rows/content/form/value/flag_step/@name}" value="1" class="checkbox">
                            <xsl:call-template name="FIELD_validator">
                              <xsl:with-param name="field" select="rows/content/form/label/flag_step"/>
                            </xsl:call-template>
                            <xsl:if test="rows/content/form/value/flag_step='1'">
                              <xsl:attribute name="checked">checked</xsl:attribute>
                            </xsl:if>
                          </input>
                          <xsl:value-of select="rows/content/form/label/flag_step" disable-output-escaping="yes"/>
                        </div>
                        <div class="_clear"/>
                      </div>
                      <div class="_clear"/>
                ...
                <xsl:if test="rows/content/form/label/xsl_surc">
                  <xsl:if test="rows/content/form/label/xsl_surc">
                    <div class="col-1-4 item" item-name="xsl_surc">
                      <div class="igrp_item text">
                        <label>
                          <xsl:value-of select="rows/content/form/label/xsl_surc" disable-output-escaping="yes"/>
                        </label>
                        <input type="text" name="{rows/content/form/value/xsl_surc/@name}" value="{rows/content/form/value/xsl_surc}" class="text" maxlength="200">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/xsl_surc"/>
                          </xsl:call-template>
                        </input>
                        <div class="_clear"/>
                      </div>
                ...
                <xsl:if test="rows/content/form/label/clonar">
                  <xsl:if test="rows/content/form/label/clonar">
                    <div class="col-1-4 item" item-name="clonar">
                      <div class="igrp_item radiolist">
                        <a id="idp_clonar"/>
                        <label>
                          <xsl:value-of select="rows/content/form/label/clonar" disable-output-escaping="yes"/>
                        </label>
                        <xsl:for-each select="rows/content/form/list/clonar/option">
                          <div class="col-1-1">
                            <input type="radio" name="{../@name}" value="{value}" class="radiolist IGRP_change">
                              <xsl:call-template name="FIELD_validator">
                                <xsl:with-param name="field" select="../../../label/clonar"/>
                              </xsl:call-template>
                              <xsl:if test="@selected='true'">
                                <xsl:attribute name="checked">checked</xsl:attribute>
                              </xsl:if>
                  ...
                  <xsl:if test="rows/content/form/label/class_fk">
                    <div class="col-1-4 item" item-name="class_fk">
                      <div class="igrp_item selectchange">
                        ...
                        <select name="{rows/content/form/list/class_fk/@name}" chosen="select" data-placeholder="{rows/content/form/list/class_fk/option[position() = 1]}" class="selectchange IGRP_change">
                          <xsl:call-template name="FIELD_validator">
                ...
                </xsl:if><!-- INICIO SEPARADOR etapa_a_clonar--><xsl:if test="rows/content/form/label/etapa_a_clonar">
                  <div class="box-content resetPadding" sep-name="etapa_a_clonar">
                    <xsl:call-template name="titlecollapser">
                      <xsl:with-param name="title" select="rows/content/form/label/etapa_a_clonar"/>
                    </xsl:call-template>
                    <div class="box-collapser">
                      <div class="_clear"/>
                    </div>
                ...
                <xsl:if test="rows/content/form/label/aplicacao_clone">
                  <xsl:if test="rows/content/form/label/aplicacao_clone">
                    <div class="col-1-4 item" item-name="aplicacao_clone">
                      <div class="igrp_item selectchange">
                        <a id="idp_aplicacao_clone"/>
                        <label>
                          <xsl:value-of select="rows/content/form/label/aplicacao_clone" disable-output-escaping="yes"/>
                        </label>
                        <select name="{rows/content/form/list/aplicacao_clone/@name}" chosen="select" data-placeholder="{rows/content/form/list/aplicacao_clone/option[position() = 1]}" class="selectchange IGRP_change">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/aplicacao_clone"/>
                          </xsl:call-template>
                          <option value=""/>
                          <xsl:for-each select="rows/content/form/list/aplicacao_clone/option[position() != 1]">
                            <option value="{value}">
                              <xsl:if test="@selected='true'">
                                <xsl:attribute name="selected">selected</xsl:attribute>
                              </xsl:if>
                ...
                <xsl:if test="rows/content/form/label/processo_clone">
                  <xsl:if test="rows/content/form/label/processo_clone">
                    <div class="col-1-4 item" item-name="processo_clone">
                      <div class="igrp_item selectchange">
                        <a id="idp_processo_clone"/>
                        <label>
                          <xsl:value-of select="rows/content/form/label/processo_clone" disable-output-escaping="yes"/>
                        </label>
                        <select name="{rows/content/form/list/processo_clone/@name}" chosen="select" data-placeholder="{rows/content/form/list/processo_clone/option[position() = 1]}" class="selectchange IGRP_change">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/processo_clone"/>
                          </xsl:call-template>
                          <option value=""/>
                          <xsl:for-each select="rows/content/form/list/processo_clone/option[position() != 1]">
                            <option value="{value}">
                              <xsl:if test="@selected='true'">
                                <xsl:attribute name="selected">selected</xsl:attribute>
                              </xsl:if>
                ...
                <xsl:if test="rows/content/form/label/incluir_clone">
                  <xsl:if test="rows/content/form/label/incluir_clone">
                    <div class="col-1-4 item" item-name="incluir_clone">
                      <div class="igrp_item selectlist">
                        <label>
                          <xsl:value-of select="rows/content/form/label/incluir_clone" disable-output-escaping="yes"/>
                        </label>
                        <select name="{rows/content/form/list/incluir_clone/@name}" chosen="select" data-placeholder="{rows/content/form/list/incluir_clone/option[position() = 1]}" multiple="multiple" class="selectlist">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/incluir_clone"/>
                          </xsl:call-template>
                          <option value=""/>
                          <xsl:for-each select="rows/content/form/list/incluir_clone/option[position() != 1]">
                            <option value="{value}">
                              <xsl:if test="@selected='true'">
                                <xsl:attribute name="selected">selected</xsl:attribute>
                              </xsl:if>
                ...
                <xsl:if test="rows/content/form/label/etapa_clone">
                  <xsl:if test="rows/content/form/label/etapa_clone">
                    <div class="col-1-4 item" item-name="etapa_clone">
                      <div class="igrp_item select">
                        <label>
                          <xsl:value-of select="rows/content/form/label/etapa_clone" disable-output-escaping="yes"/>
                        </label>
                        <select name="{rows/content/form/list/etapa_clone/@name}" chosen="select" data-placeholder="{rows/content/form/list/etapa_clone/option[position() = 1]}" class="select">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/etapa_clone"/>
                          </xsl:call-template>
                          <option value=""/>
                          <xsl:for-each select="rows/content/form/list/etapa_clone/option[position() != 1]">
                            <option value="{value}">
                              <xsl:if test="@selected='true'">
                                <xsl:attribute name="selected">selected</xsl:attribute>
                              </xsl:if>
                ...
                </xsl:if><!-- INICIO SEPARADOR repeticoes--><xsl:if test="rows/content/form/label/repeticoes">
                  <div class="box-content resetPadding" sep-name="repeticoes">
                    <xsl:call-template name="titlecollapser">
                ...
                <xsl:if test="rows/content/form/label/flag_multi">
                  <xsl:if test="rows/content/form/label/flag_multi">
                    <div class="col-1-4 item" item-name="flag_multi">
                      <div class="igrp_item selectchange">
                        <a id="idp_flag_multi"/>
                        <label>
                          <xsl:value-of select="rows/content/form/label/flag_multi" disable-output-escaping="yes"/>
                        </label>
                        <select name="{rows/content/form/list/flag_multi/@name}" chosen="select" data-placeholder="{rows/content/form/list/flag_multi/option[position() = 1]}" class="selectchange IGRP_change">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/flag_multi"/>
                          </xsl:call-template>
                          <option value=""/>
                          <xsl:for-each select="rows/content/form/list/flag_multi/option[position() != 1]">
                            <option value="{value}">
                              <xsl:if test="@selected='true'">
                                <xsl:attribute name="selected">selected</xsl:attribute>
                              </xsl:if>
                ...
                <xsl:if test="rows/content/form/label/multi_flow">
                  <xsl:if test="rows/content/form/label/multi_flow">
                    <div class="col-1-4 item" item-name="multi_flow">
                      <div class="igrp_item select">
                        <label>
                          <xsl:value-of select="rows/content/form/label/multi_flow" disable-output-escaping="yes"/>
                        </label>
                        <select name="{rows/content/form/list/multi_flow/@name}" chosen="select" data-placeholder="{rows/content/form/list/multi_flow/option[position() = 1]}" class="select">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/multi_flow"/>
                          </xsl:call-template>
                          <option value=""/>
                          <xsl:for-each select="rows/content/form/list/multi_flow/option[position() != 1]">
                            <option value="{value}">
                              <xsl:if test="@selected='true'">
                                <xsl:attribute name="selected">selected</xsl:attribute>
                              </xsl:if>
