                ...
                <xsl:if test="rows/content/form/label/code">
                  <div class="col-1-4 item" item-name="code">
                    <div class="igrp_item text">
                      ...
                      <input type="text" name="{rows/content/form/value/code/@name}" value="{rows/content/form/value/code}" class="text required IGRP_change" maxlength="50">
                ...
                <xsl:if test="rows/content/form/label/msg">
                  <div class="col-1-4 item" item-name="msg">
                    <div class="igrp_item textarea">
                      ...
                      <textarea name="{rows/content/form/value/msg/@name}" class="textarea required" maxlength="1000">
                        <xsl:call-template name="FIELD_validator">
                        ...
                        <table rel="T_others" data-control="data-others">
                          <thead>
                            <tr>
                              ...
                              <xsl:if test="rows/content/form/table/others/label/other_msg">
                                <xsl:if test="not(rows/content/form/table/others/label/other_msg/@visible)">
                                  <th>
                                    <xsl:value-of select="rows/content/form/table/others/label/other_msg" disable-output-escaping="yes"/>
                                  </th>
                                </xsl:if>
                              </xsl:if>
                            </tr>
                          ...
                          <tbody>
                            <xsl:for-each select="rows/content/form/table/others/value/row[not(@total='yes')]">
                              <tr row="{position()}">
                                ...
                                <xsl:if test="other_msg">
                                  <xsl:if test="not(other_msg/@visible)">
                                    <td data-row="{position()}" data-title="{../../label/other_msg}" class="text">
                                      <xsl:value-of select="other_msg" disable-output-escaping="yes"/>
                                      <input type="hidden" name="p_other_msg_fk" value="{other_msg}"/>
                                    </td>
                                  </xsl:if>
                                  <xsl:if test="other_msg/@visible = 'false'">
                                    <input type="hidden" name="p_other_msg_fk" value="{other_msg}"/>
                                  </xsl:if>
                                </xsl:if>
