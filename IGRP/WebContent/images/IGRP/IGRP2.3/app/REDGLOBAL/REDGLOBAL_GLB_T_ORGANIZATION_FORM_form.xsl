              ...
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FORM--><!--START TOOLS BAR FROM--><xsl:apply-templates mode="tools-bar" select="rows/content/form/tools-bar"/><!--END TOOLS BAR FORM--><div class="col addMarginTop" sep-name="form">
                ...
                <xsl:if test="rows/content/form/label/name">
                  <div class="col-1-4 item" item-name="name">
                    <div class="igrp_item LOOKUP_ORG">
                      <label>
                      ...
                      <div class="itemIcon">
                        <input type="LOOKUP_ORG" name="{rows/content/form/value/name/@name}" value="{rows/content/form/value/name}" class="LOOKUP_ORG required">
                          <xsl:call-template name="FIELD_validator">
                        ...
                        <xsl:call-template name="lookup-tool">
                          ...
                          <xsl:with-param name="js_lookup" select="rows/content/form/lookup/name"/>
                        </xsl:call-template>
                      </div>
                      <div class="_clear"/>
                    </div>
                ...
                <xsl:if test="rows/content/form/label/self_fk">
                  <div class="col-1-4 item" item-name="self_fk">
                    <div class="igrp_item selectchange">
                      ...
                      <select name="{rows/content/form/list/self_fk/@name}" chosen="select" data-placeholder="{rows/content/form/list/self_fk/option[position() = 1]}" class="selectchange IGRP_change">
                        <xsl:call-template name="FIELD_validator">
