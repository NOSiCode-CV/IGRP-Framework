                      ...
                      <thead>
                        <tr>
                          <xsl:if test="rows/content/table/label/componente">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/componente"/>
                            </th>
                          </xsl:if>
                        ...
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="componente">
                              <td align="" data-row="{position()}" data-title="{../../label/componente}" class="link">
                                <xsl:choose>
                                  <xsl:when test="componente != ''">
                                    <a href="{componente}" class="link bClick" target="_blank" name="componente">
                                      <xsl:value-of select="componente_desc" disable-output-escaping="yes"/>
                                    </a>
                                  </xsl:when>
                                  <xsl:otherwise>
                                    <xsl:value-of select="componente_desc" disable-output-escaping="yes"/>
                            ...
                            <xsl:if test="preview">
                              <td align="" data-row="{position()}" data-title="{../../label/preview}" class="text">
