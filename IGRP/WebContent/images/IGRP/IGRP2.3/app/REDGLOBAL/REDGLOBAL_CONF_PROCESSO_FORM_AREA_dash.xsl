<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/description">
                                                                    <div class="form-group col-md-6  gen-fields-holder" item-name="description" item-type="textarea">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/status">
                                                                    <div class="col-md-6  gen-fields-holder" item-name="status" item-type="checkbox">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1490358115076"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1490358115076"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1490358115076"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1490358115076"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1490358115077"/>
    <xsl:include href="../../xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1490358115077"/>
</xsl:stylesheet>