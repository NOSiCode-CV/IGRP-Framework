        ...
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:if test="not(rows/target) or rows/target!='_blank'"><!--MENU--><div class="bodyPageLeft">
            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_form" enctype="multipart/form-data"><!-- SHOW HIDDEN--><xsl:apply-templates mode="form-hidden" select="rows/content/filter/value"/>
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FORM--><!--START TOOLS BAR FROM--><xsl:apply-templates mode="tools-bar" select="rows/content/form/tools-bar"/><!--END TOOLS BAR FORM--><div class="col addMarginTop" sep-name="form">
                  ...
                  <xsl:if test="rows/content/form/label/modulo">
                    <div class="col-1-4 item" item-name="modulo">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/form/value/modulo/@name}" value="{rows/content/form/value/modulo}" class="text" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                ...
                <xsl:if test="rows/content/form/label/parametrizacao">
                  <xsl:if test="rows/content/form/label/parametrizacao">
                    <div class="col-1-4 item" item-name="parametrizacao">
                      <div class="igrp_item checkbox">
                        <div class="col-1-1">
                          <input type="checkbox" name="{rows/content/form/value/parametrizacao/@name}" value="1" class="checkbox">
                            <xsl:call-template name="FIELD_validator">
                              <xsl:with-param name="field" select="rows/content/form/label/parametrizacao"/>
                            </xsl:call-template>
                            <xsl:if test="rows/content/form/value/parametrizacao='1'">
                              <xsl:attribute name="checked">checked</xsl:attribute>
                            </xsl:if>
                          </input>
                          <xsl:value-of select="rows/content/form/label/parametrizacao" disable-output-escaping="yes"/>
                        </div>
                        <div class="_clear"/>
                      </div>
                      <div class="_clear"/>
