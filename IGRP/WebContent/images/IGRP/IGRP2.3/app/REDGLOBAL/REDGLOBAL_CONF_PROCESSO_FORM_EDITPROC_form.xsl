<xsl:stylesheet
                                            ...
                                            <div class="gen-inner">
                                                ...
                                                <div class="gen-tab-holder nav-tabs-custom gen-container-item " tab-template="default" gen-class="" item-name="tabcontent_1">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <xsl:if test="rows/content/tabcontent_1/fields/doc_aux">
                                                            <li item-name="doc_aux" class=" gen-fields-holder" rel="tab-tabcontent_1-doc_aux">
                                                                <a data-toggle="tab" aria-expanded="true" href="#tab-tabcontent_1-doc_aux">
                                                                    <i class="fa fa-angle-right"/>
                                                                    <span>
                                                                        <xsl:value-of select="rows/content/tabcontent_1/fields/doc_aux/label"/>
                                                                    </span>
                                                                </a>
                                                            </li>
                                                        </xsl:if>
                                                    ...
                                                    <div class="tab-content">
                                                                                    ...
                                                                                    <div class="box-body">
                                                                                        <div role="form">
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/env_fk">
                                                                                                <div class="col-md-4 form-group  gen-fields-holder" item-name="env_fk" item-type="select">
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/area_super_fk">
                                                                                                <div class="col-md-4 form-group  gen-fields-holder" item-name="area_super_fk" item-type="select">
                                                                                                    <label for="{rows/content/form_1/fields/area_super_fk/@name}">
                                                                                                        <xsl:value-of select="rows/content/form_1/fields/area_super_fk/label"/>
                                                                                                    </label>
                                                                                                    <select class="form-control select2 IGRP_change" id="form_1_area_super_fk" name="{rows/content/form_1/fields/area_super_fk/@name}">
                                                                                                        <xsl:for-each select="rows/content/form_1/fields/area_super_fk/list/option">
                                                                                                            <option value="{value}" label="{text}">
                                                                                                                <xsl:if test="@selected='true'">
                                                                                                                    <xsl:attribute name="selected">selected</xsl:attribute>
                                                                                                                </xsl:if>
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/area_fk">
                                                                                                <div class="col-md-4 form-group  gen-fields-holder" item-name="area_fk" item-type="select" required="required">
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/code">
                                                                                                <div class="form-group col-md-4   gen-fields-holder" item-name="code" item-type="text" required="required">
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/name">
                                                                                                <div class="form-group col-md-8   gen-fields-holder" item-name="name" item-type="text" required="required">
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/automatico">
                                                                                                <div class="col-md-3  gen-fields-holder" item-name="automatico" item-type="checkbox" required="required">
                                                                                                    <div class="form-group">
                                                                                                        <div class="checkbox form-check-offset">
                                                                                                            <label>
                                                                                                                <input type="checkbox" name="{rows/content/form_1/fields/automatico/@name}" value="1" class="checkbox " required="required" label="{rows/content/form_1/fields/automatico/label}">
                                                                                                                    <xsl:if test="rows/content/form_1/fields/automatico/value = '1'">
                                                                                                                        <xsl:attribute name="checked">checked</xsl:attribute>
                                                                                                                    </xsl:if>
                                                                                                                </input>
                                                                                                                <span>
                                                                                                                    <xsl:value-of select="rows/content/form_1/fields/automatico/label"/>
                                                                                                                </span>
                                                                                                            </label>
                                                                                                        </div>
                                                                                                    </div>
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/acti_start">
                                                                                                <div class="col-md-6 form-group  gen-fields-holder" item-name="acti_start" item-type="select">
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/diagram">
                                                                                                <div class="box-head subtitle gen-fields-holder">
                                                                                                    <xsl:value-of select="rows/content/form_1/fields/diagram/label"/>
                                                                                                </div>
                                                                                            </xsl:if>
                                                                                            <xsl:if test="rows/content/form_1/fields/file">
                                                                                                <div class="form-group col-md-6  gen-fields-holder" item-name="file" item-type="file">
                                                                                            ...
                                                                                            <xsl:if test="rows/content/form_1/fields/sep_num_generator">
                                                                                                <div class="box-head subtitle gen-fields-holder">
                                                                                                    <xsl:value-of select="rows/content/form_1/fields/sep_num_generator/label"/>
                                                                                                </div>
                                                                                            </xsl:if>
                                                                                            <xsl:if test="rows/content/form_1/fields/num_generator">
                                                                                                <div class="form-group col-md-6   gen-fields-holder" item-name="num_generator" item-type="text">
                                                                                                    <label for="{rows/content/form_1/fields/num_generator/@name}">
                                                                                                        <span>
                                                                                                            <xsl:value-of select="rows/content/form_1/fields/num_generator/label"/>
                                                                                                        </span>
                                                                                                    </label>
                                                                                                    <input type="text" value="{rows/content/form_1/fields/num_generator/value}" class="form-control " id="{rows/content/form_1/fields/num_generator/@name}" name="{rows/content/form_1/fields/num_generator/@name}" maxlength="100" placeholder=""></input>
                                                                                                </div>
                                                                                            </xsl:if>
                                                                                        </div>
                                                                                    </div>
                                                        ...
                                                        <xsl:if test="rows/content/tabcontent_1/fields/doc_aux">
                                                            <div class="tab-pane gen-rows-holder " id="tab-tabcontent_1-doc_aux" rel="tab-tabcontent_1-doc_aux">
                                                                <div class="row">
                                                                    <div class="gen-column col-md-12">
                                                                        <div class="gen-inner">
                                                                            <xsl:if test="rows/content/docs_aux">
                                                                                <div class="box gen-container-item " gen-class="" item-name="docs_aux">
                                                                                    <xsl:call-template name="box-header">
                                                                                        <xsl:with-param name="title" select="rows/content/docs_aux/@title"/>
                                                                                        ...
                                                                                        <div class="splist-form-holder">
                                                                                            <div class="splist-form" role="form">
                                                                                                ...
                                                                                                <xsl:if test="rows/content/docs_aux/fields/type_aux">
                                                                                                    <div class="col-md-6 form-group  gen-fields-holder" item-name="type_aux" item-type="select">
                                                                                                ...
                                                                                                <xsl:if test="rows/content/docs_aux/fields/file_aux">
                                                                                                    <div class="form-group col-md-6  gen-fields-holder" item-name="file_aux" item-type="file">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1490978351760"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1490978351760"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1490978351760"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1490978351760"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1490978351760"/>
</xsl:stylesheet>