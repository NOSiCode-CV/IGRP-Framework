                ...
                <xsl:if test="rows/content/form/label/descr">
                  <div class="col-1-4 item" item-name="descr">
                    <div class="igrp_item text">
                      ...
                      <input type="text" name="{rows/content/form/value/descr/@name}" value="{rows/content/form/value/descr}" class="text required" maxlength="100">
                        <xsl:call-template name="FIELD_validator">
                ...
                <xsl:if test="rows/content/form/label/org_fk">
                  <div class="col-1-4 item" item-name="org_fk">
                    <div class="igrp_item selectchange">
                      ...
                      <select name="{rows/content/form/list/org_fk/@name}" chosen="select" data-placeholder="{rows/content/form/list/org_fk/option[position() = 1]}" class="selectchange IGRP_change">
                        <xsl:call-template name="FIELD_validator">
