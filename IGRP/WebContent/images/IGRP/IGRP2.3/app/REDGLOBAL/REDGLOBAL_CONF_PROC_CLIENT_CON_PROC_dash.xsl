                  ...
                  <xsl:if test="rows/content/filter/label/proc_tp_fk">
                    <div class="col-1-4 item" item-name="proc_tp_fk">
                      <div class="igrp_item select">
                        ...
                        <select name="{rows/content/filter/list/proc_tp_fk/@name}" chosen="select" data-placeholder="{rows/content/filter/list/proc_tp_fk/option[position() = 1]}" class="select required">
                          <xsl:call-template name="FIELD_validator">
