<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/env_fk">
                                                                    <div class="col-md-6 form-group  gen-fields-holder" item-name="env_fk" item-type="select" required="required">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/self_fk">
                                                                    <div class="col-md-6 form-group  gen-fields-holder" item-name="self_fk" item-type="select" required="required">
                                                                        <label for="{rows/content/form_1/fields/self_fk/@name}">
                                                                            <xsl:value-of select="rows/content/form_1/fields/self_fk/label"/>
                                                                        </label>
                                                                        <select class="form-control select2 " id="form_1_self_fk" name="{rows/content/form_1/fields/self_fk/@name}" required="required">
                                                                            <xsl:for-each select="rows/content/form_1/fields/self_fk/list/option">
                                                                                <option value="{value}" label="{text}">
                                                                                    <xsl:if test="@selected='true'">
                                                                                        <xsl:attribute name="selected">selected</xsl:attribute>
                                                                                    </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/sep_info">
                                                                    <div class="box-head subtitle gen-fields-holder">
                                                                        <xsl:value-of select="rows/content/form_1/fields/sep_info/label"/>
                                                                    </div>
                                                                </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/name">
                                                                    <div class="form-group col-md-6   gen-fields-holder" item-name="name" item-type="text" required="required">
    ...
    <xsl:include href="../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1491223866825"/>
    <xsl:include href="../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1491223866825"/>
    <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1491223866825"/>
    <xsl:include href="../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1491223866825"/>
    <xsl:include href="../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1491223866825"/>
</xsl:stylesheet>