                  ...
                  <xsl:if test="rows/content/form/label/componentes">
                    <div class="col-1-4 item" item-name="componentes">
                      <div class="igrp_item selectchange">
                        ...
                        <select name="{rows/content/form/list/componentes/@name}" chosen="select" data-placeholder="{rows/content/form/list/componentes/option[position() = 1]}" class="selectchange IGRP_change">
                          <xsl:call-template name="FIELD_validator">
