<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/n_consulta_por_dia">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="n_consulta_por_dia" item-type="number" required="required">
                                                                        ...
                                                                        <input type="number" value="{rows/content/form_1/fields/n_consulta_por_dia/value}" class="form-control " id="{rows/content/form_1/fields/n_consulta_por_dia/@name}" name="{rows/content/form_1/fields/n_consulta_por_dia/@name}" required="required" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                            </div>
                                                        </div>
    ...
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-functions.tmpl.xsl?v=1495448269797"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-variables.tmpl.xsl?v=1495448269797"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1495448269797"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-utils.tmpl.xsl?v=1495448269797"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1495448269797"/>
</xsl:stylesheet>
