<xsl:stylesheet
                                                        ...
                                                        <div class="box-body">
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/nome_utente">
                                                                    <div class="form-group col-md-3   gen-fields-holder" item-name="nome_utente" item-type="text">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/data_consulta">
                                                                    <div class="form-group col-md-3  gen-fields-holder" item-name="data_consulta" item-type="date">
                                                                    ...
                                                                    <xsl:for-each select="rows/content/table_1/table/value/row">
                                                                        <tr>
                                                                            ...
                                                                            <xsl:if test="nome_utente">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/nome_utente/label}" class="text">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="medico_a_consultar">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/medico_a_consultar/label}" class="text">
                                                                                    <span class="">
                                                                            ...
                                                                            <xsl:if test="data_da_consulta">
                                                                                <td align="left" data-row="{position()}" data-title="{../../fields/data_da_consulta/label}" class="date">
                                                                                    <span class="">
    ...
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-functions.tmpl.xsl?v=1495474214623"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-variables.tmpl.xsl?v=1495474214623"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1495474214623"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-utils.tmpl.xsl?v=1495474214623"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1495474214623"/>
    <xsl:include href="/IGRP/images/IGRP/IGRP2.3/xsl/tmpl/IGRP-table-utils.tmpl.xsl?v=1495474214623"/>
</xsl:stylesheet>
