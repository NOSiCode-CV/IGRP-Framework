                ...
                <xsl:if test="rows/content/form/label/rv_domain">
                  <div class="col-1-4 item" item-name="rv_domain">
                    <div class="igrp_item text">
                      ...
                      <input type="text" name="{rows/content/form/value/rv_domain/@name}" value="{rows/content/form/value/rv_domain}" class="text required" maxlength="50">
                ...
                <xsl:if test="rows/content/form/label/rv_meaning">
                  <div class="col-1-4 item" item-name="rv_meaning">
                    <div class="igrp_item text">
                      ...
                      <input type="text" name="{rows/content/form/value/rv_meaning/@name}" value="{rows/content/form/value/rv_meaning}" class="text" maxlength="150">
                        <xsl:call-template name="FIELD_validator">
