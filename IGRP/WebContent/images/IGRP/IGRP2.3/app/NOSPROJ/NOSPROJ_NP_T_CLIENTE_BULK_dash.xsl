            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_filter"><!-- SHOW HIDDEN--><xsl:apply-templates mode="form-hidden" select="rows/content/filter/value"/>
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FILTER--><div class="box-content resetPadding">
                <div class="col">
                  <xsl:if test="rows/content/filter/label/nu_nif">
                    <div class="col-1-4 item" item-name="nu_nif">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/filter/value/nu_nif/@name}" value="{rows/content/filter/value/nu_nif}" class="text required" maxlength="9">
                  ...
                  <xsl:if test="rows/content/filter/label/dt_registo">
                    <div class="col-1-4 item" item-name="dt_registo">
                      <div class="igrp_item date">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/dt_registo) > 45">
                            <xsl:attribute name="title">
                              <xsl:value-of select="rows/content/filter/label/dt_registo" disable-output-escaping="yes"/>
                            </xsl:attribute>
                          </xsl:if>
                          <xsl:value-of select="rows/content/filter/label/dt_registo" disable-output-escaping="yes"/>
                        </label>
                        <div class="itemIcon">
                          <input type="text" name="{rows/content/filter/value/dt_registo/@name}" value="{rows/content/filter/value/dt_registo}" class="date" trel="IGRP_datePicker">
                            <xsl:call-template name="FIELD_validator">
                              <xsl:with-param name="field" select="rows/content/filter/label/dt_registo"/>
                            </xsl:call-template>
                          </input>
                          <div class="calendar"/>
                        </div>
                  ...
                  <xsl:if test="rows/content/filter/label/data_ate">
                    <div class="col-1-4 item" item-name="data_ate">
                      <div class="igrp_item date">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/data_ate) > 45">
                            <xsl:attribute name="title">
                              <xsl:value-of select="rows/content/filter/label/data_ate" disable-output-escaping="yes"/>
                            </xsl:attribute>
                          </xsl:if>
                          <xsl:value-of select="rows/content/filter/label/data_ate" disable-output-escaping="yes"/>
                        </label>
                        <div class="itemIcon">
                          <input type="text" name="{rows/content/filter/value/data_ate/@name}" value="{rows/content/filter/value/data_ate}" class="date" trel="IGRP_datePicker">
                            <xsl:call-template name="FIELD_validator">
                    ...
                    <table class="IGRP_table default-table" data-control="table">
                      <thead>
                        <tr>
                          ...
                          <xsl:if test="rows/content/table/label/dt_registo">
                            <th align="center">
                              <xsl:value-of select="rows/content/table/label/dt_registo"/>
                            </th>
                          </xsl:if>
                      ...
                      <tbody>
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="nu_nif">
                              <td align="left" data-row="{position()}" data-title="{../../label/nu_nif}" class="text">
                            ...
                            <xsl:if test="dt_registo">
                              <td align="center" data-row="{position()}" data-title="{../../label/dt_registo}" class="date">
                                <xsl:value-of select="dt_registo"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="estado">
