                  ...
                  <xsl:if test="rows/content/filter/label/codigo">
                    <div class="col-1-4 item" item-name="codigo">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/filter/value/codigo/@name}" value="{rows/content/filter/value/codigo}" class="text required" maxlength="20">
                  ...
                  <xsl:if test="rows/content/filter/label/nome">
                    <div class="col-1-4 item" item-name="nome">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/filter/value/nome/@name}" value="{rows/content/filter/value/nome}" class="text required" maxlength="100">
                          <xsl:call-template name="FIELD_validator">
