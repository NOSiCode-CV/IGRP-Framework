            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_filter"><!-- SHOW HIDDEN--><xsl:apply-templates mode="form-hidden" select="rows/content/filter/value"/>
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FILTER--><div class="box-content resetPadding">
                <div class="col">
                  <xsl:if test="rows/content/filter/label/descricao">
                    <div class="col-1-4 item" item-name="descricao">
                      <div class="igrp_item text">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/descricao) > 45">
                            <xsl:attribute name="title">
                              <xsl:value-of select="rows/content/filter/label/descricao" disable-output-escaping="yes"/>
                            </xsl:attribute>
                          </xsl:if>
                          <xsl:value-of select="rows/content/filter/label/descricao" disable-output-escaping="yes"/>
                        </label>
                        <input type="text" name="{rows/content/filter/value/descricao/@name}" value="{rows/content/filter/value/descricao}" class="text" maxlength="100">
                  ...
                  <xsl:if test="rows/content/filter/label/valor">
                    <div class="col-1-4 item" item-name="valor">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/filter/value/valor/@name}" value="{rows/content/filter/value/valor}" class="text" maxlength="50">
                          <xsl:call-template name="FIELD_validator">
                  ...
                  <xsl:if test="rows/content/filter/label/domains">
                    <div class="col-1-4 item" item-name="domains">
                      <div class="igrp_item text">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/domains) > 45">
                            <xsl:attribute name="title">
                              <xsl:value-of select="rows/content/filter/label/domains" disable-output-escaping="yes"/>
                            </xsl:attribute>
                          </xsl:if>
                          <xsl:value-of select="rows/content/filter/label/domains" disable-output-escaping="yes"/>
                        </label>
                        <input type="text" name="{rows/content/filter/value/domains/@name}" value="{rows/content/filter/value/domains}" class="text" maxlength="50">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/filter/label/domains"/>
                          </xsl:call-template>
                        </input>
                        <div class="_clear"/>
                      </div>
                    ...
                    <table class="IGRP_table default-table" data-control="table">
                      <thead>
                        <tr>
                          ...
                          <xsl:if test="rows/content/table/label/domains">
                            <th align="left">
                              <xsl:value-of select="rows/content/table/label/domains"/>
                            </th>
                          </xsl:if>
                      ...
                      <tbody>
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="domains">
                              <td align="left" data-row="{position()}" data-title="{../../label/domains}" class="text">
