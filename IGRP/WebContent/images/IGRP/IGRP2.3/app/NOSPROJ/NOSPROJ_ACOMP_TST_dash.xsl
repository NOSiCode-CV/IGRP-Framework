<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                  ...
                  <xsl:if test="rows/content/filter/label/fase">
                    <div class="col-1-4 item" item-name="fase">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/filter/value/fase/@name}" value="{rows/content/filter/value/fase}" class="text" maxlength="30">
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-context.tmpl.xsl?v=20150616"/>
</xsl:stylesheet>
