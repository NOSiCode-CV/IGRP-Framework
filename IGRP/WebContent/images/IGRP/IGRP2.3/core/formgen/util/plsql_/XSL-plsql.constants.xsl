...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="all_fields" select="rows/content/*[@type = 'form' or @type = 'table' or @type = 'separatorlist' or @type = 'separatordialog' or @type = 'list' or @type = 'formlist']/fields/*[not(.=preceding::*)]"/>
    <xsl:variable name="all_fields_sql" select="rows/content/*[@type = 'form' or @type = 'table' or @type = 'separatorlist' or @type = 'separatordialog' or @type = 'list' or @type = 'formlist']/fields/*[not(.=preceding::*) and (@type='select' or @type='selectchange' or @type='selectlist' or @type='radiolist' or @type='checkboxlist')]"/>
    <xsl:variable name="all_fields_chart" select="rows/content/*[@type = 'chart' and not(.=preceding::*)]"/>
    <xsl:variable name="all_fields_lookup" select="rows/content/*[@type = 'form' or @type = 'table' or @type = 'separatorlist' or @type = 'separatordialog' or @type = 'list' or @type = 'formlist']/fields/*[not(.=preceding::*) and contains(@type,'LOOKUP')]"/>
    <xsl:variable name="all_fields_group" select="rows/content/*[(@type = 'separatorlist' or @type = 'separatordialog' or @type = 'list' or @type = 'formlist') and not(.=preceding::*)]" />
    <xsl:variable name="all_fields_array" select="rows/content/*[@type = 'separatorlist' or @type = 'separatordialog' or @type = 'list' or @type = 'formlist']/fields/*[not(.=preceding::*)]" />
    <xsl:variable name="all_fields_table" select="rows/content/*[(@type = 'table') and not(.=preceding::*)]" />
    <xsl:variable name="all_toolsbars" select="rows/content/*[@type = 'toolsbar']/*|rows/content/*[@type = 'table']/table/context-menu/*|rows/content/*[@type = 'tabmenu']/group/*"/>
