...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="genCallListForm">
        <xsl:for-each select="rows/content/*[@type = 'form']|rows/content/*[@xml-type = 'form']|rows/content/*[@type = 'view']">
            <xsl:call-template name="genCallList">
                <xsl:with-param name="tag" select="name()"/>
    ...
    <xsl:template name="genCallList">
        ...
        <xsl:call-template name="genComment">
            <xsl:with-param name="comment" select="concat('invoke ', $type, ' ', $tag)"/>
        </xsl:call-template>

        <xsl:value-of select="@xml-type"/><xsl:value-of select="$enter"/>
        ...
        <xsl:choose>
            ...
            <xsl:when test="$type='form' or @xml-type = 'form'">
