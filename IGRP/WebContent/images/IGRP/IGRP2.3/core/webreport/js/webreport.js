				...
				var filter = new CKEDITOR.htmlParser.filter({
			    	...
			    	elements:{
			    		span : function(element){
			    			var span  = {};
			    			span.tag  = element.attributes.tag;
			    			...
			    			if (span.tag && span.tag != undefined) {
			    				var path = 'rows/content[position()='+span.pos+']/'+span.no+'/fields/'+span.tag+'/value';
			    				...
			    				if(span.type == 'chart'){
			    					...
			    					span.element = '<xsl:value-of select="rows/content[position()='+span.pos+']/'+span.no+'/fields/'+span.tag+'/list/option[@selected='+"'"+'true'+"'"+']/text"/>';
			    				}
			    		...
			    		table : function(element){
			    			...
			    			table.no   		= element.attributes.no;
			    			table.group 	= element.attributes.group || '';
			    			table.grouphtml = element.attributes.grouphtml || '';
			    			table.vars 		= '';
			    			table.cond 		= '';
			    			table.colgroup 	= element.attributes.colgroup ? element.attributes.colgroup.split(',') : [];
			    		...
			    		ul : function(element){
			    			...
			    			if (ul.no && ul.no != undefined) {
			    				element.forEach(function(node){
			    					if (node.name == 'li')
			    						ul.element +=  '<li '+$.WR.element.getStyle(node)+'><xsl:value-of select="'+node.attributes.tag+'"/></li>';
			    				});
			    		...
			    		ol : function(element){
			    			...
			    			if (ol.no && ol.no != undefined) {
			    				element.forEach(function(node){
			    					if (node.name == 'li')
			    						ol.element += '<li '+$.WR.element.getStyle(node)+'><xsl:value-of select="'+node.attributes.tag+'"/></li>';
			    				});
			    		...
			    		img : function(element){
			    			var img  = {};
			    			img.tag  = element.attributes.tag;
