<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:call-template name="home-slide-menu"/><!--HOME RIGTH--><div class="bodyPageRigth"><!-- START YOUR CODE HERE --><!-- SHOW TABLET AND MOBILE TITLE --><div class="box-head showTabMobile">
            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_form" enctype="multipart/form-data"><!-- SHOW HIDDEN--><xsl:apply-templates mode="form-hidden" select="rows/content/filter/value"/>
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FORM--><!--START TOOLS BAR FROM--><xsl:apply-templates mode="tools-bar" select="rows/content/form/tools-bar"/><!--END TOOLS BAR FORM--><div class="col addMarginTop addPaddingBottom10" sep-name="form">
                ...
                <xsl:if test="rows/content/form/label/rv_low_value">
                  <div class="col-1-4 item" item-name="rv_low_value">
                    <div class="igrp_item text">
                      ...
                      <input type="text" name="{rows/content/form/value/rv_low_value/@name}" value="{rows/content/form/value/rv_low_value}" class="text required" maxlength="100">
                        <xsl:call-template name="FIELD_validator">
                ...
                <xsl:if test="rows/content/form/label/rv_meaning">
                  <div class="col-1-4 item" item-name="rv_meaning">
                    <div class="igrp_item text">
                      ...
                      <input type="text" name="{rows/content/form/value/rv_meaning/@name}" value="{rows/content/form/value/rv_meaning}" class="text required" maxlength="100">
                        <xsl:call-template name="FIELD_validator">
                ...
                <xsl:if test="rows/content/form/label/rv_description">
                  <div class="col-1-4 item" item-name="rv_description">
                    <div class="igrp_item text">
                      <label>
                        <xsl:if test="string-length(rows/content/form/label/rv_description) > 45">
                          <xsl:attribute name="title">
                            <xsl:value-of select="rows/content/form/label/rv_description" disable-output-escaping="yes"/>
                          </xsl:attribute>
                        </xsl:if>
                        <xsl:value-of select="rows/content/form/label/rv_description" disable-output-escaping="yes"/>
                      </label>
                      <input type="text" name="{rows/content/form/value/rv_description/@name}" value="{rows/content/form/value/rv_description}" class="text" maxlength="100">
                        <xsl:call-template name="FIELD_validator">
                          <xsl:with-param name="field" select="rows/content/form/label/rv_description"/>
                        </xsl:call-template>
                      </input>
                      <div class="_clear"/>
                    </div>
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20150828"/>
  <xsl:include href="../../xsl/tmpl/IGRP-setAttribute.tmpl.xsl?v=20150828"/>
  <xsl:include href="../../xsl/tmpl/IGRP-slide-menu.tmpl.xsl?v=20150828"/>
</xsl:stylesheet>
