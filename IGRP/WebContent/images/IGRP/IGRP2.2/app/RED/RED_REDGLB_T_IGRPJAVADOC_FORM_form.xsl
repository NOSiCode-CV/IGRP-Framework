              ...
              <xsl:call-template name="dialog-modal"/><!-- START YOUR CODE HERE --><div class="box-content"><!--PAGE TITLE--><xsl:call-template name="page-title">
                  ...
                  <xsl:with-param name="class" select="'notification'"/>
                    ...
                    <xsl:if test="rows/content/form/label/group_name">
                      <label>
                        <span>
                          <xsl:value-of select="rows/content/form/label/group_name"/>
                        </span>
                        <input type="text" name="{rows/content/form/value/group_name/@name}" value="{rows/content/form/value/group_name}" class="text" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/group_name"/>
                          </xsl:call-template>
                        </input>
                      </label>
                    </xsl:if>
