            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_form" enctype="multipart/form-data">
                    ...
                    <div class="IGRP-menu groupItemTab itemMenu" id="tab2" type="tab">
                      <xsl:if test="rows/content/form/label/datasorce_app">
                        <div class="col item" item-name="datasorce_app">
                          <div class="igrp_item select">
                            <!-- <label>
                              <xsl:if test="string-length(rows/content/form/label/datasorce_app) >45">
                                <xsl:attribute name="title">
                                  <xsl:value-of select="rows/content/form/label/datasorce_app" disable-output-escaping="yes"/>
                                </xsl:attribute>
                              </xsl:if>
                              <xsl:value-of select="rows/content/form/label/datasorce_app"/>
                            </label> -->
                            <div class="itemIcon">
                              <xsl:if test="rows/content/form/value/link_add_source !=''">
                                <xsl:attribute name="add">on</xsl:attribute>
                              </xsl:if>
                              <select name="{rows/content/form/list/datasorce_app/@name}" chosen="select" id="{rows/content/form/list/datasorce_app/@name}" data-placeholder="{rows/content/form/list/datasorce_app/option[position() = 1]}" class="select">
                                <xsl:call-template name="FIELD_validator">
                              ...
                              <xsl:if test="rows/content/form/value/link_add_source !=''">
                                ...
                                <a class="addDataSource bClick" target="_blank" href="{rows/content/form/value/link_add_source}" title="{$lngPath/js_messages/message[@name ='edit']} {rows/content/form/label/datasorce_app}" id="editDataSource">
              ...
              <div class="colCenter" sep-name="form">
                <div class="ui-dialog" id="reportTitle">
                  <div class="dialog">
                    <div class="title"><xsl:value-of select="'Titulo de Report'"/></div>
                    <div class="message">
                      <div class="igrp_item">
                        <div class="col-1-4"><label><xsl:value-of select="'Titulo'"/></label></div>
                        <div class="col-9-12">
                          <input type="text" name="p_title_report" placeholder="Titulo"/>
                        </div>
                        <div class="_clear"/>
                      </div>
                    </div>
