<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                  ...
                  <xsl:if test="rows/content/filter/label/env_fk">
                    <div class="col-1-4 item" item-name="env_fk">
                      <div class="igrp_item selectchange">
                        ...
                        <select name="{rows/content/filter/list/env_fk/@name}" chosen="select" id="{rows/content/filter/list/env_fk/@name}" data-placeholder="{rows/content/filter/list/env_fk/option[position() = 1]}" class="selectchange required IGRP_change">
                  ...
                  <xsl:if test="rows/content/filter/label/area_super_fk">
                    <div class="col-1-4 item" item-name="area_super_fk">
                      <div class="igrp_item selectchange">
                        ...
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/area_super_fk) > 45">
                            <xsl:attribute name="title">
                        ...
                        <select name="{rows/content/filter/list/area_super_fk/@name}" chosen="select" id="{rows/content/filter/list/area_super_fk/@name}" data-placeholder="{rows/content/filter/list/area_super_fk/option[position() = 1]}" class="selectchange IGRP_change">
                          <xsl:call-template name="FIELD_validator">
                  ...
                  <xsl:if test="rows/content/filter/label/area_fk">
                    <div class="col-1-4 item" item-name="area_fk">
                      <div class="igrp_item selectchange">
                        ...
                        <select name="{rows/content/filter/list/area_fk/@name}" chosen="select" id="{rows/content/filter/list/area_fk/@name}" data-placeholder="{rows/content/filter/list/area_fk/option[position() = 1]}" class="selectchange IGRP_change">
                          <xsl:call-template name="FIELD_validator">
                  ...
                  <xsl:if test="rows/content/filter/label/proc_tp_fk">
                    <div class="col-1-4 item" item-name="proc_tp_fk">
                      <div class="igrp_item select">
                        ...
                        <select name="{rows/content/filter/list/proc_tp_fk/@name}" chosen="select" id="{rows/content/filter/list/proc_tp_fk/@name}" data-placeholder="{rows/content/filter/list/proc_tp_fk/option[position() = 1]}" class="select">
                          <xsl:call-template name="FIELD_validator">
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20150922"/>
  <xsl:include href="../../xsl/tmpl/IGRP-setAttribute.tmpl.xsl?v=20150922"/>
  <xsl:include href="../../xsl/tmpl/IGRP-slide-menu.tmpl.xsl?v=20150922"/>
  <xsl:include href="../../xsl/tmpl/IGRP-menu.tmpl.xsl?v=20150922"/>
  <xsl:include href="../../xsl/tmpl/IGRP-context.tmpl.xsl?v=20150922"/>
</xsl:stylesheet>
