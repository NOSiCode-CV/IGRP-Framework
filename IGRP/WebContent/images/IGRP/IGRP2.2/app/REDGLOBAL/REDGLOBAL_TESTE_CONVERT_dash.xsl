                      ...
                      <thead>
                        <tr>
                          <xsl:if test="rows/content/table/label/contacto">
                            <th align="">
                              <xsl:value-of select="rows/content/table/label/contacto"/>
                            </th>
                          </xsl:if>
                        </tr>
                      </thead>
                        ...
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="">
                            ...
                            <xsl:if test="contacto">
                              <td align="" data-row="{position()}" data-title="{../../label/contacto}" class="js_passa_valor">
                                <a class="link bClick" title="Passa Valor" target="lookup">
                                  <xsl:value-of select="contacto" disable-output-escaping="yes"/>
                                </a>
                              </td>
                            </xsl:if>
                          </tr>
