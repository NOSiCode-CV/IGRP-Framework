<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <html><!--XSL Generator (RED/DIM 2015)--><head><!--HOME-HEADER--><xsl:call-template name="home-header"/>
      ...
      <body class="bodyColor">
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:call-template name="home-slide-menu"/><!--HOME RIGTH--><div class="bodyPageRigth"><!-- START YOUR CODE HERE --><!-- SHOW TABLET AND MOBILE TITLE --><div class="box-head showTabMobile">
           ...
           </div><div id="sep_proc" class="workFlow-content">
        <!-- INICIO SEPARADOR sep_proc--><xsl:if test="rows/content/form/label/sep_proc">
                ...
                <xsl:if test="rows/content/form/label/flg_adhoc">
                  <div class="col-1-4 item" item-name="flg_adhoc">
                    <div class="igrp_item checkbox">
                      <a id="idp_flg_adhoc"/>
                      <div class="col-1-1">
                        <input type="checkbox" name="{rows/content/form/value/flg_adhoc/@name}" value="1" class="checkbox IGRP_change">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/flg_adhoc"/>
                          </xsl:call-template>
                          <xsl:if test="rows/content/form/value/flg_adhoc='1'">
                            <xsl:attribute name="checked">checked</xsl:attribute>
                          </xsl:if>
                        </input>
                        <xsl:value-of select="rows/content/form/label/flg_adhoc" disable-output-escaping="yes"/>
                      </div>
                      <div class="_clear"/>
                    </div>
                    <div class="_clear"/>
                ...
                <xsl:if test="rows/content/form/label/acti_start">
                  <div class="col-1-4 item" item-name="acti_start">
                    <div class="igrp_item select">
                      <label>
                        <xsl:if test="string-length(rows/content/form/label/acti_start) > 45">
                          <xsl:attribute name="title">
                            <xsl:value-of select="rows/content/form/label/acti_start" disable-output-escaping="yes"/>
                          </xsl:attribute>
                        </xsl:if>
                        <xsl:value-of select="rows/content/form/label/acti_start" disable-output-escaping="yes"/>
                      </label>
                      <select name="{rows/content/form/list/acti_start/@name}" chosen="select" id="{rows/content/form/list/acti_start/@name}" data-placeholder="{rows/content/form/list/acti_start/option[position() = 1]}" class="select">
                        <xsl:call-template name="FIELD_validator">
                          <xsl:with-param name="field" select="rows/content/form/label/acti_start"/>
                        </xsl:call-template>
                        <option value=""/>
                        <xsl:for-each select="rows/content/form/list/acti_start/option[position() != 1]">
                          <option value="{value}">
                            <xsl:if test="@selected='true'">
                              <xsl:attribute name="selected">selected</xsl:attribute>
                            </xsl:if>
           ...
           </div><div id="bpmn_diag" class="workFlow-content">
        <!-- INICIO SEPARADOR bpmn_diag--><xsl:if test="rows/content/form/label/bpmn_diag">
           ...
           </div><div id="param_exec" class="workFlow-content">
        <!-- INICIO SEPARADOR param_exec--><xsl:if test="rows/content/form/label/param_exec">
           ...
           </div><div id="clone" class="workFlow-content">
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20150925"/>
  <xsl:include href="../../xsl/tmpl/IGRP-setAttribute.tmpl.xsl?v=20150925"/>
  <xsl:include href="../../xsl/tmpl/IGRP-slide-menu.tmpl.xsl?v=20150925"/>
  <xsl:include href="../../xsl/tmpl/IGRP-workflowtab.tmpl.xsl?v=20150925"/>
</xsl:stylesheet>
