<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                  ...
                  <xsl:if test="rows/content/filter/label/id">
                    <div class="col-1-4 item" item-name="id">
                      <div class="igrp_item number">
                        <label>
                          <xsl:if test="string-length(rows/content/filter/label/id) > 45">
                      ...
                      <tbody>
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="id">
                              <td align="center" data-row="{position()}" data-title="{../../label/id}" class="number">
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20151023"/>
  <xsl:include href="../../xsl/tmpl/IGRP-setAttribute.tmpl.xsl?v=20151023"/>
  <xsl:include href="../../xsl/tmpl/IGRP-slide-menu.tmpl.xsl?v=20151023"/>
  <xsl:include href="../../xsl/tmpl/IGRP-context.tmpl.xsl?v=20151023"/>
</xsl:stylesheet>
