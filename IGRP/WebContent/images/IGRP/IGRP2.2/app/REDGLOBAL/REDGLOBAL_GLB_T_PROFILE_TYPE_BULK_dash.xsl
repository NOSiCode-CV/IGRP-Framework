                    ...
                    <table class="IGRP_table default-table" data-control="table">
                      <thead>
                        <tr>
                          ...
                          <xsl:if test="rows/content/table/label/org_fk_desc">
                            <th align="left">
                              <xsl:value-of select="rows/content/table/label/org_fk_desc"/>
                            </th>
                          </xsl:if>
                      ...
                      <tbody>
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="org_fk_desc">
                              <td align="left" data-row="{position()}" data-title="{../../label/org_fk_desc}" class="text">
                                <xsl:value-of select="org_fk_desc"/>
                              </td>
                            </xsl:if>
                            <xsl:if test="status">
