<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                  ...
                  <xsl:if test="rows/content/form/label/action">
                    <div class="col-1-4 item" item-name="action">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/form/value/action/@name}" value="{rows/content/form/value/action}" class="text" maxlength="100">
                          <xsl:call-template name="FIELD_validator">
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20150731"/>
  <xsl:include href="../../xsl/tmpl/IGRP-setAttribute.tmpl.xsl?v=20150731"/>
  <xsl:include href="../../xsl/tmpl/IGRP-slide-menu.tmpl.xsl?v=20150731"/>
  <xsl:include href="../../xsl/tmpl/IGRP-context.tmpl.xsl?v=20150731"/>
</xsl:stylesheet>
