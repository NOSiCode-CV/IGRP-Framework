<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      <body class="bodyColor">
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:call-template name="home-slide-menu"/><!--HOME RIGTH--><div class="bodyPageRigth"><!-- START YOUR CODE HERE --><!-- SHOW TABLET AND MOBILE TITLE --><div class="box-head showTabMobile">
              ...
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FILTER--><div class="box-content resetPadding">
                ...
                </xsl:apply-templates><!--END TOOL BAR TABLE--><div class="box-table table-responsive"><!-- LEGENDA TABELA --><xsl:apply-templates mode="table-legend" select="rows/content/table/legend_color"/>
                    ...
                    <table class="IGRP_table default-table" data-control="table">
                      <thead>
                        <tr>
                          ...
                          <xsl:if test="rows/content/table/label/dias_em_espera">
                            <th align="right">
                              <xsl:value-of select="rows/content/table/label/dias_em_espera"/>
                            </th>
                          </xsl:if>
                        ...
                        <xsl:for-each select="rows/content/table/value/row[not(@total='yes')]">
                          <tr row="{position()}" class="IGRP_contextMenu">
                            ...
                            <xsl:if test="priority">
                              <td align="" data-row="{position()}" data-title="{../../label/priority}" class="tdcolorcolor_td">
                            ...
                            <xsl:if test="dias_em_espera">
                              <td align="right" data-row="{position()}" data-title="{../../label/dias_em_espera}" class="number">
            ...
            <div class="col">
              ...
              <div class="box-content resetPadding">
                <div class="col">
                  <xsl:if test="rows/content/tarefas_por_executar"><!-- START CHARTS--><div class="col" graph-name="tarefas_por_executar">
                  ...
                  <xsl:if test="rows/content/tarefas_por_prioridade"><!-- START CHARTS--><div class="col" graph-name="tarefas_por_prioridade">
                      <xsl:call-template name="igrp-graph">
                  ...
                  <xsl:if test="rows/content/tarefas_disponiveis"><!-- START CHARTS--><div class="col" graph-name="tarefas_disponiveis">
                      <xsl:call-template name="igrp-graph">
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-others.tmpl.xsl?v=20150311"/>
