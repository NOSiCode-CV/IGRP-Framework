				 ...
				 <xsl:if test="rows/content/form/label/nome">
                  <div class="col-1-4 item" item-name="nome">
                    <div class="igrp_item nome">
                      ...
                      <input type="nome" name="{rows/content/form/value/nome/@name}" value="{rows/content/form/value/nome}" class="nome required">
                        <xsl:call-template name="FIELD_validator">
				 ...
				 <xsl:if test="rows/content/form/label/user_name">
                  <div class="col-1-4 item" item-name="user_name">
                    <div class="igrp_item user_name">
                      ...
                      <input type="user_name" name="{rows/content/form/value/user_name/@name}" value="{rows/content/form/value/user_name}" class="user_name required">
                        <xsl:call-template name="FIELD_validator">
