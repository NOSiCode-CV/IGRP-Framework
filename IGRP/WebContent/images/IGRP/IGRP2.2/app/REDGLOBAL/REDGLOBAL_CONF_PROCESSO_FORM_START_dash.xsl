<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:if test="not(rows/target) or rows/target!='_blank'"><!--MENU--><div class="bodyPageLeft">
            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_form" enctype="multipart/form-data"><!-- SHOW HIDDEN--><xsl:apply-templates mode="form-hidden" select="rows/content/filter/value"/>
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FORM--><!-- START SEPARADOR TAB--><xsl:apply-templates mode="workFlow_tab" select="rows/content/form/label"/><!-- END SEPARADOR TAB--><!--START TOOLS BAR FROM--><xsl:apply-templates mode="tools-bar" select="rows/content/form/tools-bar"/><!--END TOOLS BAR FORM--><div class="col"><div class="col addMarginTop" sep-name="form">
                ...
                <xsl:if test="rows/content/form/label/order_visual">
                  <xsl:if test="rows/content/form/label/order_visual">
                    <div class="col-1-4 item" item-name="order_visual">
                      <div class="igrp_item number">
                        <label>
                          <xsl:value-of select="rows/content/form/label/order_visual" disable-output-escaping="yes"/>
                        </label>
                        <input type="number" name="{rows/content/form/value/order_visual/@name}" value="{rows/content/form/value/order_visual}" class="number" maxlength="30">
                          <xsl:call-template name="FIELD_validator">
                            <xsl:with-param name="field" select="rows/content/form/label/order_visual"/>
                          </xsl:call-template>
                        </input>
                        <div class="_clear"/>
                      </div>
           ...
           </div><div id="se_etapa" class="col workFlow-content">
        <!-- INICIO SEPARADOR se_etapa--><xsl:if test="rows/content/form/label/se_etapa">
                  <div class="box-content resetPadding" sep-name="se_etapa">
                    <xsl:call-template name="titlecollapser">
                      <xsl:with-param name="title" select="rows/content/form/label/se_etapa"/>
                    </xsl:call-template>
                  ...
                  <xsl:if test="rows/content/form/label/xsl_src">
                    <div class="col-1-4 item" item-name="xsl_src">
                      <div class="igrp_item text">
                        ...
                        <input type="text" name="{rows/content/form/value/xsl_src/@name}" value="{rows/content/form/value/xsl_src}" class="text" maxlength="250">
                          <xsl:call-template name="FIELD_validator">
           ...
           </div><div id="sep_class_dest" class="col workFlow-content">
        <!-- INICIO SEPARADOR sep_class_dest--><xsl:if test="rows/content/form/label/sep_class_dest">
           ...
           </div><div id="tempos" class="col workFlow-content">
        <!-- INICIO SEPARADOR tempos--><xsl:if test="rows/content/form/label/tempos">
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-workFlow.tmpl.xsl?v=20150309"/>
</xsl:stylesheet>
