...
<p class="app-titulo-logo">
<xsl:value-of select="rows/content/filter/value/name" disable-output-escaping="yes"/>
</p>
</xsl:if>
<div class="_clear"/>
</div>
...
<xsl:if test="count(rows/content/form/table/favorites/value/row[not(@total='yes')]) > 0">
<div class="box-collapser">
<!--  START TABELA LIST -->
<ul class="app-list1">
<xsl:for-each select="rows/content/form/table/favorites/value/row[not(@total='yes')]">
<li class="col-1-2">
<span class="app-img-icon">
<a href="{fav_link}" class="link bClick" target="_self" name="fav_link">
<xsl:value-of select="fav_title" disable-output-escaping="yes"/>
</a>
</span>
</li>
</xsl:for-each>
...
<xsl:if test="count(rows/content/form/table/notification/value/row[not(@total='yes')]) > 0">
<div class="box-collapser">
<!--  START TABELA LIST -->
...
-->
<p class="app-p1">
<xsl:value-of select="not_data" disable-output-escaping="yes"/>
</p>
<div class="_clear"/>
<p class="app-p3 borderColor">
<xsl:value-of select="not_description" disable-output-escaping="yes"/>
</p>
</li>
</xsl:for-each>
</ul>
...
<xsl:if test="count(rows/content/form/table/last_task/value/row[not(@total='yes')]) > 0">
<div class="box-collapser">
<!--  START TABELA LIST -->
<div class="box-table table-responsive">
<ul class="app-list3">
...
<p class="app-p1">
<xsl:value-of select="task_title" disable-output-escaping="yes"/>
</p>
<p class="app-p2 borderColor">
<xsl:value-of select="task_data" disable-output-escaping="yes"/>
</p>
<div class="_clear"/>
<p class="app-p3 borderColor">
<xsl:value-of select="task_description" disable-output-escaping="yes"/>
</p>
</li>
</xsl:for-each>
</ul>
