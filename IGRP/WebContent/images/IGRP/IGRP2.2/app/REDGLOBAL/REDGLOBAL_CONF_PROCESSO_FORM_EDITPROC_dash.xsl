              ...
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FORM--><!--START TOOLS BAR FROM--><xsl:apply-templates mode="tools-bar" select="rows/content/form/tools-bar"/><!--END TOOLS BAR FORM--><div class="col addMarginTop addPaddingBottom10" sep-name="form">
                ...
                <xsl:if test="rows/content/form/label/flg_adhoc">
                  <div class="col-1-4 item" item-name="flg_adhoc">
                    <div class="igrp_item checkbox">
                      <div class="col-1-1">
                        <input type="checkbox" name="{rows/content/form/value/flg_adhoc/@name}" value="1" class="checkbox">
                          <xsl:call-template name="FIELD_validator">
                ...
                <xsl:if test="rows/content/form/label/acti_start">
                  <div class="col-1-4 item" item-name="acti_start">
                    <div class="igrp_item select">
                      ...
                      <select name="{rows/content/form/list/acti_start/@name}" chosen="select" id="{rows/content/form/list/acti_start/@name}" data-placeholder="{rows/content/form/list/acti_start/option[position() = 1]}" class="select IGRP_change">
                        <xsl:call-template name="FIELD_validator">
