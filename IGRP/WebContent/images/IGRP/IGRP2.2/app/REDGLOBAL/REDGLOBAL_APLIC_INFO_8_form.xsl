<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      <body class="bodyColor">
        <div class="IGRP_overlay"/><!--HOME TOP--><xsl:call-template name="home-top-main"/><!--HOME--><div id="igrp-bodyPage"><!--HOME LEFT--><xsl:call-template name="home-slide-menu"/><!--HOME RIGTH--><div class="bodyPageRigth"><!-- START YOUR CODE HERE --><!-- SHOW TABLET AND MOBILE TITLE --><div class="box-head showTabMobile">
            ...
            <form action="#" method="post" id="formular_default" name="formular_default" class="default_form" enctype="multipart/form-data"><!-- SHOW HIDDEN--><xsl:apply-templates mode="form-hidden" select="rows/content/filter/value"/>
              <xsl:apply-templates mode="form-hidden" select="rows/content/form/value"/><!-- START FORM--><!--START TOOLS BAR FROM--><xsl:apply-templates mode="tools-bar" select="rows/content/form/tools-bar"/><!--END TOOLS BAR FORM--><div class="col addMarginTop addPaddingBottom10" sep-name="form"><!-- INICIO SEPARADOR suport_item--><xsl:if test="rows/content/form/label/suport_item">
                  <div class="box-content resetPadding" sep-name="suport_item">
                    ...
                    <div class="box-collapser">
                      <div class="col" sep-name="group-suport_item">
                        ...
                        <xsl:if test="rows/content/form/label/img_bt">
                          <div class="col-1-4 item" item-name="img_bt">
                            <div class="igrp_item text">
                              <label>
                                <xsl:if test="string-length(rows/content/form/label/img_bt) > 45">
                                  <xsl:attribute name="title">
                        ...
                        <xsl:if test="rows/content/form/label/status">
                          <div class="col-1-4 item" item-name="status">
                            <div class="igrp_item select">
                              ...
                              <select name="{rows/content/form/list/status/@name}" chosen="select" id="{rows/content/form/list/status/@name}" data-placeholder="{rows/content/form/list/status/option[position() = 1]}" class="select" rel="F_suport_item">
                                <xsl:call-template name="FIELD_validator">
                      ...
                      <div class="col" sep-name="list-suport_item"><!-- START TABELA LIST--><div class="box-table table-responsive">
                          <ul class="contextMenu ctxSepListDialog" id="data-suport_item" sep-name="btn-suport_item">
                            <li rel="suport_item" class="IGRP_editRow operationTable" item-name="edit-suport_item">
                            ...
                            <li rel="suport_item" class="IGRP_delRow operationTable" item-name="del-suport_item">
                                ...
                                <tr row="{position()}">
                                  ...
                                  <td class="bEdDel" data-row="{position()}" data-title="{$lngPath/separatorlist_dialog/edit}/{$lngPath/separatorlist_dialog/delete}">
                                    <xsl:if test="not(@noupdate)">
                                      <img title="{$lngPath/separatorlist_dialog/edit}" src="{$path_tmpl}/img/icon/tools-bar/edit.png" item-name="edit-suport_item" rel="suport_item" class="IGRP_editRow"/>
                                    </xsl:if>
                                    <xsl:if test="not(@nodelete)">
                                      <img title="{$lngPath/separatorlist_dialog/delete}" src="{$path_tmpl}/img/icon/tools-bar/delete.png" item-name="del-suport_item" rel="suport_item" class="IGRP_delRow"/>
                                    </xsl:if>
                                  </td>
  ...
  <xsl:include href="../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=20151021"/>
  <xsl:include href="../../xsl/tmpl/IGRP-setAttribute.tmpl.xsl?v=20151021"/>
  <xsl:include href="../../xsl/tmpl/IGRP-slide-menu.tmpl.xsl?v=20151021"/>
</xsl:stylesheet>
