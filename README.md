...
The IGRP**Web** core is extremely lightweight and based on simple concepts. It's open-source and distributed under the Apache 2.0 license. Allows you to build an unlimited number of e-government applications by yourself ensuring sustainability with an affordable and scalable solution on your own data.
...
There’s available a free demo cloud on how to create and run your own e-government apps on the cloud https://cloud.nosi.cv/IGRP:

- User: demo@nosi.cv
- Password: demo

Also, there is documentation that is going to help you develop and to understand the framework: [Docs IGRP (PT)](https://docs.igrp.cv)
...
(Please note that IGRP Framework may work on other databases, but these are not tested nor officially supported at this time.)
...
Follow [Contributing guidelines](CONTRIBUTING.md) for more details on how to contribute to the community and the process of submitting pull requests, bug fixing, and patches.

Remember pull requests, bug fixes, and new application development are always encouraged.
